...
すべての設定が完了したら、**実験プラグインがどのように機能するかについての簡単なデモを、** インスタント実験[と題したこのビデオ &#x200B;](https://business.adobe.com/jp/products/experience-manager/sites/testing-optimization.html)をご覧ください。
