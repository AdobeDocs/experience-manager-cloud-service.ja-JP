...
>[!TIP]
>
>コンテンツを翻訳することを初めておこなう場合は、 [サイト翻訳ジャーニー](/help/journey-sites/translation/overview.md). AEMの強力な翻訳ツールを使用してAEM Sitesのコンテンツを翻訳する際のガイド付きのパスです。AEMまたは翻訳エクスペリエンスがない場合に最適です。
...
* この [翻訳](translation/overview.md) AEMの統合機能は、サードパーティの翻訳管理サービスと共に、言語を管理し、コンテンツをこれらの異なる言語に翻訳します。
