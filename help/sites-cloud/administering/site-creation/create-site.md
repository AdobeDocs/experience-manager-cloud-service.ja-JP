...
コンテンツ作成者がコンテンツを含むページを作成する前に、まずサイトを作成する必要があります。これは、通常、サイトの初期構造を定義する AEM 管理者が実行します。サイトテンプレートを使用すると、開発者以外でもサイトを迅速かつ柔軟に作成できます。
...
>[!TIP]
>
>サイトテンプレートについて詳しくは、[サイトテンプレート](site-templates.md)ドキュメントを参照してください。

>[!NOTE]
>
>サイトテンプレートをページテンプレートと混同しないでください。[](/help/sites-cloud/authoring/page-editor/templates.md) サイトテンプレートは、サイト全体の構造を定義します。ページテンプレートは、個々のページの構造と初期コンテンツを定義します。
...
1. サイトテンプレートの必要に応じて、追加のサイト詳細を指定します。
   ...
   * 例えば、[Edge Delivery Services プロジェクト](https://www.aem.live/developer/ue-tutorial)のテンプレートでは、プロジェクトの GitHub リポジトリが必要です。
...
テンプレートは、サイトの基本構造とスタイルをすばやく設定するのに役立ちます。ただし、ほとんどのプロジェクトでは、追加のスタイル設定とカスタマイズが必要です。サイトテンプレートを使用すると、サイトのスタイル設定を分離するのに役立つので、フロントエンド開発者は AEM の知識がなくてもサイトのスタイル設定が可能になり、コンテンツ作成者とは別に、並行して作業できます。プロジェクトのタイプに応じて、テンプレートは次の 2 つのフォームで利用できます。

* ユニバーサルエディターを使用した AEM ページオーサリングと [Edge Delivery](/help/edge/overview.md) を通じて配信を行うプロジェクトでは、すべてのスタイル設定は GitHub プロジェクトで行われます。
   * 詳しくは、[はじめに - ユニバーサルエディターの開発者チュートリアル](https://www.aem.live/developer/ue-tutorial)ドキュメントを参照してください。
* 従来の AEM ページオーサリングと[公開配信](/help/sites-cloud/authoring/author-publish.md)を通じて配信を行うプロジェクトでは、AEM 管理者は、サイトテーマをダウンロードし、フロントエンド開発者に提供するだけです。この開発者は、好きなツールを使用してテーマをカスタマイズし、AEM コードリポジトリに変更をコミットして、デプロイします。
   * 詳しくは、[AEM クイックサイト作成ジャーニー](/help/journey-sites/quick-site/overview.md)ドキュメントを参照してください。
