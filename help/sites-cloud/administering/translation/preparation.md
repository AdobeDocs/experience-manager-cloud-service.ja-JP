...
1. 「**作成**」を選択します。確認ダイアログボックスで、次のいずれかを選択します。 **完了** サイトコンソールに戻るには、または **開く** をクリックして、言語コピーを開きます。
...
1. サイトコンソールで、サイトのページを選択し、「 」を選択します。 **参照**.

   ![参照パネルを開く](../assets/opening-references-rail.png)

1. 参照レールで、「 」を選択します。 **言語コピー**. Web サイトの言語コピーがパネルに表示されます。
