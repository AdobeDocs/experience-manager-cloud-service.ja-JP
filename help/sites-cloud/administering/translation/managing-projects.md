...
新しいプロジェクトの作成時と同様に、ページを追加する際は、既存の言語コピーが上書きされないようにするために必要な場合、ページのコピーがローンチに追加されます。（[既存の言語コピー用の翻訳プロジェクトの作成](#performing-initial-translations-and-updating-existing-translations)を参照してください。）
