...
タグの動作方法に関する技術的な詳細については、ドキュメントを参照してください。 [AEM Tagging Framework。](/help/implementing/developing/introduction/tagging-framework.md)
...
タグを作成して使用してコンテンツを整理する手順は多数あります。
...
1. 新しい名前空間を作成するには、 [タグ付けコンソール](#tagging-console) をクリックし、 **作成** ボタンをツールバーに追加し、 **名前空間を作成**.
...
1. 必要な情報を入力したら、をタップまたはクリックします。 **作成**.
...
1. 新しいタグを作成するには、 [タグ付けコンソール。](#tagging-console)

1. タグを作成する名前空間を選択します。 または、別のタグを選択して、その下にサブタグを作成します。

1. をタップまたはクリックします。 **作成** ボタンを使用して、 **タグを作成**.
...
* 名前空間や別のタグを選択せずにタグを作成する場合は、新しい名前空間を効果的に作成できます。
...
1. 公開するタグを 1 つ以上選択し、ツールバーでを選択します。 **公開**.

   ![コンソールでのタグの選択](assets/select-tags.png)

1. The **タグを公開** ダイアログで、選択したタグを公開するかどうかを確認する確認が表示されます。 「**公開**」をタップまたはクリックします。
...
1. The **タグを非公開にする** ダイアログで、選択したタグを公開するかどうかを確認する確認が表示されます。 「**公開**」をタップまたはクリックします。
...
1. タグに割り当てられているコンテンツの詳細なリストを表示するには、タグ参照の数をタップまたはクリックします。
...
1. 移動または名前を変更するタグを選択し、をタップまたはクリックします。 **移動** 」と入力します。
...
1. 別のタグに統合するタグを選択し、をタップまたはクリックします。 **結合** 」と入力します。

1. Adobe Analytics の **タグを結合** ダイアログで、をタップまたはクリックします。 **参照** アイコン **結合先** フィールドを選択し、選択したタグを結合するタグを指定します。

   ![タグを結合ダイアログ](assets/merge-tag.png)

1. 「**送信**」をタップまたはクリックします。

コンソールで選択したタグが、ダイアログで指定したタグに結合されます。 参照されたタグを移動または結合すると、そのタグは物理的に削除されず、参照を維持できます。 ドキュメントを参照してください [AEM Tagging Framework](/help/implementing/developing/introduction/tagging-framework.md#moving-and-merging-tags) を参照してください。
...
1. 削除するタグを選択し、をタップまたはクリックします。 **削除** 」と入力します。

1. The **タグを削除** 選択したタグを削除するかどうかを確認するダイアログが表示されます。 タップまたはクリック **削除**.

   ![タグの削除の確認モーダル](assets/delete-tag.png)

1. AEMは、タグが参照されていないことを確認します。

   1. 参照が見つからない場合、AEMは削除に関する最終確認を求めます。 タップまたはクリック **削除**
...
例えば、というタグがあるとします。 `Animals` ドイツ語とフランス語に翻訳したいと思う

1. を開きます。 [タグ付けコンソール。](#tagging-console)

1. 翻訳するタグを選択し、をタップまたはクリックします。 **編集** 」と入力します。
...
>[!TIP]
>
>AEMのローカライゼーション機能の詳細については、ドキュメントを参照してください。 [多言語サイトのコンテンツの翻訳。](/help/sites-cloud/administering/translation/overview.md)
