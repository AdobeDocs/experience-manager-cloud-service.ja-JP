...
>[!NOTE]
後 [フラグメントを使用するページを公開する](/help/sites-cloud/authoring/fundamentals/content-fragments.md#publishing);フラグメントがページ参照にリストされます。
...
>[!NOTE]
この **非公開** アクションは、公開されたフラグメントが使用可能な場合にのみ表示されます。
