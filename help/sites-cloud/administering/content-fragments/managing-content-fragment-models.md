...
![コンテンツフラグメントコンソール – コンテンツフラグメントモデルの管理](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models.png)
...
* 上部のツールバー
   * 標準の AEM 機能を提供します
   * IMS組織を表示します
   * 様々な[&#x200B; アクション &#x200B;](#actions-unselected)を提供します。1つ以上のモデルを選択すると[変更できます](#actions-selected-content-fragment-models)
* 左側のパネル
...
* 右側のメインパネルでは、次のことが可能です。
   * 選択したフォルダーの下にあるすべてのコンテンツフラグメントモデルのリストを確認します。
      ...
      * 列ヘッダーにマウスオーバーを使用すると、ドロップダウンアクションセレクターと幅スライダーが表示されます。 これらを使用すると、次のことができます。
         * 並べ替え – 昇順または降順の適切なアクションを選択します
これにより、テーブル全体がその列に従ってソートされます。 並べ替えは、適切な列でのみ使用できます。
...
* **公開者**
   ...
   * [高速フィルタリング](#fast-filtering)に使用可能。
* **様**&#x200B;様が使用しています
   * モデルに基づくコンテンツフラグメントを一覧表示するダイアログが開きます。 このリストには、フラグメントを直接開くためのリンクが用意されています。
...
![コンテンツフラグメントコンソール – 選択したコンテンツフラグメントモデルの情報](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models-selected.png)
...
* **[公開](#publishing-a-content-fragment-model)**&#x200B;および&#x200B;**[非公開](#unpublishing-a-content-fragment-model)**&#x200B;を[公開](/help/implementing/cloud-manager/manage-environments.md#environment-types)または[&#x200B; プレビュー](/help/implementing/cloud-manager/manage-environments.md#access-preview-service)階層に公開します。
...
![コンテンツフラグメントコンソール - 列の設定](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models-column-selection.png)
...
![コンテンツフラグメントコンソール – コンテンツフラグメントモデルのフィルタリング](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models-filter.png)
...
1. 「**ポリシー**」タブを開き、以下を設定します。
   ...
   * **許可されているコンテンツフラグメントモデルタグ (タグ別)**
   ...
   ![コンテンツフラグメントモデルポリシー](/help/sites-cloud/administering/content-fragments/assets/cf-cfmodels-policy-assets-folder.png)
...
1. に移動し、コンテンツフラグメントモデルを選択します。
公開済みステータスがコンソールに表示されます。

1. ツールバーから「**非公開**」を選択します。
...
* モデルエディター
   ...
   * 「**編集**」を選択すると、更新内容を編集して保存できます。
     ...
     ![編集 - ロックされたコンテンツフラグメントモデル](/help/sites-cloud/administering/content-fragments/assets/cf-cfmodels-editor-locked-edit.png)
