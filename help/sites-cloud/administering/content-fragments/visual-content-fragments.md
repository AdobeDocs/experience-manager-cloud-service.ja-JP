...
お客様（または開発チーム）は、[&#128279;](/help/implementing/developing/extending/content-fragments-visualization-templates.md)独自のHTML テンプレートを作成してカスタマイズし、[1つ以上をコンテンツフラグメントモデル &#x200B;](#upload-and-assign-your-template)にアップロードして添付することで、対応するフラグメントをエクスペリエンスにレンダリングできます。[&#x200B; プレビュー](#preview-your-fragment-with-a-template)および[必要に応じて配信](#deliver-your-visual-content-fragment)。
