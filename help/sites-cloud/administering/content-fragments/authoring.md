...
* [バリエーションを生成](#generate-variations-ai) 生成 AI を使用して、プロンプトに基づいてコンテンツの作成を高速化します。
...
* このフラグメントに作成された&#x200B;**[バリエーション](#variations)**&#x200B;のリスト。
   ...
   * バリエーションを生成（#generate-variations）を使用して、特定のユースケース用にAdobeが作成したプロンプトベースのテンプレートを使用できます。
...
* [バリエーションを生成 AI を使用](#generate-variations-ai) ジェネレーティブ AI を使用して、Adobeが特定のユースケース用に作成したプロンプトベースのテンプレートを使用するには、次のようにします。
...
### GenAI とバリエーション生成を使用したバリエーションの作成 {#generate-variations-ai}

ジェネレーティブバリエーションを使用して、ジェネレーティブ AI を活用し、コンテンツの作成を高速化します。
