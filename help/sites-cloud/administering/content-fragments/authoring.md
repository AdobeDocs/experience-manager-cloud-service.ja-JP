...
>[!NOTE]
>
>コンテンツフラグメントモデルとコンテンツフラグメントを操作する場合は、[&#x200B; ベストプラクティス &#x200B;](/help/sites-cloud/administering/content-fragments/overview.md#best-practices)に注意してください。
...
* 上部のツールバー：主要な情報とアクション
   ...
   * モデルとフォルダーに関する情報
   * [Preview](#preview-content-fragment)へのリンク。デフォルトのプレビューURL パターンがモデルに設定されている場合
   ...
   * フラグメントとアカウントに対して有効な警告。 例えば、フラグメントを編集するための正しい権限がない場合、または別のユーザーが[&#x200B; チェックアウト &#x200B;](/help/sites-cloud/administering/content-fragments/managing.md#check-out-and-check-in)した場合、フラグメントには読み取りアクセス権のみが付与されます。
...
* このフラグメントに作成された&#x200B;**[バリエーション](#variations)**&#x200B;のリスト。
   ...
   * [&#x200B; バリエーションを生成](#generate-variations-ai)を使用すると、Adobeが特定のユースケース用に作成したプロンプトベースのテンプレートを使用できます。
...
![コンテンツフラグメントエディター - リンクアイコン](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-link-icon.png)

### 構造ツリー {#structure-tree}

エディターのツールバーから「**構造ツリー**」タブを開いて、コンテンツフラグメントの階層構造とその参照を表示します。 リンクアイコンを使用して参照に移動します。

![コンテンツフラグメントエディター - 構造ツリー](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-structure-tree.png)
...
1. 左側のパネルで、**バリエーション**&#x200B;の右側にある&#x200B;**プラス記号**（**バリエーションを作成**）を選択します。
   ...
   ![コンテンツフラグメントエディター - 最初のバリエーションの作成](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-create-variation-01.png)

1. ダイアログで、必要に応じて、バリエーションの&#x200B;**タイトル**&#x200B;および&#x200B;**説明**&#x200B;を入力します。

   ![コンテンツフラグメントエディター - バリエーションを作成ダイアログ](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-create-variation-02.png)
...
1. **バリエーション**&#x200B;パネルで、削除アイコン（ごみ箱）を選択します。
   ...
   ![コンテンツフラグメントエディター - バリエーションを削除アイコン](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-delete-variation.png)
...
![コンテンツフラグメントエディター - 複数行テキスト - 全画面表示](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-multilinetext-plaintext-markdown.png)
...
![コンテンツフラグメントエディター - 複数行テキスト - 全画面表示切り替え](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-multilinetext-fullscreen-toggle.png)
...
![コンテンツフラグメントエディター - 複数行テキスト - 全画面表示](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-multilinetext-fullscreen.png)
...
![コンテンツフラグメントエディター - 統計](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-multilinetext-statistics.png)
...
![コンテンツフラグメントエディター - 比較と同期](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-multilinetext-compare.png)
...
* **アセットを追加**&#x200B;アクションを選択して、「**アセットを参照**」または「**アップロード**」を選択して、使用する適切なセレクターを開きます。
  ...
  ![コンテンツフラグメントエディター - アセットオプションの追加](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-add-asset-options.png)
...
1. アセットを参照する際にリモート&#x200B;**リポジトリ**&#x200B;を指定します。
   ...
   ![コンテンツフラグメントエディター - リモートからアセットを選択](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-remote-asset-01.png)

2. 選択後、アセット情報内に場所が表示されます。

   ![コンテンツフラグメントエディター - リモートリポジトリからのアセット](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-remote-asset-02.png)
...
![コンテンツフラグメントエディター - 参照の表示](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-show-references-link.png)

ウィンドウが開き、関連するすべての参照が表示されます。 参照を開くには、名前、タイトルまたはリンクアイコンを選択します。

例：

![コンテンツフラグメントエディター - 参照の表示](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-show-references.png)
...
![コンテンツフラグメントエディター - プロパティ](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-properties.png)
...
* **タグ**：ドロップダウンリストまたは選択ダイアログを使用
  ...
  ![コンテンツフラグメントエディター - タグの管理](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-edit-tags.png)
...
![コンテンツフラグメントエディター - コンテンツフラグメントモデルを開く](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-open-model.png)
...
![コンテンツフラグメントエディター - バージョン履歴の概要](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-version-history-overview.png)
...
![コンテンツフラグメントエディター：バージョン履歴の比較](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-version-history-compare.png)
...
![コンテンツフラグメントエディター：バージョン履歴のバージョンの比較](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-version-history-compare-versions.png)
...
![コンテンツフラグメントエディター - バージョン履歴を元に戻す](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-version-history-revert.png)
...
![コンテンツフラグメントエディター - 言語コピーを開く](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-open-language-copies.png)
...
![コンテンツフラグメントエディター -「コメント」タブ](/help/sites-cloud/administering/content-fragments/assets/cf-authoring-comments.png)
...
* **テンプレート**
   ...
   * **[ビジュアライゼーション（HTML）テンプレート](#preview-with-visualization-html-templates)**&#x200B;を使用して、コンテンツフラグメントをプレビューできます。
