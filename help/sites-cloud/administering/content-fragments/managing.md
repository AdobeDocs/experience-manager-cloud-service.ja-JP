...
description: コンソールとエディターからAEMコンテンツフラグメントを管理し、ヘッドレスコンテンツの基礎としてコンテンツを作成する方法、またはページオーサリングの方法について説明します。
...
* 右側のメインパネル
   * ツリーの選択したブランチ内のすべてのコンテンツフラグメントのリストを表示します。
      * 選択したフォルダーのコンテンツフラグメントと、すべての子フォルダーのコンテンツフラグメントが表示されます。
         * 場所はパンくずリストによって示されます。これらを使用して場所を変更することもできます。
...
1. The **新しいコンテンツフラグメント** ダイアログが開きます。ここから、次の項目を指定できます。
   ...
   * **コンテンツフラグメントモデル**  — フラグメントの基礎として使用するモデルをドロップダウンリストから選択します。
   * **タイトル**
   * **名前**  — に基づいて自動完了 **タイトル**&#x200B;必要に応じて編集できます。
   * **説明**
