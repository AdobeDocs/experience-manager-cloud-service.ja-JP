...
* ページエディターを使用している場合、ステータスバーには次の情報が表示されます。
   ...
   * ページに関与するワークフローの数。以下の操作を実行できます。
      ...
      * 実際の数を選択して、該当するすべてのワークフローのドロップダウンリストを開き、ステータスバーに表示するワークフローを選択します。
...
* リソースの&#x200B;**タイムライン**&#x200B;が開いている場合、ワークフローステップが表示されます。アラートバナーで「 」を選択すると、使用可能なアクションも表示されます。
...
1. 操作するワークフロー項目を選択します（サムネールを選択します）。
1. ツールバーの「**完了**」を選択します。
1. The **作業項目を完了** ダイアログが開きます。 を選択します。 **次のステップ** ドロップダウンセレクターから、 **コメント** 必要に応じて。
...
1. 使用可能なアクションを表示するアラートバナーを選択します。 「**進む**」を選択します。
...
ステップが割り当てられているが、何らかの理由で操作できない場合は、そのステップを別のユーザーまたはグループに委任できます。
...
1. 必要なページを選択して&#x200B;**タイムライン**&#x200B;を開きます（または&#x200B;**タイムライン**&#x200B;を開いてからページを選択します）。
1. 使用可能なアクションを表示するアラートバナーを選択します。 「**担当者を変更**」を選択します。
...
1 つのステップ（または一連のステップ）を繰り返す必要がある場合は、前のステップに戻すことができます。 これにより、ワークフロー内で前に発生した再処理のステップを選択できます。 指定した手順にワークフローが戻り、そこから続行します。
...
1. 次を指定します。 **前のステップ** をクリックし、 **コメント** 必要に応じて。
1. 「**OK**」を使用して手順を完了します（または「**キャンセル**」を使用してアクションを中止します）。
...
1. 必要なページを選択して&#x200B;**タイムライン**&#x200B;を開きます（または&#x200B;**タイムライン**&#x200B;を開いてからページを選択します）。
1. 使用可能なアクションを表示するアラートバナーを選択します。 「**ロールバック**」を選択します。
...
1. 必要に応じて、適切なアクションを選択し、詳細を入力して、次の手順で確定します。 **OK** ( または **キャンセル**) をクリックします。
