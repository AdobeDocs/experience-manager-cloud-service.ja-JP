...
![スタイルシステムのアーキテクチャ](/help/sites-cloud/authoring/assets/style-system-architecture.png)
...
1. プロパティの「スタイル」タブで、スタイルがどのように設定されているかを確認できます。
   ...
   ![プロパティウィンドウの「スタイル」タブ](/help/sites-cloud/authoring/assets/style-system-template-styles.png)
