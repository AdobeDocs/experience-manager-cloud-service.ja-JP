...
* **** タスクタイル：プロジェクトの全体的な進行状況は、プロジェクトの詳細ページにある「タスクタイル」に表示されます。
...
![タスクに対するコメント](/help/sites-cloud/authoring/assets/projects-tasks-comments.png)
...
![受信トレイ内のタスク](/help/sites-cloud/authoring/assets/projects-task-inbox.png)
