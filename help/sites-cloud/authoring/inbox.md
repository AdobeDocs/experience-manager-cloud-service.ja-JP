...
>[!NOTE]
>
>特定のアクションは、[適切なリソースのカード表示](/help/sites-cloud/authoring/basic-handling.md#card-view)にも表示されます。
...
>[!NOTE]
>
>インボックスはコンソールとして機能するので、完了したら、[グローバルナビゲーション](/help/sites-cloud/authoring/basic-handling.md#global-navigation)または[検索](/help/sites-cloud/authoring/search.md)を使用して、別の場所に移動します。
