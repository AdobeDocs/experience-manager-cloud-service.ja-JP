---
title: ページエディターで編集可能なページを作成するためのテンプレート
description: テンプレートエディターを使用して、コンテンツ作成者がページエディターで編集可能なページの作成に使用できるテンプレートを作成できます。
...
# ページエディターで編集可能なページを作成するためのテンプレート {#creating-page-templates}

テンプレートエディターを使用して、コンテンツ作成者がページエディターで編集可能なページの作成に使用できるテンプレートを作成できます。

## 概要 {#overview}

作成者がページを作成するとき、新しいページの基礎として使用されるテンプレートを選択する必要があります。 テンプレートは、結果として作成されるページの構造、すべての初期コンテンツおよびページエディターでページを編集する際に使用できるコンポーネントを定義します。

>[!NOTE]
>
>[ テンプレートは、ユニバーサルエディターで編集可能なページを作成する場合にも使用できます。](/help/sites-cloud/authoring/universal-editor/templates.md)

**テンプレートエディター** では、テンプレートの作成と管理は開発者だけが行うタスクではありません。 パワーユーザーの一種は、**テンプレート作成者** と呼ばれ、テンプレートを作成できます。 環境の設定、クライアントライブラリの作成、使用されるコンポーネントの作成は開発者が行う必要がありますが、これら基本となる部分が一度配置されると、**テンプレート作成者** は開発者を介さずにテンプレートを作成して構成できるようになります。
...
このドキュメントでは、**テンプレート作成者** が **テンプレートエディター** を使用して編集可能テンプレートを作成および管理する方法について説明します。

技術レベルでの編集可能テンプレートの動作について詳しくは、開発者向けドキュメント [ 編集可能テンプレート ](/help/implementing/developing/components/templates.md) を参照してください。
...
新しいテンプレートを作成するには、次の役割間での共同作業が必要です。
...
>[!TIP]
>
>テンプレートには [ 国際化 ](/help/implementing/developing/extending/i18n/dev.md) が必要な情報は絶対に入れないようにしてください。
>
...
コンテンツ（またはデザイン）ポリシーにより、コンポーネントのデザインプロパティが定義されます。例えば、使用できるコンポーネントや最小／最大サイズを定義できます。これらのポリシーは、テンプレート（およびテンプレートを使用して作成されたページ）に適用できます。
...
1. **[テンプレート コンソールから ](#publishing-a-template-template-author)0} テンプレートをPublishします。[]** （/help/sites-cloud/administering/templates-console.md）
