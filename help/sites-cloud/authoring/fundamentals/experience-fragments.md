...
* このテンプレートは、 *ルートページ* エクスペリエンスフラグメントの
...
* これらのバリエーションは、コンテンツやコンポーネントを共有できます。
...
1. **エクスペリエンスフラグメント**&#x200B;の&#x200B;**プロパティ**&#x200B;を入力します。
   ...
   **タイトル**&#x200B;は必須です。**名前**&#x200B;が空欄のままの場合、**タイトル**&#x200B;から派生されます。
   ...
   >[!NOTE]
   >
   >エクスペリエンスフラグメントテンプレートのタグは、このエクスペリエンスフラグメントルートページのタグと結合されません。
   >
   >これらは完全に別々です。
...
* **マスターに移動**:ルートページのバリエーションを新しいタブで開く
* **名前を変更**
* **削除**
