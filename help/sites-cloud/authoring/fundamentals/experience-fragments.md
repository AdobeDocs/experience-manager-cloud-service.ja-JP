...
>[!NOTE]
>
>詳しくは、 [ページのコンテンツの編集](/help/sites-cloud/authoring/fundamentals/editing-content.md) ページエディターの使用方法について詳しくは、を参照してください。
...
1. フラグメントを開く対象 [編集中](#editing-your-experience-fragment).
1. 「**バリエーション**」タブを開きます。
