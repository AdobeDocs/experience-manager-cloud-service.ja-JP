...
* 図表とグラフ：通常は数値データを表しています。そのため、代替テキストを提供する際の選択肢の一つとして、図表やグラフが示す主なトレンドを簡潔にまとめることができます。必要に応じて、画像の「**詳細**」プロパティタブの「**説明**」フィールドを使用して、詳しい説明をテキストで提供します。さらに、ページまたはサイトの別の場所で、ソースデータを表形式で提供することもできます。
