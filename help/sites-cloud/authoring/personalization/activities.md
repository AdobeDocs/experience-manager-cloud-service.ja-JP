...
1. アクティビティを作成するブランドを選択し、「 」を選択します。 **作成** その後 **アクティビティを作成**. 編集する場合は、マスター領域画面でアクティビティを選択して、「**アクティビティを編集**」をクリックまたはタップします。
1. 次の情報を入力し、 **次へ**:
   * アクティビティの名前。
   ...
   * アクティビティタイプを選択します。
1. 1 つ以上のエクスペリエンスをアクティビティに追加します。選択 **エクスペリエンスを追加**.
1. AEM ターゲティングまたは Adobe Target エクスペリエンスのターゲット設定を使用する場合の手順は次のとおりです。
   1. 選択 **オーディエンスを選択** エクスペリエンスのターゲットにするセグメントを選択します。
   1. 選択 **エクスペリエンスを追加**、名前を入力して、「 」を選択します。 **OK**.
   1. 「**次へ**」を選択します。Adobe Target A/B テストを使用している場合：
   1. オーディエンスボックスで鉛筆アイコンを選択して、オーディエンスを選択します。
   1. 選択 **エクスペリエンスを追加**、名前を入力して、「 」を選択します。 **OK**.
...
1. ブランドを選択し、公開または非公開にするアクティビティが含まれる領域を選択します。
1. 公開または非公開にするアクティビティの横にあるアイコンを選択します。

   ![アクティビティコンソールからの公開](/help/sites-cloud/authoring/assets/activities-console.png)

1. 公開するには、「 」を選択します。 **公開**. 非公開にするには、「 」を選択します。 **非公開**. アクティビティが公開または非公開になり、アクティビティコンソールでステータスが変更されます（更新が必要な場合があります）。
...
1. In **パーソナライズ**&#x200B;を選択します。 **アクティビティ** をクリックして、 **アクティビティ** コンソール。
1. アクティビティを表示するブランドを選択します。
1. アクティビティを選択し、「 」を選択します。 **プロパティを表示** をクリックし、 **レポート** 「 」タブをクリックし、パフォーマンスを表示または成功エクスペリエンスを採用するアクティビティを選択します。 パフォーマンスデータが表示されます。

   ![アクティビティのパフォーマンスの確認](/help/sites-cloud/authoring/assets/activities-performance.png)

1. を選択します。 **勝者を採用** リンクをクリックして、そのエクスペリエンスをデフォルトエクスペリエンスとしてプッシュします。
...
1. 選択 **はい** 勝者を採用することを確認するには、現在のエクスペリエンスを無効にして、勝者エクスペリエンスの内容に置き換えます。
