...
1. オファーコンソールで、オファーの隣のアイコンをタップまたはクリックし、「**編集**」をクリックまたはタップします。
...
1. オファーコンソールで、オファーの隣のアイコンをタップまたはクリックし、「**削除**」をクリックまたはタップします。

   オファーを選択し、「**削除**」をクリックまたはタップします。

1. 表示されるダイアログボックスで、「**削除**」をクリックまたはタップして、削除を確定します。
