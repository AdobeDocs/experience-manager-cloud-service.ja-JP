...
1. ナビゲーションコンソールで、「 **パーソナライズ**. 選択 **オーディエンス**.
1. 選択 **ContextHub セグメントを作成**.
...
1. **新しい ContextHub セグメント**&#x200B;ダイアログボックスで、タイトルを入力し、ブーストを調整して、「**作成**」をクリックします。新しい ContextHub セグメントがオーディエンスリストに表示されます。
   ...
   >[!NOTE]
   >
   >「 」をタップまたはクリックして、変更済みのリストを並べ替えることができます **変更済み** をクリックして、作成したオーディエンスが表示されるよう降順で並べ替えます。
...
1. オーディエンスコンソールで、「 **作成** その後 **Target オーディエンスを作成**.
...
1. [ 規則#1] 領域で、属性タイプを選択し、使用可能なフィールドに属性情報を入力します。 終了したら、属性の右側にあるチェックマークを選択して保存します。すべての属性について詳しくは、[属性とそのオプション](#attributes-and-their-options)を参照してください。
...
1. ナビゲーションコンソールで、「 **パーソナライズ**. 選択 **オーディエンス**.
1. 編集する ContextHub セグメントの横のアイコンを選択し、「 」を選択します。 **編集**.
