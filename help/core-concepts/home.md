...
# Adobe Experience Manager as a Cloud Service の中心概念 {#aem-core-concepts-guide}

ここでは、Adobe Experience Manager as a Cloud Service の中心概念を紹介するセルフヘルプリソースの一覧を示します。

## 中心概念に関する主要な記事 {#key-articles}

* [AEM as a Cloud Service のアーキテクチャ](architecture.md)
