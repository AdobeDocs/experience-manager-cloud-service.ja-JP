...
1. [ログとログ作成](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/logs.html?lang=ja#debugging)
   ...
   * ローカル SDK ログ （host:port/crx-quickstart/logsの下）
...
<tr>
<td>測定</td>
<td><ul><li><a href="https://experienceleague.adobe.com/welcome/aem/part6.html?lang=ja">プロジェクト KPI</a>、成功基準、プロジェクトタイムラインを確立します。</li></ul></td>
</tr>
</table>
