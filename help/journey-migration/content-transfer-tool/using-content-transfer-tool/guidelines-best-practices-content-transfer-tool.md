...
* コンテンツ転送プロセスの&#x200B;*抽出*&#x200B;フェーズを完了した後、*取り込みフェーズ*&#x200B;を開始して AEM as a Cloud Service *ステージング*&#x200B;または&#x200B;*実稼働*&#x200B;インスタンスにコンテンツを取り込む前に、サポートチケットをログに記録します。Adobeに実行の意図を通知 *取得* したがって、Adobeは、 *取得* プロセス。 計画した&#x200B;*取り込み*&#x200B;日付より 1 週間前にサポートチケットをログに記録しますサポートチケットを送信すると、次の手順に関するガイダンスがサポートチームから提供されます。 次の詳細を含むサポートチケットを送信できます。
