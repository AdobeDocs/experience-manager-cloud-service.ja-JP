...
1. これで、リスト表示に移行リストが表示されます。3 つのドット記号 (**...**) をクリックして、ドロップダウンを開き、「 」を選択します。 **抽出キーをコピー**. このキーは、抽出段階で必要になります。 この抽出キーをコピーします。
...
1. クリック **サイズを確認** をクリックしてプロセスを開始します。 移行セットリスト表示に戻り、**サイズ確認**&#x200B;が実行中であることを示すメッセージが表示されます。
