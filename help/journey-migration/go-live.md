...
このジャーニーのこの部分では、コードとコンテンツの両方をAEM as a Cloud Serviceに移行する準備が整ったら、移行を計画および実行する方法を学びます。 また、移行を実行する際のベストプラクティスと既知の制限事項についても説明します。
...
また、最終的なコンテンツ追加がスケジュールされる際に、コンテンツをフリーズする計画を立てる必要があります。
