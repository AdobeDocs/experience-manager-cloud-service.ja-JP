...
| REP | forward.replication <br> reverse.replication <br> standard.replication.agent.modification <br> custom.replication.agent.detection | 作成したレプリケーションエージェントを削除します。<br> または<br>変更/追加されたプロパティを削除します。 |
...
* 使いやすさ：コンテンツ変換サービスは、コンテンツトランスファーツールに統合され、直感的なシンプルなユーザーインターフェイスを備えています。
