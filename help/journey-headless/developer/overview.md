...
このガイドでは、AEMのヘッドレス実装に関する最も多くのトピックを順を追って説明し、完了時に以下をおこないます。
...
>[!TIP]
>
> **やって学びたい、技術的に傾いている場合は、APIとフレームワークで構成され、このドキュメントの最後にある「[その他のリソース」の節](#additional-resources)で参照できるAEMヘッドレスチュートリアルを参照してください。**
...
| ペルソナ | 説明 | このジャーニーでの役割 |
|---|---|---|
| 開発者（ターゲットオーディエンス） | 様々なソースのコンテンツを使用するヘッドレスアプリケーションの開発経験がある | このジャーニーの対象読者 |
