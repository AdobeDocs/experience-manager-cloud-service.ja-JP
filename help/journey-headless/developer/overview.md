...
>title="AEMヘッドレス開発者向けリソースと高度なドキュメント"
>abstract="AEMヘッドレス CMS について学び、より優れたアプリケーションを構築して出荷し、より迅速なエクスペリエンスを実現するために必要なすべてが揃っています。"
>additional-url="https://experienceleague.adobe.com/landing/experience-manager/headless/developer.html?lang=ja" text="AEMヘッドレス開発者リソース"
