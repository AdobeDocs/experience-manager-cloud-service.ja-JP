...
AEMに関する既存の知識を活用して学習したい場合は、APIとフレームワークで構成された実践チュートリアルを参照してください。このチュートリアルでは、AEM ヘッドレス基盤で構築されたアプリケーションの作成と使用について説明します。 AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html?lang=ja)の「[ ヘッドレスのチュートリアル」を参照してください。
