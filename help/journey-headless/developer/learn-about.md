...
一般的に、コンテンツはクライアントサイドでレンダリングされます。これは、通常、誰かがモバイルデバイスでコンテンツを呼び出し、CMS がコンテンツを配信し、その後、モバイルデバイス（クライアント）が、提供したコンテンツのレンダリングを担当することを意味します。 デバイスが古い場合や低速の場合、デジタルエクスペリエンスも低調になります。
