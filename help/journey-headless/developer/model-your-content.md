...
この歌詞が本当かどうかはわかりませんが、これは確かに ***複雑*** そこの世界とデータモデリングは、ある目的に必要な特定の情報を使用して、非常に（非常に）小さなサブセクションの簡略化された表現を定義するために使用されます。
...
その後、コンテンツフラグメントモデルを作成し、構造を定義できます。これは、以下で実行できます。 **ツール** > **一般** > **コンテンツフラグメントモデル**. 次に例を示します。
