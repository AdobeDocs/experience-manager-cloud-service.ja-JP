...
以前のドキュメントのAEMヘッドレス翻訳ジャーニーでは、 [翻訳コネクタを設定](configure-connector.md) AEMでの翻訳フレームワークについて学習しました。 その結果、以下を達成できました。
...
このドキュメントでは、AEM翻訳プロジェクトをコネクタと共に使用してコンテンツを翻訳する方法を説明します。 読み終えると、次のことができるようになります。
