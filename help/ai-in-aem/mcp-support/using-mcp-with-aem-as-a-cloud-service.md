...
| **Cloud Manager** | `/cloudmanager` | プログラム、環境、リポジトリ、パイプラインなどのCloud Manager エンティティを管理します。これらのエンティティはトリガーすることもできます。 <br><br>*この MCP サーバーは&#x200B;**ベータ版**になりました。アクセスをリクエストするには、ユースケースの説明を添えて [3}aemcs-mcp-feedback@adobe.com} にメールで送信してください。](mailto:aemcs-mcp-feedback@adobe.com)* |
