...
現在、多くのAdobe Experience Manager（AEM）チームは、統合開発環境（IDE）や、Cursor、ChatGPT、Anthropic Claude、Microsoft Copilot Studio などのチャットベースのアプリケーションで作業しています。 これらのアプリケーションは、アプリケーションがバックエンドツールを標準化された方法で大規模な言語モデル（LLM）に公開できるようにするモデルコンテキストプロトコル（MCP）をサポートしています。
...
| **Cloud Manager** | `/cloudmanager` | プログラム、環境、リポジトリ、パイプラインなどのCloud Manager エンティティを管理します。これらのエンティティはトリガーすることもできます。 <br><br>*この MCP サーバーは&#x200B;**ベータ版**&#x200B;になりました。アクセスをリクエストするには、ユースケースの説明を添えて [3&rbrace;aemcs-mcp-feedback@adobe.com&rbrace; にメールで送信してください。](mailto:aemcs-mcp-feedback@adobe.com)* |
...
![ChatGPT の設定 – 設定 &#x200B;](assets/chatgpt-1.png)

![ChatGPT の設定 – アプリとコネクタ – 詳細設定 &#x200B;](assets/chatgpt-2.png)

![ChatGPT の設定 – アプリとコネクタ – 開発者モード &#x200B;](assets/chatgpt-3.png)

![ChatGPT の設定 – アプリとコネクタ – アプリを作成 &#x200B;](assets/chatgpt-4.png)

![ChatGPT の設定 – アプリとコネクタ – 新しいアプリ &#x200B;](assets/chatgpt-5.png)

![ChatGPT の設定 – アプリとコネクタ - AEM Content MCP Service](assets/chatgpt-6.png)

![ChatGPT の設定 – AEM Content MCP Service に問い合わせる &#x200B;](assets/chatgpt-7.png)
...
![&#x200B; クラウドの構成 – 設定 &#x200B;](assets/claude-1.png)

![&#x200B; クラウドの設定 – コネクタ &#x200B;](assets/claude-2.png)

![&#x200B; クラウドの設定 – コネクタ – カスタムコネクタの追加 &#x200B;](assets/claude-3.png)

![&#x200B; クラウドの設定 – コネクタ – カスタムコネクタの接続 &#x200B;](assets/claude-4.png)

![&#x200B; クラウドの設定 – コネクタ – カスタムコネクタの設定 &#x200B;](assets/claude-5.png)

![&#x200B; クラウドの設定 – コネクタ – カスタムコネクタツールの権限 &#x200B;](assets/claude-6.png)

![&#x200B; クラウドの設定 – AEM コンテンツ MCP サービスに問い合わせる &#x200B;](assets/claude-7.png)
...
![&#x200B; カーソルの構成 – 設定 &#x200B;](assets/cursor-1.png)

![&#x200B; カーソルの設定 – ツールと MCP - カスタム MCP の追加 &#x200B;](assets/cursor-2.png)

![&#x200B; カーソルの構成 – カスタム MCP 設定の追加 &#x200B;](assets/cursor-3.png)

![&#x200B; カーソルの設定 – 接続 &#x200B;](assets/cursor-4.png)

![&#x200B; カーソルの構成 – 新しいサービスを要求 &#x200B;](assets/cursor-5.png)
...
### Microsoft コパイロット スタジオ {#microsoft-copilot-studio}

![&#x200B; コパイロットの設定 – エージェント &#x200B;](assets/copilot-1.png)

![&#x200B; コパイロットの設定 – ツールの追加 &#x200B;](assets/copilot-2.png)

![&#x200B; コパイロットの設定 – ツールの追加 – モデル コンテキスト プロトコル &#x200B;](assets/copilot-3.png)

![&#x200B; コパイロットの構成 – モデル コンテキスト プロトコル サーバーの追加（プレビュー） &#x200B;](assets/copilot-4.png)

![&#x200B; コパイロットの設定 – ツールの追加 – 新しい接続の作成 &#x200B;](assets/copilot-5.png)

![&#x200B; コパイロットの設定 – ツールの追加 – 追加と設定 &#x200B;](assets/copilot-6.png)

![&#x200B; コパイロットの設定 – ツールの追加 – 設定 &#x200B;](assets/copilot-7.png)

![&#x200B; コパイロットの設定 – 接続のテスト &#x200B;](assets/copilot-8.png)

![&#x200B; コパイロットの設定 – 接続の管理 &#x200B;](assets/copilot-9.png)

![Copilot の設定 – テストエージェント &#x200B;](assets/copilot-10.png)
