...
| **エクスペリエンスガバナンス** | `/experience-governance` | コンテンツ（テキスト、画像、ページ）をブランドガバナンスルールに照らして評価し、ブランドの設定とチェックをリストアップします。<br/>Experience Governance MCPにアクセスするには、お客様が[ エージェント体験版に登録するか、有料ライセンス ](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/trial?lang=en)を持っている必要があります。 |
