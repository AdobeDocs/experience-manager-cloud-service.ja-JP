...
* コンテンツ アドバイザ エージェントからソース アセットを取得する

## アクティベーション {#activation}

Brand Experience Agent をアクティブ化してアクセスできるようにするには、次のいずれかの方法でAdobeに連絡する必要があります。

* E メール送信 `experience-production-agent@adobe.com`
* またはアカウントチームへのお問い合わせ
