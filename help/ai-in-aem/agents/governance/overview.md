...
ガバナンスエージェントには、AI を活用したブランドポリシー読み込み機能も含まれています。この機能では、AI を使用して、顧客の既存のブランドガイドラインドキュメントを、準拠したコンテンツ作成を自動的に管理、検証、ガイドする、構造化された強制可能なポリシーチェックに変換します。 詳しくは、[ ブランドポリシーを読み込む方法 ](/help/ai-in-aem/agents/governance/how-to-import-a-brand-policy.md) を参照してください。
