...
[Discovery Agent](/help/ai-in-aem/agents/discovery/using.md) は、AEMのコンテンツを提供して、クリックのない効率的な検出エクスペリエンスを実現します。 Assets、コンテンツフラグメント、アダプティブFormsをまたいでインテリジェントに検索し、関連する資料（画像、ビデオ、PDF ドキュメント、記事、フォームテンプレートなど）を提供します。
