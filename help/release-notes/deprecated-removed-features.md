...
| Sites | [SPA Editor](/help/implementing/developing/hybrid/introduction.md) | AEMでヘッドレスコンテンツを管理するための優先エディターは、次のとおりです。<br>- [&#x200B; ビジュアル編集のためのユニバーサルエディター](https://www.aem.live/docs/aem-authoring)。<br>- [&#x200B; フォームベース編集のためのコンテンツフラグメントエディター](/help/assets/content-fragments/content-fragments-managing.md)。 |
