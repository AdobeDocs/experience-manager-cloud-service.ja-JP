...
>[!IMPORTANT]
>
>[非推奨のAPI](#aem-apis)が&#x200B;**2026年5月4日**&#x200B;に削除されます。 以下の重要な日付と影響を確認してください。
>
...
>
>デプロイメントブロックを防ぐには、2026年3月30日（PT）より前にAPIの使用を削除してください。
...
ACS AEM Commonsを使用している場合は、少なくともバージョン 6.11.0 （最新バージョンをお勧めします）を使用し、コンテンツパッケージに分類子[を指定して、Cloud Service](https://adobe-consulting-services.github.io/acs-aem-commons/pages/maven.html)のバージョンを`cloud`必ず含めてください。
