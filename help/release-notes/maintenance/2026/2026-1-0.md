---
title: 2026.1.0 機能のアクティベーションに関連する  [!DNL Adobe Experience Manager]  as a Cloud Service のメンテナンスリリースノート。
description: 2026.1.0 機能のアクティベーションに関連する  [!DNL Adobe Experience Manager]  as a Cloud Service のメンテナンスリリースノート。
...
次の節では、2026.1.0 機能のアクティベーションに関連する Experience Manager as a Cloud Service のメンテナンスリリースに関するテクニカルリリースノートの概要を説明します。

## リリース 23963 {#23963}

2026年1月8日（PT）に公開された、メンテナンスリリース 23963 の継続的な改善点を以下にまとめます。 前回のメンテナンスリリースは、リリース 23482 でした。
...
* SITES-25240：ティーザーモーダルのCall to action フィールドに、表示ラベルがない。
* SITES-24869：テンプレートエディター/セパレーター/ポリシーでツールヒントが切り詰められる。
* SITES-19313：テンプレートエディターで削除されたテンプレートにコンポーネントをドラッグ&amp;ドロップすると、エラーがローカライズされない。
