...
source-git-commit: 6486664c631fe376c8a90254aef5985c450c6520
workflow-type: tm+mt
...
### セキュリティの修正 {#security-16799}

AEM as a Cloud Serviceは、プラットフォームのセキュリティとパフォーマンスの最適化に取り組んでいます。 このメンテナンスリリースは、特定された 11 の脆弱性に対処し、堅牢なシステム保護への取り組みを強化しています。
