...
role: Admin
source-git-commit: ed9f1ad22247a4886fdd1554b63ca0952bd3c224
workflow-type: tm+mt
...
パフォーマンスの向上、デバッグの容易さ、長期サポートの強化を実現する [Java Use API](https://experienceleague.adobe.com/ja/docs/experience-manager-htl/content/java-use-api) に移行する必要があります。
