...
role: Admin
source-git-commit: 13edd972d159c92ce09ad307480c94c964ac6110
workflow-type: tm+mt
...
# [!DNL Adobe Experience Manager] as a Cloud Service の 2026.1.0 リリースノート {#release-notes}

以下の節では、[!DNL Experience Manager] as a Cloud Service の 2026.1.0 バージョンの機能リリースノートの概要について説明します。
