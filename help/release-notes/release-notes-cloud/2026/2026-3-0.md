---
title: ' [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.3.0 リリースのリリースノート。'
description: ' [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.3.0 リリースのリリースノート。'
feature: Release Information
role: Admin
source-git-commit: ccbd9c991761640248d664472a938318f3474e88
workflow-type: tm+mt
...
# [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.3.0 リリースノート {#release-notes}

次の節では、[!DNL Experience Manager] as a Cloud Serviceの2026.3.0 バージョンの機能リリースノートの概要を説明します。
...
現在の機能リリース（2026.3.0）である[!DNL Cloud Service]のリリース日は2026年3月26日（PT）です。 [!DNL Adobe Experience Manager]次回の機能リリース（2026.4.0）は、2026年4月30日（PT）に予定されています。
...
2026.3.0 リリースで追加された機能の概要については、2026年3月リリースの概要ビデオをご覧ください。
