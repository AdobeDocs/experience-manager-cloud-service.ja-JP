---
title: ' [!DNL Adobe Experience Manager]  as a Cloud Service 2026.1.0 リリースのリリースノート。'
description: ' [!DNL Adobe Experience Manager]  as a Cloud Service 2026.1.0 リリースのリリースノート。'
...
# [!DNL Adobe Experience Manager] as a Cloud Service の 2026.2.0 リリースノート {#release-notes}

以下の節では、[!DNL Experience Manager] as a Cloud Service の 2026.2.0 バージョンの機能リリースノートの概要について説明します。
