---
title: ' [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.5.0 リリースのリリースノート。'
description: ' [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.5.0 リリースのリリースノート。'
feature: Release Information
role: Admin
nudge: please
source-git-commit: 31eb51ee56814800b4c9acc7a4e93466b1f4c6d5
workflow-type: tm+mt
...
# [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.5.0 リリースノート {#release-notes}

次の節では、[!DNL Experience Manager] as a Cloud Serviceの2026.5.0 バージョンの機能リリースノートの概要を説明します。
