---
title: ' [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.4.0 リリースのリリースノート。'
description: ' [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.4.0 リリースのリリースノート。'
feature: Release Information
role: Admin
source-git-commit: 826f34e02d2ce2f2b70c7158a1642632c57526ac
workflow-type: tm+mt
...
# [!DNL Adobe Experience Manager] as a Cloud Serviceの2026.4.0 リリースノート {#release-notes}

次の節では、[!DNL Experience Manager] as a Cloud Serviceの2026.4.0 バージョンの機能リリースノートの概要を説明します。
