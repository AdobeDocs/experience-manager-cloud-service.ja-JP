---
title: ' [!DNL Adobe Experience Manager]  as a Cloud Service 2025.6.0 リリースのリリースノート。'
...
# [!DNL Adobe Experience Manager] as a Cloud Service の 2025.6.0 リリースノート {#release-notes}

以下の節では、[!DNL Experience Manager] as a Cloud Service の 2025.6.0 バージョンの機能リリースノートの概要について説明します。
...
[!DNL Adobe Experience Manager] as a [!DNL Cloud Service] の最新の機能リリース（2025.6.0）のリリース日は 2025年6月26日です。 次回の機能リリース（2025.7.0）は、2025年8月7日（PT）に予定されています。
...
>[!VIDEO](https://video.tv.adobe.com/v/3470879?captions=jpn&quality=12)
...
* **新しい環境** （今後作成され、個別に通知されます）：
   * **7 日**&#x200B;より古いレプリケーション、DAM、ページ監査ログは、定期的に削除されます。
