...
* サムネールの改善により、コンテンツの縦横比に適合し、より広い領域のコンテンツをカバーできるようになりました。
