...
description: '"[!DNL Adobe Experience Manager] as a Cloud Service Release Notes(2020.11.0)'
...
* [!DNL Dynamic Media] では、アクセシビリティが次のように強化されました。
   ...
   * 公開、アセットを編集、スマート切り抜きを編集、画像セットエディターの各ページが、Web 標準に準拠するように改善されました。支援テクノロジー（AT）を使用すると、これらのページ内を容易に移動し、画像の切り抜きなどの操作を実行できるようになりました。
