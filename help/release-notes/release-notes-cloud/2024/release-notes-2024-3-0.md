...
>[!VIDEO](https://video.tv.adobe.com/v/3450360?captions=jpn&quality=12)
...
* **[Adobe Experience Manager Forms Edge Delivery Services](/help/edge/docs/forms/overview.md)**: Edge Delivery Services for AEM Formsは、作成者が新しいフォームを迅速に更新、公開、起動できる迅速な開発環境を実現する、構成可能な一連のサービスです。 これらのサービスは、エンゲージメントとコンバージョンを促進する、優れた効果の高いフォームエクスペリエンスを提供します。これらのフォームエクスペリエンスは、簡単に作成および開発できます。
...
* 申し込み手続きを効率化し、申し込み手続きを高速化しましょう。オペレーショナルテレメトリを利用して、フォームのパフォーマンスを継続的に監視できます。
...
#### ドメインマッピング（アーリーアダプタープログラム） {#cdn-config-early-adopter}
