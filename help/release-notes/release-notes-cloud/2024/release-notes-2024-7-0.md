...
[Cloud Manager設定パイプラインを使用してパージ API トークンの設定をセルフサービスで実行する方法](/help/implementing/dispatcher/cdn-credentials-authentication.md#purge-API-token)を説明します。これにより、次のいずれかのバリエーションを含むパージ API](/help/implementing/dispatcher/cdn-cache-purge.md)を[呼び出すことができます。
