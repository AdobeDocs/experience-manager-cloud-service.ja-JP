...
以下に、非推奨（廃止予定）のAEM APIの広範なリストと、その削除予定日を示します。 お客様は、コードから削除予定日までにAPIを削除する必要があります。 削除日を過ぎているAPIを使用すると、ローカルのSDK/開発環境とCloud Managerのビルドプロセスでエラーが発生します。
...
<tbody>
  <tr>
    ...
    <td>SlingのAuth Core/Auth Core SPIインターフェイスを代替として使用します。</td>
    <td>2015年</td>
    <td>7/30/21</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>SlingのDiscovery APIを代替として使用する</td>
    <td>2015年</td>
    <td>削除</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>org.json</td>
    <td><a href="https://johnzon.apache.org/index.html">javax.json</a>のApache Johnzon実装をお勧めします。この実装を使用する必要があります。 </td>
    <td>4/30/21</td>
    <td>12/31/21</td>
  </tr>
  <tr>
    <td>org.apache.felix.cm<br>org.apache.felix.cm.file</td>
    <td>カスタム永続性マネージャーは、AEM as aCloud Serviceではサポートされていません。</td>
    <td>4/30/21</td>
    <td>削除</td>
  </tr>
  <tr>
    <td>org.apache.commons.lang<br>org.apache.commons.lang.enums<br>org.apache.commons.lang.builder<br>org.apache.commons.lang.exception<br>org.apache.commons.lang.math<br>org.apache.commons.lang.mutable<br>org.apache.commons.lang.reflect<br>org.apache.commons.lang.text<br>org.apache.commons.lang.time</td>
    <td>Commons Lang 2はメンテナンスモードです。 代わりにCommons Lang 3を使用する必要があります。</td>
    <td>4/30/21</td>
    <td>12/31/21</td>
  </tr>
  <tr>
    <td>org.apache.commons.collections<br>org.apache.commons.collections.bag<br>org.apache.commons.collections.bidimap<br>org.apache.commons.collections.buffer<br>org.apache.commons.collections.collection<br>org.apache.commons.collections.comparators<br>org.apache.commons.collections.functors<br>org.apache.commons.collections.iterators<br>org.apache.commons.collections.keyvalue<br>org.apache.commons.collections.list<br>org.apache.commons.collections.map<br>org.apache.commons.collections.set</td>
    <td>Commons Collections 3はメンテナンスモードです。 代わりにCommons Collections 4を使用する必要があります。</td>
    <td>4/30/21</td>
    <td>12/31/21</td>
  </tr>
  <tr>
    <td>org.apache.felix.systemready</td>
    <td>代わりに、Apache Felix HealthCheck APIを使用することをお勧めします</td>
    <td>4/30/21</td>
    <td>削除</td>
  </tr>
  <tr>
    <td>org.apache.felix.webconsole<br>org.apache.felix.webconsole.bundleinfo<br>org.apache.felix.webconsole.i18n</td>
    <td>Felix Webコンソールは、クラウド環境ではサポートされていません</td>
    <td>4/30/21</td>
    <td>7/30/21</td>
  </tr>
  <tr>
    ...
    <td>Eclipse JettyおよびFelix Http Jettyパッケージはサポートされなくなりました。</td>
    <td>5/27/21</td>
    <td>8/26/21</td>
  </tr>
  <tr>
    ...
    <td>このAPIの使用は、AEM as aCloud Serviceではサポートされていません。</td>
    <td>5/27/21</td>
    <td>7/30/21</td>
  </tr>
  <tr>
    <td>org.apache.felix.metatype<br>org.apache.felix.scr<br>org.apache.felix.scr.info</td>
    <td>Apache FelixのメタタイプとSCR APIは非推奨（廃止予定）となりました。  代わりに、OSGiメタタイプと宣言型サービスAPIを使用してください。</td>
    <td>5/27/21</td>
    <td>8/26/21</td>
  </tr>
  <tr>
    <td>oorg.slf4j.impl</td>
    <td>ログ実装クラスは、AEM as aCloud Serviceと互換性がありません。</td>
    <td>7/4/21</td>
    <td>8/26/21</td>
  </tr>
  <tr>
    <td>org.apache.abdera<br>org.apache.abdera.model<br>org.apache.abdera.factory<br>org.apache.abdera.ext.media<br>org.apache.abdera.util<br>org.apache.abdera.i18n.iri<br>org.apache.abdera.writer<br>org.apache.abdera.i18n.rfc4646<br>org.apache.abdera.i18n.rfc4646.enums<br>org.apache.abdera.i18n.text<br>org.apache.abdera.filter<br>org.apache.abdera.xpath<br>org.apache.abdera.i18n.text.io<br>org.apache.abdera.i18n.text.data<br>org.apache.abdera.parser</td>
    <td>このAPIは、Apache Abderaは2017年以降廃止されたプロジェクトなので非推奨（廃止予定）となりました。</td>
    <td>7/29/21</td>
    <td>09/29/21</td>
  </tr>
  <tr>
