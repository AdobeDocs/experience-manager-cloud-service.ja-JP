...
1. 自分用、組織全体用、または選択したグループ用にのみ、項目をピン留めする必要がある場合に選択します。次を選択した場合、 **[!UICONTROL グループの場合]**、「 **[!UICONTROL グループのピン留め]** フィールドに入力します。
...
現在割り当てられているタスクのリストを **[!UICONTROL マイタスク]** タブ ( 自分が **[!UICONTROL 割り当て済みタスク]** 」タブに追加され、 **[!UICONTROL 完了したタスク]** タブをクリックします。 タスクを選択し、 **[!UICONTROL 質問の完了]** タスクを承認または却下する場合。 タスクを選択し、「**[!UICONTROL タスクの詳細を開く]**」をクリックして、タスクを表示し、承認、却下、編集または削除することもできます。
