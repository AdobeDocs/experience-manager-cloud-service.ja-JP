...
[!DNL Assets view] には、[!DNL Adobe Photoshop Express] を利用した使いやすい編集オプションが用意されています。使用可能な編集操作は、スポット修復、切り抜きと角度補正、画像のサイズ変更、画像の調整です。

画像の編集後、新しい画像を新しいバージョンとして保存できます。バージョン管理を使用すると、必要に応じて後で元のアセットに戻すことができます。画像を編集するには、[プレビューを開き](/help/assets/navigate-assets-view.md#preview-assets)、右側のパネルで&#x200B;**[!UICONTROL 画像編集]**&#x200B;アイコン（![編集アイコン](assets/do-not-localize/edit-icon.png)）をクリックします。
