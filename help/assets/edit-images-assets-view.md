...
1. 「**[!UICONTROL 適用]**」をクリックし、変更を適用します。
   ...
   編集した画像はダウンロードできます。 編集したアセットを同じアセットの新しいバージョンとして保存するか、新しいアセットとして保存することができます。   ![Adobe Express を使用した画像の保存](assets/adobe-express-resize-save.png)
...
![Essentials UI での Express](/help/assets/assets/express-in-essentials-ui.jpg)
[!DNL Adobe Express]組み込みエディターを使用して画像を編集するには、次の手順に従います。
...
>[!NOTE]
>
>PSD ファイルをAdobe Express ドキュメントとして保存すると、元のPSD ファイルのレイヤーが保持されます。


#### Express エディターでの画像編集の制限事項 {#limitations-of-editing-images-in-the-express-editor}

* サポートされているファイル形式：JPEG、PSD、またはPNG
...
* 新しいExpress ドキュメントのキャンバスには、1つのディメンションにつき最大8000 ピクセルまで許可します
