...
+ デジタルアセットの管理 {#manage}
   ...
   + [ [!DNL Creative Cloud] API を使用してアセットを処理する](cc-api-integration.md)
...
+ Dynamic Media {#dynamicmedia}
   + [Experience League 提供の Dynamic Media ニュースレターアーカイブ](dynamic-media/dynamic-media-newsletter.md)
   ...
   + [Dynamic Media 画像プリセットを管理する](dynamic-media/managing-image-presets.md)
   + [Dynamic Media 画像プリセットを適用する](dynamic-media/image-presets.md)
   + [Dynamic Media ビューアプリセットを管理する](dynamic-media/managing-viewer-presets.md)
   + [Dynamic Media ビューアプリセットを適用する](dynamic-media/viewer-presets.md)
   + [バッチセットプリセット](dynamic-media/batch-set-presets-dm.md)
   + [Dynamic Media を使用して CDN キャッシュを無効化する](dynamic-media/invalidate-cdn-cache-dynamic-media.md)
   + [Dynamic Media Classic を使用して CDN キャッシュを無効化する](dynamic-media/invalidate-cdn-cache-dm-classic.md)
   + [スマートイメージング](dynamic-media/imaging-faq.md)
   + [Dynamic Media アセットを配信する](dynamic-media/delivering-dynamic-media-assets.md)
   + [Dynamic Media でホットリンク保護を有効化する](dynamic-media/hotlink-protection.md)
   ...
   + [ビデオ（Dynamic Media 内）](dynamic-media/video.md)
   ...
   + [Dynamic Media ビューアと Adobe Analytics および Adobe Experience Platform タグを統合する](dynamic-media/tags.md)
   + [クイックビューを使用してカスタムポップアップを作成する](dynamic-media/custom-pop-ups.md)
   + [レスポンシブサイトに最適化された画像を配信する](dynamic-media/responsive-site.md)
   + [Dynamic Media アセットをプレビューする](dynamic-media/previewing-assets.md)
   + [ページに Dynamic Media アセットを追加する](dynamic-media/adding-dynamic-media-assets-to-pages.md)
   + [Dynamic ビデオビューアまたは画像ビューアを Web ページに埋め込む](dynamic-media/embed-code.md)
   + [Web アプリケーションに URL をリンクする](dynamic-media/linking-urls-to-yourwebapplication.md)
   + [ルールセットを使用して URL を変換する](dynamic-media/using-rulesets-to-transform-urls.md)
   + [Dynamic Media アセットを公開する](dynamic-media/publishing-dynamicmedia-assets.md)
   + [Dynamic Media で選択的公開を使用する](dynamic-media/selective-publishing.md)
   + [セレクターを使用する](dynamic-media/working-with-selectors.md)
