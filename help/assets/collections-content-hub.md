...
### AEM Assets Content Hubではコレクションと呼ばれるものはどれですか？

AEM Assets Content Hubのコレクションは、ユーザー間で共有できる一連のアセットを指します。 コレクションには、参照整合性を維持しながら、様々な場所のアセットを含めることができます。 コンテンツに効率的にアクセスし、利用するための共有スペースを作成します。

### AEM Assets Content Hubで新しいコレクションを作成するにはどうすればよいですか？

AEM Assets Content Hubで新しいコレクションを作成するには、「コレクション」タブに移動し、「**コレクションを作成**」をクリックします。 新しいコレクション ウィンドウで、「タイトル」と「説明」を追加し、「**アクセスできるユーザー**」ドロップダウンリストでアクセス制御タイプを選択して、「**作成**」をクリックします。 その後、コレクションにアセットを追加できます。

### AEM Assets Content Hubでコレクションを作成する際に使用できるアクセス制御の種類を教えてください。

AEM Assets Content Hubには、アクセス制御の種類が 3 つあります。**プライベート** – 作成者と管理者のみが編集およびアクセスできる、**パブリック** – 表示のみ – すべてのユーザーが表示できますが、作成者と管理者のみが編集できる、**パブリック** – 表示と編集 – すべてのユーザーが制限なくコレクションにアクセスして編集できます。

### AEM Assets Content Hub内のコレクションに対するアクションを実行できるのは誰ですか？

AEM Assets Content Hub ユーザーは、コレクションの作成、表示、共有、ダウンロード、削除、削除、ピン留め、お気に入りとしてマークするなどのアクションを実行できます。 管理者は、すべてのアクセスオプションの表示やコレクションの削除など、追加の権限を持っています。

### AEM Assets Content Hubで既存のコレクションにアセットを追加する方法を教えてください。

AEM Assets Content Hubで既存のコレクションにアセットを追加するには、追加するアセットを選択し、「**コレクションに追加**」をクリックして、リストからコレクションを選択します。 検索バーを使用してコレクションを検索することもできます。 **コレクションに追加** をクリックして、アクションを確定します。

### AEM Assets Content Hubでコレクションをフィルタリングおよび検索できますか？

はい。AEM Assets Content Hub内でコレクションを名前、アクセス権限、作成者でフィルタリングおよび検索できます。 フィルターには、「**すべてのコレクション**」、「**自分のみ**」、「**誰でも閲覧できる**」、「**誰でも編集できる**」、「**誰でも作成**」、「**自分で作成** などのオプションが含まれます。

### AEM Assets Content Hubのコレクションからアセットをダウンロードするにはどうすればよいですか？

AEM Assets Content Hubのコレクションからアセットをダウンロードするには、「**コレクション**」タブに移動し、コレクションカードのダウンロードアイコンをクリックしてすべてのアセットをダウンロードします。 また、コレクションを開き、個々のアセットを選択し、「**ダウンロード**」をクリックして個別にダウンロードすることもできます。

### AEM Assets Content Hub内のコレクションからアセットを共有するにはどうすればよいですか？

Assetsを共有するには、AEM Assets Content Hubで公開リンク共有を有効にします。 アセットカードの共有アイコンを選択して、共有リンクをコピーします。このリンクは、受信者に送信できます。 プライベートコレクションは共有できません。

### AEM Assets Content Hubのコレクションからアセットを削除できるのは誰ですか。

コレクションの所有者、管理者、編集権限を持つ非管理者ユーザーは、AEM Assets Content Hubのコレクションから 1 つまたは複数のアセットを削除できます。 削除するには、アセットを選択し、「**コレクションから削除**」をクリックして、削除を確認します。

### AEM Assets Content Hubからコレクションを削除できるユーザーと方法を教えてください。

管理者およびコレクションの作成者のみがコレクションを削除できます。 削除するには、「コレクション」タブに移動し、コレクションを選択して、削除アイコンをクリックします。 コレクションがAEM Assets Content Hubから削除されます。

### AEM Assets Content Hubのコレクションに対して管理者が設定できるのは、どのようなオプションですか？

管理者は、AEM Assets Content Hubのコレクションに対して、次のオプションを有効または無効にできます。

* **コレクションのみを表示** 切替スイッチを有効にして、すべてのユーザーがアクセスできるが、作成者と管理者のみが編集できるコレクションを許可します。
