...
### コレクションを作成する際に使用できるアクセス制御の種類を教えてください。

アクセス制御タイプは 3 つあります。**プライベート** – 編集およびアクセスできるのは作成者と管理者のみ、**パブリック** – 表示のみ – すべてのユーザーが表示できますが、編集できるのは作成者と管理者のみ、**パブリック** – 表示と編集 – すべてのユーザーが制限なくコレクションにアクセスして編集できます。

### Content Hub内のコレクションに対するアクションを実行できるのは誰ですか？

Content Hub ユーザーは、コレクションの作成、表示、共有、ダウンロード、削除、削除、ピン留め、お気に入りとしてマークするなどのアクションを実行できます。 管理者は、すべてのアクセスオプションの表示やコレクションの削除など、追加の権限を持っています。

### AEM Assets Content Hubで既存のコレクションにアセットを追加する方法を教えてください。

追加するアセットを選択し、「**コレクションに追加** をクリックして、リストからコレクションを選択します。 検索バーを使用してコレクションを検索することもできます。 **コレクションに追加** をクリックして、アクションを確定します。
...
Assetsを共有するには、Content Hubで公開リンク共有を有効にします。 アセットカードの共有アイコンを選択して、共有リンクをコピーします。このリンクは、受信者に送信できます。 プライベートコレクションは共有できません。

### AEM Assets Content Hubのコレクションからアセットを削除できるのは誰ですか。

コレクションの所有者、管理者、編集権限を持つ非管理者ユーザーが、コレクションから 1 つまたは複数のアセットを削除できます。 削除するには、アセットを選択し、「**コレクションから削除**」をクリックして、削除を確認します。
