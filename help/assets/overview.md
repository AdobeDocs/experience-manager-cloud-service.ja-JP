...
<td>
   ...
   <div>
      <a href="https://experienceleague.adobe.com/ja/docs/experience-manager-desktop-app/using/get-started">
      <strong>AEM デスクトップアプリを使用</strong>
...
<td>
   ...
   <div>
      <a href="https://helpx.adobe.com/jp/enterprise/using/adobe-asset-link.html">
      <strong>Adobe Asset Linkの使用</strong>
...
**スマートタグ**: スマートタグは、Adobe AIの人工知能を活用したフレームワークを使用して、タグ構造とビジネス分類法に関する画像認識アルゴリズムをトレーニングします。 その後、このコンテンツインテリジェンスを使用して、アセットの個々のセットに関連性の高いタグが適用されます。 デフォルトでは、AEM は、アップロードされたアセットにスマートタグを自動的に適用します。

**インテリジェントなカラーベースのタグ付けと検索**: AEM Assetsでは、Adobe AI機能を使用して画像内のカラーを区別し、取り込み時に自動的にタグとして適用します。 これらのタグを使用すると、画像のカラー構成に基づいて検索エクスペリエンスを強化できます。
...
**AI を活用したアセットの一括名前変更**：[アセットビューでは、人工知能を使用して複数のアセットの名前を一度に変更できます](/help/assets/bulk-rename-assets-view.md)。 複数のファイルを一度に選択し、まとめて名前を変更できます。 会話形式の名前変更プロンプトの例には、*すべてのファイルを「my-file」に変更し、増分番号*&#x200B;と&#x200B;*ファイルのプレフィックスに001、002などを追加して英語*&#x200B;に翻訳するというものがあります。
...
<td>
   ...
   <div>
      <a href="/help/assets/smart-tags.md">
      <strong>AI スマートタグをアセットに追加</strong>
...
<td>
   ...
   <div>
      ...
      <strong> インテリジェントなカラーベースのタグを追加</strong>
...
<td>
   ...
   <div>
      <a href="/help/assets/search-assets-view.md#search-firefly">
      <strong>Adobe Fireflyを使用してアセットを生成</strong>
...
**スマート切り抜き**: Adobe AI機能。画像やビデオの焦点を自動的に検出し、切り抜いて維持できます。 画面サイズに関係なく、意図した目標地点をキャプチャして、面倒な手動タスクを排除し、あらゆるデバイスや画面で美しく表示される、高画質で読み込みが速い画像とビデオを配信します。
...
<td>
   ...
   <div>
      <a href="/help/assets/dynamic-media/video.md">
      <strong>AIが生成したビデオキャプション </strong>
...
<td>
   ...
   <div>
      <a href="/help/assets/search-assets-view.md">
      <strong>Assets ビューでアセットを検索</strong>
...
* **Content Advisor**: Content Advisorは、Experience Manager Assets リポジトリと統合されたユーザーインターフェイスを提供し、リポジトリで使用可能なデジタルアセットを参照または検索できるようにします。 その後、アプリケーションのオーサリングエクスペリエンスで使用できます。Content Advisorは、AdobeまたはAdobe以外のアプリケーションと統合できます。
...
<td>
   ...
   <div>
      <a href="/help/assets/dynamic-media-open-apis-overview.md">
      <strong>OpenAPI機能を備えたDynamic Mediaの概要</strong>
...
<td>
   ...
   <div>
      <a href="/help/assets/restrict-assets-delivery.md">
      <strong>Experience Managerのアセットへのアクセスを制限</strong>
...
<td>
   ...
   <img alt="コンテンツアドバイザー" src="./assets/integration-asset-selector.jpeg" />
   </a>
   <div>
      <a href="/help/assets/integrate-adobe-non-adobe-applications.md">
      <strong> コンテンツアドバイザー</strong>
      
   </div>
   <p>
      <em>Content AdvisorをAdobeまたはAdobe以外のアプリケーションと統合する方法について説明します。</em>
   </p>
</td>
</table>
...
* **AEM AssetsとEdge Delivery Servicesのドキュメントベースのオーサリングフローの統合**: [!DNL AEM Assets]が[!DNL Microsoft Word]や[!DNL Google Docs]などのドキュメントベースのオーサリングツールと統合すると、オーサリングツールにContent Advisorが提供されます。 コンテンツアドバイザーを使用して[!DNL AEM Assets]にアクセスし、承認済みアセットをコンテンツに挿入します。既に [!DNL Edge Delivery Services] web サイトを使用している場合は、[[!DNL AEM Assets]  プラグイン](https://github.com/adobe-rnd/aem-assets-plugin/blob/main/README.md)のドキュメントを参照して、[!DNL AEM Assets] を既存の [!DNL AEM] プロジェクトに統合する方法を確認してください。
...
<td>
   ...
   <div>
      <a href="/help/assets/integrate-aem-assets-edge-delivery-services.md">
      <strong>AEM AssetsとEDS</strong>の統合
...
AEM as a Cloud Serviceは、コンテンツ管理、最適化、ガバナンスを強化するためのインテリジェントな&#x200B;**Agents**&#x200B;を提供します。 これらのエージェントにより、ユーザーはコンテンツをすばやく発見してキャンペーンを最適化し、デジタルアセット全体のコンプライアンスを確保できます。

**検出エージェント**

Discovery Agentは、自然な会話型プロンプトを通じて、AEMコンテンツをオンデマンドで提供し、クリックのない効率的な発見体験を実現します。 **Assets、コンテンツフラグメント、およびアダプティブForms**&#x200B;をまたいでインテリジェントに検索し、画像、ビデオ、PDF、記事、フォームテンプレートなどの関連コンテンツを配信します。 AEM Assetsのインターフェイスで自然言語を使用して、複雑なクエリを作成したり、フィルターを適用したりすることなく検索できます。 プロンプトに基づいて、エージェントはアセットのメタデータと配信URLと共に厳選された結果を返し、他のアプリケーションに埋め込む準備が整います。

Discovery Agentの主な利点は次のとおりです。

* **統合コンテンツ検出：**&#x200B;単一の会話型インターフェイスから、画像、ビデオ、PDF ドキュメント、記事、フォームなど、あらゆる種類のAEM コンテンツにアクセスできます。
* **キャンペーンのプランニングを高速化：**&#x200B;電子メール、Web、ソーシャルチャネルをまたいで、マーケティングキャンペーンのビジュアルとフォームをすばやく収集できます。
* **生産性の向上：**&#x200B;自動化されたインテントベースの検索により、リポジトリの参照やメタデータのフィルタリングに費やす時間を削減します。
* **一貫したコンテンツ利用率：**&#x200B;承認済みのアセットとフラグメントを再利用し、チャネル全体でブランドの一貫性を維持します。

**スキル：**&#x200B;自然言語コンテンツの検索、タグベースのアセットの検索、フォルダーベースのコンテンツの検索、形式と方向ベースのアセットの検索\
**ペルソナ：**&#x200B;のキャンペーンマネージャー、チャネルマーケター、DAM ライブラリ、代理店およびパートナー\
**AEMのAI アシスタントを介したアクセス：**

**一般的な使用例/サンプルプロンプト：**

* フォルダーWKNDに「office」タグ付きの画像を表示します。
* WKND飲料用に公開されているすべてのコンテンツフラグメントを一覧表示します。
* 求人応募フォームの検索。
* 人物を横向きにアセットを表示します。

**Content Optimization Agent**

**Content Optimization Agent**&#x200B;は、自然言語プロンプトを使用してアセットを調整するのに役立ちます。 新しいレンディションの生成、ビジュアルの調整、背景の変更をおこない、チャネルに合わせたバリエーションを自動的に作成できます。 Discovery Agentおよび&#x200B;**Dynamic Media with OpenAPI**&#x200B;と連携し、シームレスな最適化を実現します。

**主なメリット：**

* **簡単なアセット変換：**&#x200B;画像のサイズ変更、シャープ化、再配色、またはミラー。
* **チャネルに合わせて最適化された出力：** Instagram、web バナー、その他のマーケティングチャネル用のレンディションを生成します。
* **Creativeの大規模な機能強化：**&#x200B;大量のワークフローに対して背景の変更またはオーバーレイを適用します。

**AEMのAI アシスタントを介して** アクセスできます。

**サンプルプロンプト：**

* 2000 pxのJPEG レンディションを作成します。
* 画像をシャープにします。
* 背景色を#ff8932に変更します。
* Instagram ストーリーのレンディションを作成する。

**制限：**&#x200B;一部の最適化はPNG アセットでサポートされていません。

**ガバナンスエージェント**

Governance Agentは、AEMのコンテンツ全体のコンプライアンス、ブランドの一貫性、ポリシーの適用を確保するのに役立ちます。 メタデータ、アクセシビリティ、企業ガイドラインを満たしていないコンテンツを特定します。

Governance Agentの主な利点は次のとおりです。

* **コンプライアンス監視：** コンテンツのポリシー違反を検出します。
* **メタデータの適用：** アセットがガバナンスに必要なメタデータを持っていることを確認します。
* **ブランドの一貫性：**&#x200B;企業標準を満たさないコンテンツにフラグを付けます。

**スキル：** ポリシーコンプライアンス チェック、メタデータ検証、アクセシビリティ監査、違反に対する自動アラート\
**ペルソナ：** DAM管理者、コンプライアンス担当者、ブランドマネージャー\
AEM AI アシスタントを介した&#x200B;**アクセス：**

**一般的な使用例/サンプルプロンプト：**

* WKND フォルダー内のすべてのアセットのメタデータを検証します。
* ブランドガイドラインに欠けているアセットを特定。
* 公開されたコンテンツを監査し、アクセシビリティコンプライアンスを確保。
...
<td>
   ...
   <img alt="Discovery Agentの概要" src="./assets/discovery-agent.jpg" />
   </a>
   <div>
      <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/discovery/overview">
   ...
   <p>
      <em>Discovery Agentとその会話型コンテンツ発見機能の概要。</em>
   </p>
</td>
...
<td>
   ...
   <div>
      <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/content-optimization/overview">
      <strong>Content Optimization Agentの概要</strong>
      
   </div>
   <p>
      <em>Content Optimization Agentとサポートされる最適化ワークフローの概要。</em>
   </p>
</td>
...
<td>
   ...
   <div>
      <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview">
      <strong> ガバナンスエージェントの概要</strong>
      
   </div>
   <p>
      <em> コンプライアンスとポリシー適用のためのガバナンスエージェントの概要。</em>
   </p>
</td>
</table>
...
エージェントには、AEM Cloud Serviceの&#x200B;**AI アシスタント**&#x200B;からアクセスできます。 [experience.adobe.com](https://experience.adobe.com/)にログインし、自然言語プロンプトを使用してAI アシスタントと対話します。
...
<td>
   ...
   <div>
      <a href="/help/assets/edit-images-content-hub.md">
      <strong>Adobe Expressを使用した編集</strong>
...
* **スマート切り抜き**：画像やビデオの焦点を自動検出し、切り抜いて維持するAdobe AI機能。 画面サイズに関係なく、意図した目標地点をキャプチャして、面倒な手動タスクを排除し、あらゆるデバイスや画面で美しく表示される、高画質で読み込みが速い画像とビデオを配信します。
...
<td>
   ...
   <div>
      <a href="/help/assets/dynamic-media/dynamic-media.md">
      <strong>Dynamic Mediaの操作</strong>
...
<td>
   ...
   <div>
      <a href="/help/assets/dynamic-media/dm-best-practices.md">
      <strong>Dynamic Mediaのベストプラクティス </strong>
...
<td>
   ...
   <div>
      <a href="/help/assets/insights-content-hub.md">
      <strong>Content HubのAssets インサイト </strong>
