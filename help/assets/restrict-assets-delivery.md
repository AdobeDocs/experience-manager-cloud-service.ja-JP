...
1. 新しく追加されたフィールドをクリックし、**[!UICONTROL 設定]**&#x200B;パネルで次の更新を行います。
   ...
   1. **[!UICONTROL 時刻** フィールドの&#x200B;**On Time フィールドの** Off Time **フィールドの&#x200B;_マップをプロパティ]**から_./jcr:content/onTime _に更新します。/jcr:content/offTime_。
...
1. **[!UICONTROL メタデータプロパティ]**&#x200B;を&#x200B;_./jcr:content/onTime_&#x200B;に更新して、**On Time** フィールドと&#x200B;_./jcr:content/offTime_ for **Off Time** フィールドを作成します。
1. 「**[!UICONTROL 保存]**」をクリックします。
