...
1. 新しく追加されたフィールドをクリックし、**[!UICONTROL 設定]**&#x200B;パネルで次の更新を行います。
   ...
   1. 「**[!UICONTROL プロパティにマッピング]**」を _.:contentOn Time_ フィールドと **の/jcr**/onTime _「オフタイム :content フィールドの場合は_ jcr **/offTime**。
...
1. **[!UICONTROL メタデータプロパティ]**&#x200B;を _.:contentOn Time_ フィールドと **の/jcr**/onTime _「オフタイム :content フィールドの場合は_ jcr **/offTime**。
1. 「**[!UICONTROL 保存]**」をクリックします。
