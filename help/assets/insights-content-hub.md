...
### AEM Assets Content HubにAssetsインサイトは何が必要ですか？

Adobe AEM AssetsのAssets Insightsは、キャンペーン、チャネル、リージョンをまたいで、アセット使用状況の統計情報に関する貴重なデータを提供し、マーケティング関係者がアセットのパフォーマンスと人気度を理解してユーザーエクスペリエンスを向上させるのに役立ちます。

### AEM Assets Content Hub内のAssets インサイトに記載されている機能にアクセスできるのは誰ですか？

AEM Assets Content Hub ユーザーは、アクションを実行し、「Assets インサイト」セクションに記載されている機能にアクセスできます。

### AEM Assets Content Hubの「インサイト」タブでは、どのようなアセットインサイトを利用できますか？

リポジトリ内のアセット数、コレクション数、年、月、日ごとのAssets アップロード、日または月ごとのアクティブユーザー、AEM Assets Content Hub内のファイル形式に基づくアセット分類を表示できます。

### AEM Assets Content Hubでアップロードされたアセットの統計情報を表示するにはどうすればよいですか？

「インサイト」タブに移動して、AEM Assets Content Hubでアップロードされたアセットとコレクションの統計情報を表示できます。ここでは、アップロード履歴を年、月、日ごとに追跡できます。

### AEM Assets Content Hubのユーザーアクティビティに関して、どの指標を分析できますか？

AEM Assets Content Hubでは、アクティブなユーザー数を日別または月別に分析できます。このデータは、折れ線グラフで視覚的に表現されます。
