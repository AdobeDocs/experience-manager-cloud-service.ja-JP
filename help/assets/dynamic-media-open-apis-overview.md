...
<td>
   ...
   <div>
      <a href="/help/assets/approve-assets.md">
      <strong>Experience Manager Assetsでアセットを承認</strong>
      </a>
   </div>
   <p>
...
<td>
   ...
   <div>
      <a href="/help/assets/integrate-dynamic-media-open-apis.md">
      <strong>AEM Assetsと下流アプリケーションの統合</strong>
      </a>
   </div>
   <p>
      <em>検索および配信APIを使用して、独自のカスタムユーザーインターフェイスをExperience Manager Assets リポジトリと統合するか、Adobe Content Advisorを使用します。</em>
   </p>
</td>
<td>
...
<td>
   ...
   <div>
      <a href="/help/assets/deliver-assets-apis.md">
      <strong>下流アプリケーションへのアセットの配信</strong>
      </a>
   </div>
   <p>
...
<td>
   ...
   <div>
      <a href="/help/assets/dynamic-media-open-apis-faqs.md">
      <strong>OpenAPI機能を備えたDynamic Mediaに関するよくある質問</strong>
      </a>
   </div>
   <p>
