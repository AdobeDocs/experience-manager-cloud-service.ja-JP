...
description: メタデータの種類と、アセットのメタデータの管理を [!DNL Adobe Experience Manager Assets] で支援して、アセットの分類と整理を容易にする方法について説明します。 [!DNL Experience Manager] では、メタデータに基づいてアセットを自動的に整理および処理することができます。
contentOwner: AG
mini-toc-levels: 1
