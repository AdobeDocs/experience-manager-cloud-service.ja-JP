---
title: Content Advisorを使用して、Adobe アプリケーション内のAEM コンテンツにアクセスします
description: Content Advisorは、Adobeアプリケーション全体で統合されたコンテンツ発見体験を提供し、コンテキストに即したインテリジェントな発見をオーサリング体験に直接提供します。
...
# Content Advisorを使用して、Adobe アプリケーションでAEM コンテンツにアクセスする{#content-advisor-aem-assets-adobe-applications}

Content Advisorは、Adobeアプリケーション全体で統合されたコンテンツ発見体験を提供します。 Adobe Workfront（近日リリース予定）、AJO B2C （近日リリース予定）、AEM Sitesなどのアプリケーションとネイティブに統合されたContent Advisorは、コンテンツ（アセットとコンテンツフラグメント）を単一のインテリジェントなインターフェイスで連携します。 これにより、ワークフロー内で最も関連性の高いコンテンツを簡単に見つけ、参照、再利用できるようになり、コンテキストを損なうことなく、迅速に移動できます。

>[!IMPORTANT]
> 
> コンテンツフラグメントのピルは現在使用できません。適切なAdobe アプリケーションでは、まもなくサポートされる予定です。
...
* コンテンツフラグメントを作成したAEM Sites環境へのアクセス。
...
Content Advisor![のアセットの](assets/content-advisor-ai-search.png)AI 検索
...
コンテンツアドバイザー![の](assets/content-advisor-content-fragments.png) コンテンツフラグメント
...
|--------------------------------------|----------------------------------------------|-----------------------------------------------------------|--------------------------------------------------------|------------------------------------------|
| AEM Sites（ドキュメントベースのオーサリング） | ✓ | − | ✓ | − |
| AEM Sites（ドキュメントオーサリング） | ✓ | ✓ | ✓ | − |
| AEM Sites（コンテンツフラグメントエディター） | ✓ | ✓ | ✓ | − |
| AEM Sites（ユニバーサルエディター） | ✓ | ✓ | ✓ | − |
