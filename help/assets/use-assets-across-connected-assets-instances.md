...
リモート DAM デプロイメントに接続するための Sites インスタンスの最適な数字を評価します。 接続された各 Sites インスタンスがリモート DAM のデータトラフィックに寄与するため、アドビでは Sites インスタンスをデプロイメントに増分的に接続し、リモート DAM でパフォーマンスに影響がないことをテストすることをお勧めします。
