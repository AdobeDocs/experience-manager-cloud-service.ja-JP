...
Adobe ExpressおよびAEM Assets Content Hubにアクセスする権限を持ち、アセットを新しいバリエーションにリミックスする権限を持つユーザーは、Content Hubを使用して画像を編集できます。

### AEM Assets Content HubでAdobe Expressを使用して画像を編集するにはどうすればよいですか。

画像を編集するには、画像のアセットカードで **Adobe Expressで開く** をクリックするか、画像の詳細を開いて、Adobe Express ロゴをクリックします。 これにより、AEM Assets Content Hub内の埋め込みAdobe Express エディターが読み込まれ、プラットフォームを離れることなく編集できます。

### Adobe Expressには、AEM Assets Content Hub内でどのような編集機能がありますか？

Adobe Expressでは、画像のサイズ変更、背景色の削除や変更、画像の切り抜き、AI 生成画像やテキストとの組み合わせなど、様々な画像編集機能を提供します。

### 編集した画像をAEM Assets Content Hubと同じように保存するには、どのファイル形式を使用できますか？

編集した画像は、PNG （高品質）、JPG（小さなファイルに適している）、PDF（ドキュメントに適している）形式で保存できます。

### 編集した画像をContent Hubに保存する際には、どのようなフィールドに入力する必要がありますか？

編集した画像を保存する際には、「**名前を付けて保存**」フィールドにアセットの名前を、「**キャンペーン名**」フィールドにキャンペーン名を指定する必要があります。 Adobeでは、検索性と編成性を高めるために、「キーワード」、「チャネル」、「期間」、「地域」などの追加フィールドに値を指定することをお勧めします。

### 編集内容を新しいアセットとしてContent Hubに保存できますか？

はい。編集が完了したら、「**新しいアセットとして保存**」をクリックして、変更内容を新しいアセットとしてContent Hubに保存できます。
