...
Adobe I/Oで新しい設定を作成し、AEM AssetsをBrand Portalで設定できます。
...
* [AEM AssetsからBrand Portalへのアセットの公開](publish-to-brand-portal.md#publish-assets-to-bp)
...
* queue-bpdistributionagent0 (DSTRQ3):Systemは、アセットを含むフォルダーをBrand Portalに複製します。
