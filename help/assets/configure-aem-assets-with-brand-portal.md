...
会社で[ セキュアプレビューが有効になっている](#https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public.html?lang=en)状態でDynamic Media-Scene7を使用する場合は、SPS （Scene7 Publishing System）フラッシュ UIを使用して、各地域のパブリックエグレス IP](#https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public.html?lang=en#testing-the-secure-testing-service)をScene7会社管理者[が許可リストに加えるすることをお勧めします。エグレス IP は次のとおりです。
