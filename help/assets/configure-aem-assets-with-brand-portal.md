...
>[!NOTE]
>
> 2024年6月以降は、新しい JWT 資格情報を作成できません。 今後は、OAuth 資格情報のみが作成されます。詳しくは、[OAuth 設定の作成](https://experienceleague.adobe.com/ja/docs/experience-manager-cloud-service/content/security/setting-up-ims-integrations-for-aem-as-a-cloud-service#creating-oauth-configuration:~:text=For%20example%3A-,Creating%20an%20OAuth%20configuration,-To%20create%20a)を参照してください。
...
**セキュアプレビューが有効になっている場合は、SPSでエグレス IPを許可リストに加えるします**
会社で[&#x200B; セキュアプレビューが有効になっている](#https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public.html?lang=ja)状態でDynamic Media-Scene7を使用する場合は、SPS （Scene7 Publishing System）フラッシュ UIを使用して、各地域のパブリックエグレス IP[&#128279;](#https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public.html?lang=ja#testing-the-secure-testing-service)をScene7会社管理者が許可リストに加えるすることをお勧めします。エグレス IP は次のとおりです。
