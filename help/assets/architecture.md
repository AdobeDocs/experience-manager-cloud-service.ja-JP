...
[!DNL Cloud Service]としての[!DNL Experience Manager Assets]は[!DNL Adobe Experience Manager]に基づいており、最新のオファー[!DNL Experience Manager] 6.5とよく比較されます。 [!DNL Cloud Service]のサービスには、クラウド ネイティブ サービスとして提供する調整されたアーキテクチャと機能があります。 基盤となるアーキテクチャが変更されたので、Adobe Experience Manager 6.5 のすべての機能が [!DNL Cloud Service] に含まれるわけではありません。
