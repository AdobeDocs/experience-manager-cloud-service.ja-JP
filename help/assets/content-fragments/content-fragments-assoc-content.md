...
>
>コンテンツフラグメントをオーサリングするエディターは 2 つあります。基本機能は同じですが、いくつか違いがあります。 この節では、主に **Assets** コンソールから主にアクセスされるエディターについて説明します。
...
関連付けを行うには、まず[&#x200B; メディアアセットをコレクションに追加する必要があります](/help/assets/manage-collections.md)。 その後、次の操作を実行できます。
