...
編集するデータタイプに応じて、その他の様々なアクションを実行します。次に例を示します。
...
コンテンツフラグメントを編集用に開くと、 **バリエーション** デフォルトでは、「 」タブが開きます。 このタブで、プライマリまたはバリエーション（ある場合）のコンテンツをオーサリングできます。構造化フラグメントには、コンテンツモデルで定義された様々なデータタイプのフィールドが含まれます。
...
1. 最後に、
   ...
   1. **開く**:
      * は、新しいフラグメントを参照します
      * 新しいフラグメントを開いて編集用に新しいブラウザータブで開く
