...
* フラグメントに&#x200B;**アセットを挿入**（混在メディアフラグメント）
   ...
   * アセットの位置を定義します。
   * 詳しくは、 [フラグメントへのアセットの挿入](/help/assets/content-fragments/content-fragments-variations.md#inserting-assets-into-your-fragment) （フラグメントエディター）を参照してください。
...
* **バリエーション**
   ...
   * バリエーションは [同期済み](/help/assets/content-fragments/content-fragments-variations.md#synchronizing-with-master) マスター(マスターコンテンツが更新された場合 )
