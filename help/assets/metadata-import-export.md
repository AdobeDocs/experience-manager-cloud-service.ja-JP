...
1. ツールバーで、「 」を選択します。 **[!UICONTROL 書き出し]**. メタデータが書き出されたことを確認するメッセージが表示されます。メッセージを閉じます。
1. 書き出しジョブのインボックス通知を開きます。ジョブを選択し、ツールバーの「**[!UICONTROL 開く]**」をクリックします。メタデータが含まれる CSV ファイルをダウンロードするには、「 」を選択します。 **[!UICONTROL CSV のダウンロード]** をクリックします。 「**[!UICONTROL 閉じる]**」をクリックします。
