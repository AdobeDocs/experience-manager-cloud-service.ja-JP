...
Content Advisor](assets/content-advisor-ai-search.png)のアセットの![AI 検索
...
| B2C](http://experienceleague.adobe.com/en/docs/journey-optimizer/using/ajo-home)の[Adobe Journey Optimizer （AJO） | ✓ | ✓ | ✓ | ✓ |
