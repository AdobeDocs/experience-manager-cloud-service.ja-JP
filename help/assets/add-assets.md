...
アップロードしたアセットに対して追加の処理を行うように選択することもできます。アセットがアップロードされるフォルダーに多数のアセット処理プロファイルを設定して、特定のメタデータ、レンディションまたは画像処理サービスを追加することができます。[アップロード時のアセットの処理](#process-when-uploaded)を参照してください。
