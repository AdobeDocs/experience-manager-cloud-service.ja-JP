...
| ファイル形式 | GIF | JPEG | PNG | フルテキストの抽出 | TIFF | メタデータ抽出 | 幅/高さ |
| ----------- | -------- | -------- | -------- | ------------------- | -------- | ------------------- | ------------ |
| AI | ✓ | ✓ | ✓ | - | ✓ | ✓ | ✓ |
| Collage | - | - | - | - | - | ✓ | - |
| DN | ✓ | ✓ | ✓ |  | ✓ | ✓ | ✓ |
...
| ファイル形式 | GIF | JPEG | PNG | TIFF | メタデータ抽出 | 幅/高さ | 切り抜き  |
| ----------- | -------- | -------- | -------- | -------- | ------------------- | ------------ | -------- |
| BMP | ✓ | ✓ | ✓ | ✓ | - | ✓ | ✓ |
| EPS | - | - | - | - | ✓ | - | - |
| GIF | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
| ファイル形式 | GIF | JPEG | PNG | TIFF | メタデータ抽出 | 幅/高さ |
| ----------- | -------- | -------- | -------- | -------- | ------------------- | ------------ |
| 3FR | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| ARW | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| CR2 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
|  | GIF | JPEG | PNG | フルテキストの抽出 | TIFF | 幅/高さ | メタデータの管理 | [Connected Assets](use-assets-across-connected-assets-instances.md) |
| ---- | -------- | -------- | -------- | ------------------- | -------- | ------------ | ------------------- | ------------------------------------------------------------------- |
| PDF | ✓ | ✓ | ✓ | ✓ | - | ✓ | ✓ | ✓ |
| DOCX | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| DOC | - | - | - | - | - | - | ✓ | ✓ |
