...
検索フィルターを使用すると、日付、ファイルタイプ、タグ、関連性などの様々なパラメーターに基づいて検索結果を絞り込むことができ、検索クエリの精度が向上します。 フィルターを適用すると、最も関連性の高い結果を効率的に素早く絞り込むことができます。 これにより、時間が節約されるだけでなく、特定の好みやニーズに合わせて結果をカスタマイズすることで、全体的な検索エクスペリエンスが向上します。詳しくは、[検索](search-assets-view.md)を参照してください。
...
1. 「**[!UICONTROL フィルター]**」セクションでは、次の設定を行うことができます。

   * **[!UICONTROL ファイル &#x200B;]:** ファイルの設定には、ファイルの種類、ファイル形式、アセットの状態、ファイルサイズ、画像サイズ、作成日、変更日などが含まれます。
   * **[!UICONTROL フォルダー]:** フォルダーの設定には、作成日、破棄された日付、破棄された日付などが含まれます。
   * **[!UICONTROL コレクション &#x200B;]:** コレクションの設定には、コレクションの表示、コレクションタイプ、作成日などが含まれます。

1. ファイル、フォルダー、またはコレクションで使用できるデフォルトの&#x200B;**[!UICONTROL プリセットフィルター]** フォームをプレビューできます。 ただし、この既存のフォームをカスタマイズしたり削除したりすることはできません。 または、カスタマイズされたフィルターフォームを作成するには、**[!UICONTROL 新しいフォームを追加]**&#x200B;をクリックします。

   >[!NOTE]
   >
   >カスタマイズされたフィルターフォームは、カテゴリ（ファイル、フォルダー、またはコレクション）ごとに1つだけ作成できます。

1. 「**[!UICONTROL 保存]**」をクリックして、変更を保存します。

## 設定済みフォームのアクション {#Actions-on-configured-form}

設定されたフィルターフォームでは、次のアクションを使用できます。

* **[!UICONTROL カスタマイズ &#x200B;]:** クリックしてフォームを追加または変更します。 フィルター要素を[&#x200B; カスタムフィルター](#available-custom-filters)からキャンバスにドロップしたり、必要に応じて並べ替えたりできます。

* **[!UICONTROL プレビュー]:** クリックして変更を確認します。

* **[!UICONTROL 既定として設定]:**&#x200B;選択したフォームを既定として設定するには、クリックします。

* **[!UICONTROL フォームを削除]:**&#x200B;その他のオプション ![その他のオプション &#x200B;](assets/do-not-localize/more-icon.svg)をクリックし、**[!UICONTROL フォームを削除]**&#x200B;を選択して、選択したフィルターフォームを削除します。

* **[!UICONTROL フォームラベルを編集]:**&#x200B;その他のオプション ![その他のオプション &#x200B;](assets/do-not-localize/more-icon.svg)をクリックし、カスタマイズしたフィルターフォームに新しいラベルと説明を追加します。

  ![&#x200B; フォームラベルの編集](assets/edit-form-labels.png)
