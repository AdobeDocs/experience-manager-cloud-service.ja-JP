...
## OpenAPI を使用してアセット配信を保護し、Dynamic Media を検索するにはどうすればよいですか？ {#secure-asset-delivery}
...
| [ 幅、高さ、回転、反転、画質、形式など、サポートされる画像修飾子の豊富なセット ](/help/assets/deliver-assets-apis.md) | 使用可能な画像修飾子の豊富なセット |
...
| は、ビデオスマート切り抜き機能をサポートしていません。 | ビデオスマート切り抜き機能をサポートします。 |
