...
>[!NOTE]
>
>アセットをダウンロードするためには、アセットのダウンロードを起動するワークフローを開始する権限が必要です。
...
![AEM Assets図からアセットをダウンロードする際に使用できる](assets/asset_download_dialog.png)*オプション：AEM Assetsからアセットをダウンロードする際に使用できるオプション*
