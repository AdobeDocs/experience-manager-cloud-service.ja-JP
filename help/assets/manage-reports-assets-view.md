...
既存のレポートは、**実行レポート** タブの下に表示されます。「**レポート**」をクリックし、「**実行レポート**」を選択すると、ステータスが&#x200B;**完了**、ダウンロードの準備ができていることを示す作成されたすべてのレポートが表示されます。レポートをCSV形式でダウンロードするか、レポートを削除するには、レポート行を選択します。次に、**CSVをダウンロード**&#x200B;または&#x200B;**削除**&#x200B;を選択します。
...
1. レポート行を選択します。
1. 「**編集**」をクリックします。
1. スケジュール済みレポートをキャンセルするには、**スケジュールのキャンセル**&#x200B;をクリックし、**確認**&#x200B;をクリックします。キャンセル済みレポートの場合、次回の実行時間は空になり、ステータスはキャンセル済みと表示されます。
   ![スケジュールされたレポートの編集とキャンセル](/help/assets/assets/cancel-edit-scheduled-reports.png)

### スケジュールを再開 {#resume-schedule}

キャンセルされたスケジュールを再開するには、レポート行を選択し、**スケジュールの再開**&#x200B;をクリックします。再開すると、次のランタイムエントリが再び表示され、ステータスが「進行中」と表示されます。
![&#x200B; スケジュールの再開](/help/assets/assets/resume-schedule.png)
