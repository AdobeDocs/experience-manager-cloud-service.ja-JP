...
コンテンツハブ機能リリース（2026.02.0）のリリース日は、2026年2月26日（PT）（AEM as a Cloud Service リリースと同じ）です。次回の機能リリース（2026.03.0）は 2026年3月26日（PT）に予定されています。

## 2026 年 2 月リリースの機能 {#february-release-features}

**AEM Governance Agent を使用したContent Hubでの権限管理**
