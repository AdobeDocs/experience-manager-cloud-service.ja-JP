...
| *dragOptions.allowList* | ブール値 | いいえ | | プロパティは、選択できないアセットのドラッグを許可または拒否するために使用されます。詳しくは、[dragOptions プロパティ](/help/assets/asset-selector-customization.md#drag-options-property)を参照してください。 |
