...
1. Experience Manager のロゴをタップし、「**[!UICONTROL Assets]**」に移動した後、画像プロファイルを適用するフォルダーに移動します。
...
1. Experience Manager ロゴをタップし、**[!UICONTROL Assets]** に移動した後、スマート切り抜きまたはスマートスウォッチの画像プロファイルが適用されているフォルダーに移動します。
...
1. Experience Manager のロゴをタップして「**[!UICONTROL アセット]**」に移動した後、画像プロファイルを削除するフォルダーに移動します。
1. チェックマークをタップして対象のフォルダーを選択し、「**[!UICONTROL プロパティ]**」をタップします。
