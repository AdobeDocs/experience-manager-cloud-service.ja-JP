...
| **[!UICONTROL ターゲット解像度全体で切り抜きコンテンツを保持する]** | 同じ縦横比でコンテンツを切り抜くようにするには | スマート切り抜きプロファイルを作成する際に使用します。<br>このチェックボックスをオフにすると、様々な解像度の特定の縦横比に対して、焦点を維持したまま、新しい切り抜きコンテンツが生成されます。<br>このチェックボックスをオフにする場合は、元の画像の解像度が、スマート切り抜きプロファイルに定義した解像度よりも大きいことを確認します。<br><br>例えば、縦横比を 600 x 600（大）、400 x 400（中）、300 x 300（小）に設定したとします。 <br>を使用 **[!UICONTROL ターゲット解像度間で切り抜きコンテンツを保持]** オプション *オン* 3 つの解像度すべてで同じ切り抜きが表示され、次の出力が得られます。<br>![オプションがオン](/help/assets/dynamic-media/assets/preserve-checked.png)<br><br>を使用 **[!UICONTROL ターゲット解像度間で切り抜きコンテンツを保持]** オプション *オフ*&#x200B;に設定した場合、切り抜きの内容は 3 つの解像度すべてに対して新しく追加され、次のように出力されます。<br>![オプションはオフ](/help/assets/dynamic-media/assets/preserve-unchecked.png) |
