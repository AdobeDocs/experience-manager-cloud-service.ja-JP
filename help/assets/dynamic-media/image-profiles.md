  ...
  <tr>
   ...
   <td><p>このオプションを使用するには、「切り抜きオプション」ドロップダウンリストで「<strong>ピクセル切り抜き</strong>」を選択します。</p> <p>画像の各辺から切り抜くには、画像の任意の辺または四辺からの切り抜きのサイズ（ピクセル数）を入力します。画像がどれだけ切り抜かれるかは、画像ファイル内の ppi（1 インチあたりのピクセル数）の設定によって変わります。</p> <p>イメージプロファイルのピクセル切り抜きは以下の方法で実行されます。<br /> </p>
    <ul>
     ...
     <li>水平方向の計算：元の画像の水平方向のピクセルサイズから左、マイナス右を引いた値。</li>
...
1. Adobe Experience Managerのロゴをタップし、**[!UICONTROL ツール]**/**[!UICONTROL アセット]**/**[!UICONTROL 画像プロファイル]**&#x200B;に移動します。
...
1. Experience Managerのロゴをタップし、**[!UICONTROL ツール]**/**[!UICONTROL アセット]**/**[!UICONTROL 画像プロファイル]**&#x200B;に移動します。
...
1. Experience Managerのロゴをタップし、**[!UICONTROL アセット]**&#x200B;に移動して、画像プロファイルを適用するフォルダーに移動します。
...
1. Experience Managerのロゴをタップし、**[!UICONTROL アセット]**&#x200B;に移動して、スマート切り抜きまたはスマートスウォッチ画像プロファイルが適用されているフォルダーに移動します。
...
1. Experience Managerのロゴをタップし、**[!UICONTROL アセット]**&#x200B;に移動して、画像プロファイルを削除するフォルダーに移動します。
1. チェックマークをタップして対象のフォルダーを選択し、「**[!UICONTROL プロパティ]**」をタップします。
