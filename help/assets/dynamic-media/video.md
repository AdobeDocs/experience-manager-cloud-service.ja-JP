...
**アカウントでの複数キャプションおよびオーディオトラックのサポートの有効化について**

アカウントでAdobeサポートケースを作成して DASH を有効にするのと同時に、複数のキャプションとオーディオトラックのサポートを自動的に有効にすることも可能です。 イネーブルメント後、アップロードするすべてのビデオは、ビデオへの複数のキャプショントラックとオーディオトラックの追加をサポートする新しいバックエンドアーキテクチャで処理されます。

>[!IMPORTANT]
>
>アップロードしたビデオ *次の前* Dynamic Media アカウントで複数のキャプションおよびオーディオトラックのサポートを有効にする [再処理する必要があります](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets). このビデオの再処理手順は、複数のキャプションとオーディオトラック機能を使用するために必要です。 再処理後も、ビデオ URL は引き続き通常どおり動作し、再生されます。
...
1. 次のいずれかを実行できます。
   ...
   * [複数のキャプションとオーディオトラックの追加](#add-msma) ビデオに追加します。


## Dynamic Mediaでのビデオの複数キャプションおよびオーディオトラックのサポートについて{#about-msma}

Dynamic Mediaの複数のキャプションおよびオーディオトラック機能を使用すると、プライマリビデオに複数のキャプションとオーディオトラックを簡単に追加できます。 この機能により、グローバルなオーディエンスがビデオにアクセスできるようになります。1 つの公開済みプライマリビデオを複数の言語でグローバルオーディエンスに向けてカスタマイズし、様々な地理的地域のアクセシビリティガイドラインに従うことができます。また、作成者はユーザーインターフェイスの 1 つのタブからキャプションとオーディオトラックを管理することもできます。
...
プライマリビデオに複数のキャプションとオーディオトラックを追加する場合に考慮すべきユースケースは、次のとおりです。
...
すべて [Dynamic Mediaでサポートされるビデオ形式](/help/assets/file-format-support.md) およびDynamic Mediaを除くすべてのDynamic Media ビデオビューア *Video_360* ビューア – 複数のキャプションおよびオーディオトラックでの使用がサポートされています。
...
>[!IMPORTANT]
>
>Adobeでは、次のことをお勧めします [複数キャプションおよびオーディオトラック機能の有効化](#enable-dash) Dynamic Media アカウントに追加します。 これにより、最新のDynamic Media バックエンドアーキテクチャを活用し、ビデオにキャプション、キャプション、オーディオトラックを追加するためのシンプルなワークフローを実現できます。
