...
ページの左下隅付近にある「**[!UICONTROL URL]**」と「**[!UICONTROL 埋め込み]**」ボタンに注意してください。これらのボタンを使用して、ビデオのURLを[web アプリケーションにリンクするか、[Web ページにビデオを埋め込むか](/help/assets/dynamic-media/embed-code.md)、それぞれ](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md)します。
