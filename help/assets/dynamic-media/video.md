...
Adobeサポートケースを作成して DASH を有効にすると同時に、マルチサブタイトルとマルチオーディオトラックのサポートも自動的に有効にすると便利です。 有効化後、以降にアップロードするすべてのビデオは、ビデオへのマルチサブタイトルおよびマルチオーディオトラックの追加をサポートする新しいバックエンドアーキテクチャで処理されます。
