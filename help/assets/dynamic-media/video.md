...
## Dynamic Mediaアカウントで DASH、マルチサブタイトルおよびマルチオーディオトラックのサポートを有効にする {#enable-dash}
...
アカウントでの DASH サポートの有効化は、作成して送信するAdobeカスタマーサポートケースを通じておこないます。

**アカウントでのマルチサブタイトルおよびマルチオーディオトラックのサポートの有効化について**

Adobeサポートケースを作成して DASH を有効にすると同時に、マルチサブタイトルとマルチオーディオトラックのサポートを自動的に有効にすることもできます。 有効化後、以降にアップロードするすべてのビデオは、ビデオへのマルチサブタイトルおよびマルチオーディオトラックの追加をサポートする新しいバックエンドアーキテクチャで処理されます。

>[!IMPORTANT]
>
>アップロードしたビデオ *前* Dynamic Mediaアカウントでのマルチサブタイトルおよびマルチオーディオトラックのサポートの有効化 [は再処理する必要があります](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets). このビデオ再処理手順は、マルチサブタイトルとマルチオーディオトラック機能を使用できるようにするために必要です。 再処理後も、ビデオ URL は引き続き通常どおり動作し、再生されます。

**Dynamic Mediaアカウントで DASH、マルチサブタイトル、マルチオーディオトラックのサポートを有効にするには：**
...
1. サポートケースを作成するには、手順に従いながら次の情報を入力します。
   ...
   * Cloud Service環境（プログラム ID と環境 ID）。
   * Dynamic Mediaの会社アカウント名。
   * Dynamic Media地域：北米 (NA)、アジア太平洋 (APAC) またはヨーロッパ中東アジア (EMEA)。
   * Experience Manager6.5 で、Dynamic Mediaアカウントで DASH、マルチサブタイトル、マルチオーディオトラックのサポートを有効にするように指定します。

1. アドビカスタマーサポートでは、リクエストが送信された順序に基づいて、 の順番待ちリストに追加します。
1. リクエストを処理する準備が整った時点で、カスタマーサポートから連絡を差し上げ、 を有効にする日付の調整と設定を行います。
1. 完了後、カスタマーサポートから通知があります。
1. 次のいずれかを実行できます。

   * 通常通り、[ビデオビューアープリセット](/help/assets/dynamic-media/managing-viewer-presets.md#creating-a-new-viewer-preset)を作成します。
   * [マルチサブタイトルとマルチオーディオトラックを追加する](#add-msma) をビデオに追加します。


## Dynamic Mediaでのビデオのマルチサブタイトルおよびマルチオーディオトラックのサポートについて{#about-msma}

Dynamic Mediaのマルチサブタイトルおよびマルチオーディオトラック機能を使用すると、複数のサブタイトルやオーディオトラックを簡単にプライマリビデオに追加できます。 この機能により、グローバルなオーディエンスがビデオにアクセスできるようになります。1 つの公開済みプライマリビデオを複数の言語でグローバルオーディエンスに向けてカスタマイズし、様々な地理的地域のアクセシビリティガイドラインに従うことができます。また、作成者は、ユーザーインターフェイスの 1 つのタブからサブタイトルとオーディオトラックを管理することもできます。

![Dynamic Mediaの「サブタイトルとオーディオトラック」タブ。アップロードされた.VTT サブタイトルファイルと、ビデオ用にアップロードされた.MP3 オーディオトラックファイルを示す表。](/help/assets/dynamic-media/assets/msma-subtitle-audiotracks-tab.png)

プライマリビデオにマルチサブタイトルやマルチオーディオトラックを追加する際に検討すべき使用例の一部を次に示します。
...
すべて [Dynamic Mediaでサポートされるビデオ形式](/help/assets/file-format-support.md) Dynamic Mediaを除くすべてのDynamic Mediaビデオビューア *ビデオ 360* viewer — マルチサブタイトルおよびマルチオーディオトラックでの使用がサポートされます。

マルチサブタイトルおよびマルチオーディオトラック機能は、Adobeカスタマーサポートが有効（オン）にする必要がある機能の切り替えを通じてDynamic Mediaアカウントで使用できます。

### ビデオへのマルチサブタイトルおよびマルチオーディオトラックの追加 {#add-msma}

ビデオにマルチサブタイトルトラックとマルチオーディオトラックを追加する前に、次のインプレースを用意しておく必要があります。

* Dynamic MediaはAEM環境で設定されます。
* A [Dynamic Mediaビデオプロファイルは、ビデオが取り込まれるフォルダーに適用されます](/help/assets/dynamic-media/video-profiles.md#applying-a-video-profile-to-folders).
* [マルチサブタイトルおよびマルチオーディオトラックがDynamic Mediaアカウントで有効になっています](#enable-dash).

追加されたサブタイトルとキャプションは、WebVTT およびAdobeVTT 形式でサポートされます。 また、追加されたオーディオトラックファイルは MP3 形式でサポートされています。

>[!IMPORTANT]
>
>アップロードしたビデオ *前* Dynamic Mediaアカウントでのマルチサブタイトルおよびマルチオーディオトラックのサポートの有効化 [は再処理する必要があります](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets). このビデオ再処理手順は、マルチサブタイトルとマルチオーディオトラック機能を使用できるようにするために必要です。 再処理後も、ビデオ URL は引き続き通常どおり動作し、再生されます。

**ビデオにマルチサブタイトルとマルチオーディオトラックを追加するには：**

1. [フォルダーにプライマリビデオをアップロード](/help/assets/manage-video-assets.md#upload-and-preview-video-assets) には、既にビデオプロファイルが割り当てられています。
1. マルチサブタイトルおよびマルチオーディオトラックを追加する、アップロードされたビデオアセットに移動します。
1. アセット選択モードで、リスト表示またはカード表示から、ビデオアセットを選択します。
1. ツールバーで、プロパティアイコン（円と「i」が入った円）を選択します。
   ![ビデオのサムネール画像の上にチェックマークが付いている、選択したビデオアセットと、ツールバーで「プロパティを表示」がハイライト表示されている。](/help/assets/dynamic-media/assets/msma-selectedasset-propertiesbutton.png)*カード表示で選択したビデオアセット。*
1. ビデオのプロパティページで、「 **[!UICONTROL 字幕とオーディオトラック]** タブをクリックします。

   >[!TIP]
   >次の項目が表示されない場合、 **[!UICONTROL 字幕とオーディオトラック]** タブとは、次の 2 つのいずれかを意味します。
   >
   >* 選択したビデオが存在するフォルダーには、ビデオプロファイルが割り当てられていません。 その場合は、 [フォルダーへのビデオプロファイルの適用](/help/assets/dynamic-media/video-profiles.md#applying-video-profiles-to-specific-folders)
   >* または、ビデオをDynamic Mediaで再処理する必要があります。 その場合は、 [フォルダー内のDynamic Mediaアセットの再処理](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets).
   >
   >上記のいずれかのタスクを完了したら、次の手順に戻ります。

   ![「プロパティ」ページの「サブタイトルとオーディオトラック」タブ&#x200B;](/help/assets/dynamic-media/assets/msma-audiotracks.png)*ビデオのプロパティページの「サブタイトルとオーディオトラック」タブ。*

1. （オプション）ビデオに 1 つ以上のサブタイトル（またはキャプション）ファイルを追加するには、次の手順を実行します。
   * 選択 **[!UICONTROL サブタイトルをアップロード]**.
   * 1 つ以上の.vtt(Video Text Tracks) ファイルに移動して選択し、開きます。
   * サブタイトルをメディアプレーヤーに表示するには、次の手順を実行します。 *必須* 次に関する必要な詳細（メタデータ）を追加 *各* アップロードしたサブタイトルファイル。 サブタイトルファイル名の右側にある鉛筆アイコンを選択します。 Adobe Analytics の **字幕を編集** ダイアログボックスで、次の必要なファイルの詳細情報を入力し、「 」を選択します。 **[!UICONTROL 保存]**. アップロードした各サブタイトルファイルに対して、次の手順を繰り返します。

     | サブタイトルメタデータ | 説明 |
     |--- |--- |
     | ファイル名 | デフォルトのファイル名は、元のファイル名から派生します。 ファイル名はアップロード時にのみ変更でき、後で変更することはできません。 ファイル名の文字数の要件は、AEM Assetsの場合と同じです。<br>追加のサブタイトルファイルとオーディオトラックファイルに同じファイル名を使用することはできません。 |
     | 言語 | サブタイトルの言語を選択します。 |
     | タイプ | 使用するサブタイトルのタイプを選択します。<br>**字幕**  — ダイアログを翻訳または転写するビデオと共に表示されるサブタイトルテキスト。<br>**キャプション**  — キャプションテキストには、背景音、話者の差別化、その他の関連情報が含まれ、対話の翻訳や転写に加えて、耳が聞こえない人や聞きにくい人がコンテンツにアクセスしやすくなっています。 |
     | ラベル | 内のサブタイトルの名前に表示されるテキスト **[!UICONTROL オーディオまたはキャプションを選択]** メディアプレーヤーのポップアップリスト。 ラベルは、字幕トラックまたはキャプショントラックに対応する顧客に表示される内容です。 例：`English (CC)` |

     必要に応じて、後でサブタイトルメタデータを変更または編集できます。 ビデオが公開されると、これらの詳細が公開されたビデオの公開 URL に反映されます。

1. （オプション）ビデオに 1 つ以上のオーディオトラックを追加するには、次の手順を実行します。
   * 選択 **[!UICONTROL オーディオトラックをアップロード]**.
   * 1 つ以上の.mp3 ファイルに移動して選択し、開きます。
   * オーディオトラックが **[!UICONTROL オーディオまたはキャプションを選択]** メディアプレーヤーのポップアップリスト *必須* ～に関する必要な詳細を追加する *各* 追加したオーディオトラックファイル。 オーディオトラックのファイル名の右側にある鉛筆アイコンを選択します。 Adobe Analytics の **オーディオトラックを編集** ダイアログボックスで、次の必要な詳細情報を入力し、「 」を選択します。 **[!UICONTROL 保存]**. アップロードした各オーディオトラックファイルに対して、この手順を繰り返します。

     | オーディオトラックメタデータ | 説明 |
     |--- |--- |
     | ファイル名 | デフォルトのファイル名は、元のファイル名から派生します。 ファイル名はアップロード時にのみ変更でき、後で変更することはできません。 ファイル名の文字数の要件は、AEM Assetsの場合と同じです。<br>追加のオーディオトラックファイルやサブタイトルファイルに同じファイル名を使用することはできません。 |
     | 言語 | オーディオトラックの言語を選択します。 |
     | タイプ | 使用するオーディオトラックのタイプを選択します。<br>**オリジナル**  — 元々ビデオに添付され、次の形式で表されたオーディオトラック `[Original]` ～というラベルで `English` デフォルトで選択されている言語です。 While **[!UICONTROL ラベル]** および **[!UICONTROL 言語]** は **[!UICONTROL オーディオトラックを編集]** ダイアログボックスに表示されます。プライマリビデオが再処理される場合は、デフォルトで元の値が使用されます。<br>**標準**  — 元の言語以外の言語のアドオンオーディオトラック。<br>**オーディオの説明**  — ビデオ内の非言語的な動きやジェスチャーの記述的ナレーションも含まれたオーディオトラックで、視覚に障碍のあるユーザー向けのコンテンツアクセシビリティを高めます。 |
     | ラベル | オーディオトラックの名前として、 **[!UICONTROL オーディオまたはキャプションを選択]** メディアプレーヤーのポップアップリスト。 ラベルは、オーディオトラックに対応する顧客に表示される内容です。 例えば `English [Original]` などのファイルです。ビデオに添付されるオーディオのラベルはに設定されます。 `[Original|` デフォルトでは。 |

     必要に応じて、後でこのオーディオトラックメタデータを変更または編集できます。 ビデオが公開されると、これらの詳細が公開されたビデオの公開 URL に反映されます。

1. ページの右上隅に、 **[!UICONTROL 保存して閉じる]** ドロップダウンリストで、「 **[!UICONTROL 保存]**. ファイルがアップロードされ、メタデータ処理が開始されます。詳しくは、 **ステータス** インターフェイスの列。

   >[!NOTE]
   >
   >インスタンスのキャッシュ設定に基づき、メタデータ処理がプレビューおよび公開済み URL に反映されるまでに数分かかる場合があります。

1. （オプション）選択した場合、 **[!UICONTROL 保存して閉じる]** 前の手順で、 **[!UICONTROL 保存]**&#x200B;に値を入力すると、アップロードしたファイルの処理ステータスを表示できます。 詳しくは、 [アップロードされたサブタイトルファイルとオーディオトラックファイルのライフサイクルステータスの表示](#lifecycle-status-video).
1. （オプション）公開する前にビデオをプレビューして、サブタイトルとオーディオが期待どおりに動作することを確認します。 詳しくは、 [複数のサブタイトルとオーディオトラックを持つビデオのプレビュー](#preview-video-audio-subtitle)
1. ビデオを公開します。 [アセットの公開](publishing-dynamicmedia-assets.md)を参照してください。

#### 既に公開されているビデオへのサブタイトルおよびオーディオトラックファイルの追加について

既に公開されているビデオに追加のサブタイトルファイルまたはオーディオトラックファイルをアップロードする場合、これらのファイルには `Processed` のステータスを確認します。 その時点で、Dynamic Mediaでビデオをプレビューして、新しくアップロードされたファイルを確認したり、聞いたりできます。

ただし、プレビュー後は、 *公開* 新しく追加されたサブタイトルまたはオーディオトラックファイルの公開に関するビデオも再度追加しました。 公開後、サブタイトルやオーディオは公開Dynamic Media URL で使用できるようになります。

>[!NOTE]
>
>インスタンスのキャッシュ設定に基づき、メタデータの更新がプレビューおよび公開済み URL に反映されるまでに、数分かかる場合があります。

即時公開用にDynamic Mediaを設定したシナリオでは、追加のサブタイトルまたはオーディオファイルをアップロードすると、サブタイトルまたはオーディオファイルのアップロード後にビデオの公開が直ちにトリガーされます。
...
1. アセット選択モードで、リスト表示またはカード表示から、ビデオアセットを選択します。
1. ツールバーで、プロパティアイコン（円と「i」が入った円）を選択します。
1. プロパティページで、「 **[!UICONTROL 字幕とオーディオトラック]** タブをクリックします。 「ステータス」列で、各サブタイトルまたはオーディオファイルの状態をメモします。
...
![「字幕」フィールドと「オーディオトラック」フィールドで強調表示されているステータス列。](/help/assets/dynamic-media/assets/msma-lifecycle-status.png)*アップロードされた各サブタイトルおよびオーディオトラックファイルのライフサイクルステータス。*

### 複数のオーディオトラックを持つビデオのデフォルトオーディオを設定

デフォルトでは、ビデオの元のオーディオが、再生されるデフォルトのオーディオとして設定されます。

ただし、アップロードしたオーディオトラックファイルは、ビデオをビューアに読み込んだ後に再生されるデフォルトのオーディオとして設定できます。 [ プロパティ ] ユーザインターフェイスで、 **字幕とオーディオトラック** タブ、 `Default` ラベルは、ビデオ再生用のオーディオトラックファイルの右側に適用されます。
...
**複数のオーディオトラックを持つビデオのデフォルトオーディオを設定するには：**

1. デフォルトのオーディオトラックを設定するビデオアセットに移動します。
1. アセット選択モードで、リスト表示またはカード表示から、ビデオアセットを選択します。
1. ツールバーで、プロパティアイコン（円と「i」が入った円）を選択します。
1. プロパティページで、「 **[!UICONTROL 字幕とオーディオトラック]** タブをクリックします。
1. の下 **オーディオトラック** の見出しで、ビデオのデフォルトとして設定するオーディオトラックファイルを選択します。
1. 選択 **[!UICONTROL デフォルトとして設定]**.
Adobe Analytics の **デフォルトとして設定** ダイアログボックスで、次の項目を選択します。 **[!UICONTROL 置換]**.

   ![選択したオーディオトラックファイル名と、「デフォルトとして設定」ボタンがハイライトされた「オーディオトラック」見出し。](/help/assets/dynamic-media/assets/msma-defaultaudiotrack.png)*ビデオのデフォルトのオーディオトラックを設定する。*

1. 右上隅で、「 **[!UICONTROL 保存して閉じる]**.
1. ビデオを公開します。 [アセットの公開](publishing-dynamicmedia-assets.md)を参照してください。
...
1. ビデオアセットをクリックして、プレビューモードで開くことができます。
1. プレビューページで、ページの左上隅付近にあるドロップダウンリストを選択し、「**[!UICONTROL ビューア]**」を選択します。

   ![「ビューア」オプションを表示するドロップダウンリスト。](/help/assets/dynamic-media/assets/msma-selectviewers.png)

1. 「ビューア」リストで、ビデオプレビューに使用するビューアを選択します。 例として、次のスクリーンショットは **[!UICONTROL ビデオ]** ビューアが選択されています。

   ![「ビューア」ドロップダウンリストからのビデオビューアの選択。](/help/assets/dynamic-media/assets/msma-dmviewerselected.png)

1. 右下隅付近のボリュームアイコンの左側にある吹き出しアイコンを選択し、聞きたいオーディオまたはサブタイトルを選択します。または、その両方を表示することもできます。 必要に応じて、「サブタイトル」で「 **[!UICONTROL オフ]** をクリックして、サブタイトルやキャプションを表示しないようにします。

   ![ビデオビューアのオーディオおよびサブタイトルポップアップリスト。](/help/assets/dynamic-media/assets/msma-selectaudiosubtitle.png)*ビデオ再生用のオーディオとサブタイトルを選択するユーザーのシミュレーション。*

1. 再生を開始するには、ビデオの&#x200B;**[!UICONTROL 再生]**&#x200B;ボタンを選択します。次の点に注意してください。 **[!UICONTROL URL]** および **[!UICONTROL 埋め込み]** ボタンを使用します。 次のボタンを使用して、 [ビデオの URL を web アプリケーションにリンクする](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md) または [Web ページにビデオを埋め込む](/help/assets/dynamic-media/embed-code.md)、それぞれ。
1. プレビューページの右上隅にある「 」 **[!UICONTROL 閉じる]**.

### ビデオからのサブタイトルまたはオーディオトラックファイルの削除

ビデオからサブタイトルファイルやオーディオトラックファイルを削除できます。 公開済みのサブタイトルまたはオーディオトラックファイルの削除は、ビデオの公開済み URL に自動的に反映されます。

プライマリビデオから抽出されたオリジナルのオーディオトラックは削除できません。

**ビデオからサブタイトルまたはオーディオトラックファイルを削除するには：**
...
1. 次のいずれかの操作をおこないます。
   ...
   * 字幕 — **字幕** 見出しで、ビデオから削除する 1 つ以上のサブタイトルファイルを選択し、「 」を選択します。 **[!UICONTROL 削除]**.
   * オーディオトラック — 下 **オーディオトラック** 見出しで、ビデオから削除する 1 つ以上のオーディオトラックファイルを選択し、「 」を選択します。 **[!UICONTROL 削除]**.

1. [ 削除 ] ダイアログボックスで、 **[!UICONTROL OK]**.
1. ビデオを公開します。

### ビデオにアップロードされたサブタイトルまたはオーディオトラックファイルをダウンロード

ビデオで使用するためにアップロードした 1 つ以上のサブタイトルまたはオーディオトラックファイルをダウンロードできます。 選択したすべてのファイルを.zip としてダウンロードするか、ファイルごとに別のダウンロードフォルダーを作成するかのどちらかを選択できます。

プライマリファイルから抽出されたオリジナルのオーディオトラックはダウンロードできません。

**ビデオからサブタイトルまたはオーディオトラックファイルをダウンロードするには：**
...
1. 次のいずれかの操作をおこないます。
   ...
   * 字幕 — **字幕** 見出しで、ビデオからダウンロードする 1 つ以上のサブタイトルファイルを選択し、「 」を選択します。 **[!UICONTROL ダウンロード]**.
   * オーディオトラック — 下 **オーディオトラック** 見出しで、ビデオからダウンロードする 1 つ以上のオーディオトラックファイルを選択し、「 」を選択します。 **[!UICONTROL ダウンロード]**.

1. ダウンロードダイアログボックスで、次のオプションを設定します。

   | オプション | 説明 |
   |--- |--- |
   | 名前を付けて保存 | 「名前を付けて保存」テキストフィールドで指定したデフォルトのファイル名を使用するか、独自の名前を指定します。 |
   | アセットごとに別のフォルダーを作成 | ダウンロード用に選択したサブタイトルファイルまたはオーディオトラックファイルごとにフォルダーを作成します。 |
   | メール | デフォルトの電子メールプログラムを使用して、.zip ファイルを指定の電子メールアドレスに送信します。 |
   | アセット | ダウンロードするファイルの数と、選択したすべてのファイルの合計サイズを指定します。 このオプションの選択を解除すると、 **[!UICONTROL ダウンロード]** 」ボタンをクリックして、ファイルをダウンロードできないようにします。 |
...
1 つのビデオまたはアダプティブビデオセットにチャプターマーカーを追加することで、長形式のビデオを見やすくし、移動しやすくすることができます。 ビデオの再生中に、ビデオタイムライン（ビデオスクラバーとも呼ばれる）のチャプターマーカーを選択することができます。これにより、ユーザーは、関心があるポイントや、新しいコンテンツ、トレーニング、デモンストレーションなどにすぐに移動できます。
...
Experience Manager 内のすべてのビデオには、サムネールを関連付ける必要があります。サムネールを置き換えずに削除することはできません。デフォルトでは、Experience Manager にビデオをアップロードすると、最初のフレームがサムネールとして使用されます。例えば、ブランド設定やビジュアル検索用にサムネールをカスタマイズできます。ビデオのサムネールをカスタマイズする場合は、使用するフレームでビデオを再生し、一時停止することができます。 あるいは、Digital Asset Manager に既にアップロードして&#x200B;*公開*&#x200B;している画像アセットを選択できます。

ビデオのサムネールを変更すると、ビデオの再処理時にAsset computeサービスを介したサムネールの生成がスキップされます。
