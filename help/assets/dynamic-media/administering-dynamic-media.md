...
>**アップグレードする場合：**
>
>* Experience Managerを起動して実行した後は、アップロードしたアセットはすべて自動的に有効になります（ただし、システム管理者が明示的に無効にしていない場合）。 アップグレードしたExperience Managerのインスタンスを使用し、Dynamic Mediaに初めてアクセスする場合は、アセットを再処理してDynamic Media対応にする必要がある場合があります。