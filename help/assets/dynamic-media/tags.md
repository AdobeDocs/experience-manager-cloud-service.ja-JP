...
Experience Platform タグ用の *Dynamic Media ビューア*&#x200B;拡張機能は、Dynamic Media ビューア 5.13 で動作します。これにより、Adobe Analytics および Experience Platform タグのお客様は、タグの設定で Dynamic Media ビューアのイベントとデータを使用できます。
...
1. まず、Experience Cloud [ホームページ](https://experience.adobe.com/#/home)から Adobe Analytics にアクセスします。メニューバーで、ページの右上隅付近にある ![アプリアイコン、ソリューション](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Apps_18_N.svg) **ソリューション**&#x200B;をクリックし、「**[!UICONTROL Analytics]**」を選択します。
...
詳しくは、[Experience Cloud ID サービス拡張機能](https://experienceleague.adobe.com/ja/docs/experience-platform/tags/extensions/client/id-service/overview)を参照してください。
