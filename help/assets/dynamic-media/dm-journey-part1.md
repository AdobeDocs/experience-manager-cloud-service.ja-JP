...
**_Audience_**
このジャーニーの読者に最も適したオーディエンスは、Experience ManagerでDynamic Mediaを初めて利用する次のユーザーです。
...
![Adobe Dynamic Mediaは、異なるサイズや形式の異なるメディアに同じプライマリ画像を配信します](/help/assets/dynamic-media/assets/dm-oneasset-multioutput.png)
_Adobe Dynamic Mediaは、サイズや帯域幅に関係なく、あらゆる画面に一貫性のある高品質なエクスペリエンスを提供します。_
...
_スマートイメージング機能は、お客様のブラウザー機能とネットワーク速度に基づいて、画像の形式とファイルサイズを自動的に最適化します。_
...
![&#x200B; コンテンツ ページの重さ](/help/assets/dynamic-media/assets/dm-content-page-weight.png)
_一般的なweb ページのコンテンツページの重み。_
...
_このウォッチは1つのプライマリ アセット ファイルですが、複数のレンディションを持ち、コピーではなく、その場で作成されます。_
...
| **問題** | **Dynamic Media の解決策** |
|---|---|
| 画像やビデオを手作業で制作、測定、カットして、重要な部分を強調したり、あらゆる画面サイズやデバイスで適切に表示できるようにするには、時間と労力がかかる。 | Adobe AIの機能であるDynamic Mediaのスマート切り抜き機能を使用して、画像や動画内の焦点を自動検出し、切り抜いて管理します。 |
...
_Dynamic Media システム内のアセットの流れ。_
...
![Dynamic Mediaにアップロードする推奨フォーマット](/help/assets/dynamic-media/assets/dm-upload-formats.png)
...
![大きな画像プリセットに基づくアセットのレンディションのプレビュー](/help/assets/dynamic-media/assets/dm-image-preset-with-url.png)
_選択した「大きい」画像プリセットに基づくアセットのレンディションのプレビュー。 「URL」ボタンをクリックしました。 結果の URL パスには「Large」画像プリセット名が含まれており、このパスを web ページで使用できます。_
...
![Zoom Vertical Light ビューアプリセットに基づくアセットのプレビュー](/help/assets/dynamic-media/assets/dm-viewer-preset.png)
