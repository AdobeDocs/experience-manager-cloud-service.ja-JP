...
「_私たちは、多額の資金を費やして、あるビデオを制作しましたが、そのビデオをページに配置したり配信したりするのは避けました。テストの結果、ビデオの品質や、実際に再生できるかを保証できないとわかったためです。そして、最終的に、このことは当社のブランドに影響を及ぼし、当社の役割、さらにはコンバージョンにさえ影響を及ぼす可能性があります。_」
