...
>[!NOTE]
>
>Adobe Experience ManagerのWebページ（サイト）を表示している場合、**[!UICONTROL 編集]**&#x200B;モードではプレビューアセットを使用できません。 代わりに、ページの右上隅にある&#x200B;**[!UICONTROL プレビュー]**&#x200B;をクリックしてプレビューモードに移動します。
...
1. クリックしたアセットの種類に応じて、次のいずれかの操作をおこないます。
   ...
   <table>
    <tbody>
      ...
      <li><p><strong>カメラのズーム</strong> - 3Dシーン内の領域の内外を移動する場合は、カメラをズームします。</p> マウス：ホイールをスクロールします。</p> タッチスクリーン：指でつまみます。</p></li>
