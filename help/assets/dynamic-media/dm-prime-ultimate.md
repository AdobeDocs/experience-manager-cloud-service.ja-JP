...
* [AEM as a Cloud Service の Dynamic Media ソリューション](/help/assets/dynamic-media/dynamic-media.md)には、次の主な機能も含まれています。
   ...
   * [Dynamic Media テンプレート](/help/assets/dynamic-media/manage-dynamic-media-templates.md)
   ...
   * [視覚的な設定](https://experienceleague.adobe.com/ja/docs/dynamic-media-classic/using/master-files/vignette-window-covering-cabinet-files)
