---
title: スマートイメージング
description: Adobe AIのスマートイメージング機能を利用して、個々のユーザーのユニークな視聴特性を利用し、エクスペリエンスに合わせて最適化された適切な画像を自動的に提供して、パフォーマンスとエンゲージメントを向上させる方法をご紹介します。
...
Adobe AIのスマートイメージング機能を利用して、個々のユーザーのユニークな視聴特性を利用し、エクスペリエンスに合わせて最適化された適切な画像を自動的に提供して、パフォーマンスとエンゲージメントを向上させる方法をご紹介します。
