...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><code>String</code></td>
   <td><p>正の数。</p> <p>初期設定は 300 です。</p> <p>HLS または DASH（アダプティブストリーミング）の推奨値は 60～90 です。 (DASH を表示または使用するには、まずアカウントのAdobeテクニカルサポートが有効にする必要があります。 詳しくは、 <a href="/help/assets/dynamic-media/video.md#enable-dash">アカウントで DASH を有効にする</a>.)</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><code>String</code></td>
   <td><p><code>true</code>／<code>false</code></p> <p>デフォルトは <code>false</code> です。</p> <p>HLS または DASH の推奨値は次のとおりです。 <code>false</code>. (DASH を表示または使用するには、まずアカウントのAdobeテクニカルサポートが有効にする必要があります。 詳しくは、 <a href="/help/assets/dynamic-media/video.md#enable-dash">アカウントで DASH を有効にする</a>.)</p> <p> </p> </td>
  </tr>
 </tbody>
</table>
