...
1. 選択 **[!UICONTROL ナビゲーション]** > **[!UICONTROL Assets]**. 画像セットを作成する場所に移動し、**[!UICONTROL 作成]**／**[!UICONTROL 画像セット]**&#x200B;に移動して、画像セットエディターページを開きます。
...
1. 次のいずれかの操作を行います。
   ...
   * 画像セットアセットでを選択し、「 」を選択します。 **[!UICONTROL 編集]** （鉛筆アイコン）を使用します。
