...
Search and Delivery APIを使用して独自のカスタムユーザーインターフェイスをExperience Manager Assetsリポジトリと統合するか、Adobe Content Advisorを使用できます。
...
Content Advisorは、[!DNL Experience Manager Assets as a Cloud Service] リポジトリと簡単に統合できるユーザーインターフェイスを提供するので、リポジトリで利用可能な承認済みデジタルアセットを参照または検索し、アプリケーションのオーサリングエクスペリエンスで使用できます。 詳しくは、[Content Advisor](/help/assets/integrate-adobe-non-adobe-applications.md)を参照してください。
