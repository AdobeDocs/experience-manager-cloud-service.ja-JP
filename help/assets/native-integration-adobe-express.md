...
Adobe Expressは、[最小必要な画像の確認](https://helpx.adobe.com/jp/express/web/image-creation-and-editing/change-file-formats/image-requirements.html)で使用できる形式をネイティブでサポートしています。 ただし、AEM Assetsでは次のフォーマットの種類をサポートしています。
