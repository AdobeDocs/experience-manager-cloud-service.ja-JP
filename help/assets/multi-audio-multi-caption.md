...
2. アセットを選択し、「**プロパティ**」をクリックします。
3. 「**キャプションとオーディオトラック**」タブを開きます。
4. 「**オーディオトラックをアップロード**」をクリックします。
5. 1つ以上の`.mp3` ファイルを選択してください。
6. オーディオトラックファイル名の横にある&#x200B;**Draw** アイコンをクリックします。
...
2. 「**キャプションとオーディオトラック**」タブを開きます。
3. **キャプションを作成**/**ファイルをアップロード**&#x200B;をクリックします。
