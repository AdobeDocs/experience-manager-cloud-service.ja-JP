...
![コンテンツフラグメントセレクター](/help/headless/assets/content-fragment-selector-unwrapped.png)

* 上部のツールバーでは、次の操作を実行できます。
   * 右上の **リポジトリ** セレクターを使用して、使用するリポジトリを選択します
   * 形式（リストまたはグリッド）を選択します。
...
必要なビューは、上部のツールバーのアイコンから選択できます。

![ コンテンツフラグメントセレクター – 表示タイプ ](/help/headless/assets/content-fragment-selector-view-type.png)

## コンテンツフラグメントセレクターとアプリケーションの統合 {#integrate-the-content-fragment-selector-with-applications}

コンテンツフラグメントセレクターは、次のような様々なアプリケーションと統合できます。

* [ コンテンツフラグメントセレクターとAdobe アプリケーションの統合 ](/help/headless/content-fragment-selector/integrate-adobe-application.md)
* [コンテンツフラグメントセレクターをAdobe以外のアプリケーションまたはサードパーティのアプリケーションと統合する](/help/headless/content-fragment-selector/integrate-non-adobe-application.md)
