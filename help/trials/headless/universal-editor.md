...
1. 最新の記事のタイトルをダブルタップまたはクリックして編集します。
...
1. 残り **コンポーネント** モードで、サーファーの画像をタップまたはクリックして選択します。

1. コンポーネントレールにアセットの詳細が表示されます。 をタップまたはクリックします。 **おすすめ画像** サムネール。
...
1. 次のような冒険の 1 つをタップまたはクリックします。 **バリサーフキャンプ** をクリックして選択します。
...
1. The **編集** アイコンがコンポーネントレールに表示されます。 をタップまたはクリックします。 **編集** アイコンをクリックして、新しいタブでコンテンツフラグメントエディターを開きます。
