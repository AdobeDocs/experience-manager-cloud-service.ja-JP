...
1. 現在の状況とExperience Managerの開始後に表示される結果を比較するためのベースラインデータがある。
1. KPI は、定期的に、確実に測定可能な項目を追跡していする。

適切な KPI を持っていることを確認したら、各 KPI に関するレポートを関連する関係者に対していつどのように作成するかを把握する必要があります。

レポートプロセスを定義する際は、次の質問を考慮します。

1. この KPI レポートのオーディエンスは誰ですか？各 KPI について、エグゼクティブスポンサー（自分とその指標に関する責任を負う他のチームを擁するエグゼクティブスポンサー）を特定し、通常のレポートを受け取る人のリストを広げておく必要があります。
...
Experience Managerを開始した後、一連の強力な KPI を使用して、適切なトラックにあるかどうかを簡単に把握できます。 KPI の 1 つを満たしていない場合は、チームがExperience Managerを使用する方法を調整する必要があります。 KPI 目標の 1 つをすぐに超える場合は、それは記念すべきことですが、より良い結果を得るためには、目標を再調整する必要があります。

>[!TIP]
>
> KPI に関するその他のヘルプが必要な場合は、 [Adobeコンサルティングサービス](https://www.adobe.com/jp/experience-cloud/consulting-services.html) または実装パートナー。
