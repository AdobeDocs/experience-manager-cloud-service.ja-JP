...
Experience Managerを開始した後、一連の強力な KPI を使用して、適切なトラックにあるかどうかを把握できます。 KPI の 1 つを満たしていない場合は、チームがExperience Managerを使用する方法を調整する必要があります。 KPI 目標の 1 つをすぐに超える場合は、それは記念すべきことですが、より良い結果を得るためには、目標を再調整する必要があります。
