...
1. アダプティブフォームのオーサリングモードで、フォームコンテナオブジェクトを選択し、![cmppr1](assets/configure-icon.svg) を選択してプロパティを開きます。
...
1. ![check-button1](assets/save_icon.svg) を選択して、プロパティを保存します。
...
1. アダプティブフォームをオーサリングモードで開いて、任意のフォームオブジェクトを選択し、![edit-rules1](assets/edit-rules-icon.svg) を選択してルールエディターを開きます。
