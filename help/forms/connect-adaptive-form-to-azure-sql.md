...
* 作成したAzure データベースの専用エグレス IP[を使用して設定された](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/networking/dedicated-egress-ip-address)高度なネットワークを有効にします。
...
>[!NOTE]
>
> プロジェクトにSQL依存関係を含めるには、[SQL ドライバーの依存関係](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/networking/examples/sql-datasourcepool#mysql-driver-dependencies)の節を参照してください。
