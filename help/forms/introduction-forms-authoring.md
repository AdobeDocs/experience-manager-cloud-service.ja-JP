...
* **プロパティブラウザー**
   ...
   コンポーネントを選択し、![フィールドレベル](assets/Smock_SelectContainer_18_N.svg)／**[!UICONTROL アダプティブフォームコンテナ]**&#x200B;をタップして、![プロパティ](assets/Smock_Wrench_18_N.svg) をタップします。
...
<table>
 <tbody>
  ...
  <tr>
   <td>セパレーター</td>
   <td>フォーム内のパネルを視覚的に分離できるようにします。</td>
  </tr>
  <tr>
   <td>署名ステップ</td>
