...
* **プロパティブラウザー**
  ...
  コンポーネントを選択してから、「 ![フィールドレベル](assets/Smock_SelectContainer_18_N.svg) > **[!UICONTROL アダプティブフォームコンテナ]**&#x200B;を選択し、 ![プロパティ](assets/Smock_Wrench_18_N.svg).
...
<table>
 <tbody>
  ...
  <tr>
   <td>ボタン</td>
   <td>保存、リセット、次へ、前へ進むなどのアクションを実行するように設定できるボタンを追加します。</td>
  </tr>
  <tr>
   <td>Captcha</td>
  ...
  <tr>
   <td>リセットボタン</td>
   <td>フォームフィールドをリセットするボタンを追加します。</td>
  </tr>
  <tr>
   <td>保存ボタン</td>
  ...
  <tr>
   <td>手書き署名</td>
   <td>手書き署名をキャプチャするためのフィールドを追加します。</td>
  </tr>
  <tr>
   <td>区切り文字</td>
...
例えば、「 **[!UICONTROL 親]** テキストボックスには、次の情報が表示されます。
