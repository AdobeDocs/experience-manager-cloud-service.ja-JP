...
* [アダプティブFormsでテーマを作成または追加する](/help/forms/using-themes-in-core-components.md)
* [コアコンポーネントに基づくAEMアダプティブフォームでのGoogle reCAPTCHA の使用](/help/forms/captcha-adaptive-forms-core-components.md)
