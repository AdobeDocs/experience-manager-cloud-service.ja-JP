...
アダプティブFormsを使用すると、企業は、レスポンシブでモバイルに適した Web サイトやその他のデジタルチャネル用のインタラクティブなデータ駆動型フォームを、を使用せずに作成および管理できます。 </br> </br> AEMのアダプティブFormsにはドラッグ&amp;ドロップフォームビルダーも含まれており、技術者以外のユーザーが、テキストボックス、ドロップダウンメニュー、日付選択などの事前作成済みフォームコンポーネントを使用して、フォームを簡単に作成およびカスタマイズできます。 これにより、フォームの作成を迅速に行うことができ、大規模なコーディングや開発を行う必要がなくなります。 </br> </br> また、AEM Adaptive Formsには、次のような他の機能が用意されています。 <ul><li>フォームデータのルーティング、承認、送信のための高度なワークフローリアルタイムの検証とエラーチェックにより、データの正確性を確認 </li><li>フォームフィールドの事前入力やデータの検証を行うためのサードパーティのデータソースおよび API との統合 </li><li>高度な分析およびレポート機能により、フォームの使用状況、コンバージョン率、その他の主要指標を追跡する </li><li>電子署名用のAdobe Signおよび DocuSign との統合 </li>

>[!TAB 自動フォーム変換サービス]

automated forms conversionサービスを使用すると、企業は従来のPDFベースのフォームを、オンラインで簡単に管理および配布できる、インタラクティブなデジタルフォームに変換できます。 この変換サービスの特長を以下に示します。 <ul><li>印刷フォームをアダプティブフォームに変換する際の手動作業が大幅に減る。</li><li>変換時に各種のパターンが適用され、適切な検証処理が実行される</li><li>変換時に「レコードのドキュメント」が生成される </li><li>使用頻度の高いフィールドが再利用可能な「フォームフラグメント」としてグループ化される </li> <li>Adobe Analytics の技術を活用して変換処理が実行される</li>

>[!TAB 通信 API(Document Services)]

通信 API は、パーソナライズされたデータ駆動型通信の作成、管理および配信を自動化するための RESTful API(Application Programming Interfaces) のセットです。 </br> </br> また、これらの API を使用すると、企業は通信ワークフローをサードパーティのシステムやデータソースと統合し、特定のイベントやユーザーの行動でトリガーされる、高度にターゲットを絞り込んでパーソナライズされたメッセージを作成できます。 AEM Forms Communications API の主な機能には次のものが含まれます。<ul><li> 動的コンテンツ配信：API を使用すると、企業は、好み、行動、過去のビジネスとのやり取りに基づいて、個々のユーザーに合わせた動的コンテンツを作成し、配信できます。</li> <li>パーソナライズされたメッセージ：この API を使用すると、名前、住所、購入履歴などのユーザー固有のデータを含めることで、企業は通信をパーソナライズできます。</li><li>バックエンドシステムとの統合：この API は、CRM、データベース、マーケティング自動化プラットフォームなど、様々なバックエンドシステムと統合できます。</li><li> Pixel PerfectPDFドキュメントを生成：この API は、ユーザー固有のデータとコンテンツを使用してカスタマイズされた、PDFに最適なピクセルドキュメントを生成します。 この機能を使用すると、請求書、契約書、明細書など、ユーザーにPDF形式で配信される、高度にプロフェッショナルで洗練されたドキュメントを作成できます。

>[!TAB 高度な分析]

このサービスは、Adobe Analyticsとの接続に OOTB サポートを提供します。 フォームをAdobe Analyticsに接続すると、次のようなメリットが企業にもたらされます。 <ul><li> ユーザーの行動に関する理解を深める：フォームをAdobe Analyticsと連携させることで、企業は、ユーザーがフォームをどのように操作しているかをより深く理解できます。 これには、改善すべき領域を特定し、より良いユーザーエクスペリエンスを得るためにフォームを最適化するのに役立つ、ユーザーエンゲージメント、コンバージョン率、ドロップオフポイント、その他の主要指標に関するインサイトが含まれます。 </li><li>マーケティング活動のターゲティングの向上：フォーム上のユーザーの行動を分析することで、企業はユーザーの好みや興味に関する貴重なインサイトを得ることができます。 この情報を使用して、マーケティング活動のターゲットを絞り、エンゲージメントとコンバージョンを促進する、より効果的なキャンペーンを作成できます。 </li><li> エラー率の削減：フォームをAdobe Analyticsと統合すると、ほとんどのエラーを含むフィールドに関するインサイトを見つけ、データの品質を向上させて、意思決定の向上と正確なインサイトの獲得が可能になります。 </li><li> ROI の向上：Adobe Analyticsから得られたインサイトに基づいてフォームを最適化することで、企業はコンバージョン率を向上させ、デジタルチャネルからの収益を増やすことができます。 これにより、マーケティングやデジタルイニシアチブに対する投資利益率 (ROI) が高まり、企業の目標達成と成長の促進を支援します。</li>
