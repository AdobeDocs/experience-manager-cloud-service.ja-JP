...
1. 編集モードで、 **[!UICONTROL サービス]** セクションを左側のペインに追加し、「 」を選択します。 **[!UICONTROL 選択項目を追加]**. 選択したサービスが、フォームデータモデルの「**[!UICONTROL サービス]**」タブに表示されます。
...
1. 選択 **[!UICONTROL 保存]** フォームデータモデルを保存します。
...
1. Adobe Analytics の **[!UICONTROL モデル]** 「 」タブで、データモデルオブジェクトのプロパティを選択し、「 」を選択します。 **[!UICONTROL プロパティを編集]**.
1. 「**[!UICONTROL 検索キー]**」切り替えオプションをオン状態に切り替えます。このオプションは、プライマリデータ型にのみ使用できます。
1. 選択 **[!UICONTROL 完了]** 次に、「 **[!UICONTROL 保存]** をクリックしてフォームデータモデルを保存します。
