...
1. 編集モードで、左側のパネルにある「**[!UICONTROL サービス]**」セクションからサービスを選択し、「**[!UICONTROL 選択項目を追加]**」を選択します。選択したサービスが、フォームデータモデルの「**[!UICONTROL サービス]**」タブに表示されます。
...
1. 「**[!UICONTROL 保存]**」を選択して、フォームデータモデルを保存します。
...
1. 「**[!UICONTROL 完了]**」を選択し、「**[!UICONTROL 保存]**」を選択してフォームデータモデルを保存します。
