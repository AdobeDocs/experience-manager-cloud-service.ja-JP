...
* 使用している環境に固有の[Adobe Developer Console](https://experienceleague.adobe.com/ja/docs/experience-manager-cloud-manager/content/requirements/access-rights)へのアクセス権があることを確認してください。
