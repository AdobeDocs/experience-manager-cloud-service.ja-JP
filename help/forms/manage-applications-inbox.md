...
1. 次のいずれかの操作を行います。
   ...
   * タスクを委任するには、「**[!UICONTROL 委任]**」を選択します。項目を委任ダイアログが開きます。ユーザーを選択し、任意でコメントを追加して、「**[!UICONTROL OK]**」を選択します。

   ![委任](assets/delegate.png)

   * タスクを要求するには、「**[!UICONTROL 開く]**」を選択します。自分に割り当てダイアログが開きます。「**[!UICONTROL 続行]**」を選択して、タスクを要求します。要求したタスクが、自分が担当者としてインボックスに表示されます。
...
1. 「**[!UICONTROL タスクステータス]**」アコーディオンを選択し、「**[!UICONTROL 完了]**」をクリックします。完了されたすべてのタスクが表示されます。
