---
title: AEM Inbox でフォーム、アプリケーション、タスクを管理するにはどうすればよいですか？
...
Forms 中心のワークフローを起動またはトリガーする多くの方法の 1 つに、AEM インボックスのアプリケーションから行う方法があります。ワークフローをインボックス内のアプリケーションとして使用できるようにするには、Forms Workflowアプリケーションを作成する必要があります。 ワークフローアプリケーションおよび Forms ワークフローを起動するためのその他の方法について詳しくは、「[OSGi 上での Forms 中心のワークフローの起動](aem-forms-workflow.md#launch)」を参照してください。

さらに、AEM インボックスは、Forms ワークフローを含む様々な AEM コンポーネントの通知やタスクを統合します。タスクの割り当てステップを含むForms Workflowがトリガーされると、関連するアプリケーションが担当者のインボックスにタスクとして表示されます。 担当者がグループの場合、そのタスクは、個人が要求するまで、またはタスクを委任するまで、グループのメンバー全員のインボックスに表示されます。
...
要約すると、インボックスでは、アプリケーションを作成し、割り当てられたタスクを管理できます。
...
1. インボックス UI で、「 **[!UICONTROL 作成/アプリケーション]**. アプリケーションを選択ページが表示されます。
1. アプリケーションを選択してから、「**[!UICONTROL 作成]**」をクリックします。アプリケーションに関連付けられたアダプティブフォームが開きます。アダプティブフォームの情報を入力し、を選択します。 **[!UICONTROL 送信]**. 関連するワークフローが起動し、担当者のインボックスにタスクが作成されます。

## タスクの管理 {#manage-tasks}

Formsワークフロートリガーが担当者または担当者グループの一部である場合は、インボックスにタスクが表示されます。 インボックス内からタスクの詳細を表示し、タスクで使用可能なアクションを実行できます。
...
1. 次のいずれかの操作を行います。
   ...
   * タスクを委任するには、「 **[!UICONTROL 委任]**. 項目を委任ダイアログが開きます。ユーザーを選択し、必要に応じてコメントを追加して、「 」を選択します。 **[!UICONTROL OK]**.

   ![委任](assets/delegate.png)

   * タスクを要求するには、「 」を選択します **[!UICONTROL 開く]**. 自分に割り当てダイアログが開きます。選択 **[!UICONTROL 続行]** タスクを要求します。 要求したタスクが、自分が担当者としてインボックスに表示されます。
...
さらに、タブはワークフローの完了した各段階ごとのタスクの履歴を表示します。次の項目を選択できます。 **[!UICONTROL 詳細を表示]** 完成したステージで、そのステージの詳細を知ることができます。 タスクに関するコメント、フォーム、タスクの添付ファイル、ステータス、開始日、終了日などが表示されます。
...
AEM インボックスでは、アクティブなタスクのみが表示されます。完了したタスクはリストには表示されません。ただし、インボックスフィルターを使用して、タスクの種類、ステータス、開始日、終了日など、複数のパラメーターに基づいてタスクをフィルタリングすることができます。 完了したタスクを表示するには、以下の手順を実行します。

1. 「AEM Inbox」で、「 ![toggle-side-panel1](assets/toggle-side-panel1.png) をクリックして、フィルターセレクターを開きます。
1. 選択 **[!UICONTROL タスクステータス]** アコーディオンと選択 **[!UICONTROL 完了]**. 完了されたすべてのタスクが表示されます。

   ![filter](assets/filter.png)

1. タスクを選択し、「 」をクリックします。 **[!UICONTROL 開く]**.
...
「**[!UICONTROL ワークフローの詳細]**」タブには、ワークフローの各ステップが表示されます。選択 **[!UICONTROL 詳細を表示]** を参照してください。

![completed-task-workflow](assets/completed-task-workflow.png)

## トラブルシューティング {#troubleshooting-workflows}

### AEM Inbox でAEM Workflow に関連する項目を表示できません {#unable-to-see-aem-worklow-items}

ワークフローモデルの所有者は、AEM Workflow に関連する項目をAEM Inbox に表示できません。 この問題を解決するには、以下にリストされているインデックスを AEM リポジトリに追加し、インデックスを再構築します。
