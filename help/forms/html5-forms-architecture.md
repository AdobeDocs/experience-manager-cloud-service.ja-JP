...
**Adobe XFA Forms レンダラー（com.adobe.livecycle.adobe-lc-forms-core）**&#x200B;は、Felix管理コンソール `(https://[host]:[port]/system/console/bundles)`のバンドルビューから表示した場合のHTML5 forms OSGi バンドルの表示名です。
