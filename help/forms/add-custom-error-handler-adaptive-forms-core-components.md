...
1. 「**[!UICONTROL 成功ハンドラーを追加]**」をクリックします。 **[!UICONTROL Invoke Service Success Handler]** ルール エディターが開きます。
1. **[!UICONTROL 次に]** セクションで、イベントペイロードデータを使用して&#x200B;**[!UICONTROL ペット名]**&#x200B;から&#x200B;**`name`**&#x200B;の値を設定するルールを追加します。
1. 「**[!UICONTROL 完了]**」をクリックして、**[!UICONTROL Invoke Service Success Handler]** エディターを閉じます。
1. 「**[!UICONTROL 失敗ハンドラーを追加]**」をクリックします。 **[!UICONTROL Invoke Service Failure Handler]** ルール エディターが開きます。
1. **[!UICONTROL 次に]** セクションで、**[!UICONTROL 関数出力]**&#x200B;を選択し、**[!UICONTROL 既定のエラーハンドラー]**&#x200B;を選択します。
1. 「**[!UICONTROL 完了]**」をクリックして、**[!UICONTROL 呼び出しサービス失敗ハンドラー]** エディターを閉じます。
...
1. 「**[!UICONTROL 完了]**」をクリックして、**[!UICONTROL Invoke Service Success Handler]** エディターを閉じます。
1. 「**[!UICONTROL 失敗ハンドラーを追加]**」をクリックします。 **[!UICONTROL Invoke Service Failure Handler]** ルール エディターが開きます。
1. **[!UICONTROL 次に]** セクションで、**[!UICONTROL 関数出力]**&#x200B;を選択し、**[!UICONTROL カスタムエラーハンドラー関数]**&#x200B;を選択します。
1. 「**[!UICONTROL 完了]**」をクリックして、**[!UICONTROL 呼び出しサービス失敗ハンドラー]** エディターを閉じます。
1. 「**[!UICONTROL 完了]**」をクリックして、ルールを保存します。
