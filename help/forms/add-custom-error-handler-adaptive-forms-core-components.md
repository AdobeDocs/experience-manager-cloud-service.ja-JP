...
1. `[AEM Forms as a Cloud Service repository folder]/apps/` フォルダーの下にフォルダーを作成します。例えば、という名前のフォルダーを作成します。 `experience-league`
