...
* **AEM の公開インスタンスから開始されるワークフロー**：アダプティブフォームまたはレターが AEM の公開インスタンスから送信されたときに、すべてのワークフローインスタンスがサービスユーザーを使用して作成されます。このような場合、ログインしているユーザーのユーザー名は、ワークフローインスタンスのデータには取り込まれていません。
...
>[!MORELIKETHIS]
>
>* [ビジネスプロセスの自動化に AEM Forms ワークフローを使用](/help/forms/aem-forms-workflow.md)