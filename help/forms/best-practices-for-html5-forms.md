...
* Web 圧縮を有効にします。これにより、フォームから生成されるリクエストと応答のサイズが小さくなります。<!-- For details, see [Performance tuning of AEM Forms Server](https://helpx.adobe.com/jp/aem-forms/6-3/performance-tuning-aem-forms.html)-->
