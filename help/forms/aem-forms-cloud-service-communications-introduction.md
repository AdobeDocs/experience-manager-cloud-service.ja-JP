...
## AEM Formsは保険証書を作成できますか？

はい。AEM Formsでは、フォームを通じて取得されたテンプレートや構造化データを使用して、ポリシー関連のドキュメントを生成できます。

## AEM Formsは大規模な保険業務に対応できますか？

はい。Adobe Managed Servicesまたはプライベートクラウドで推奨アーキテクチャを使用してデプロイする場合、AEM Formsは大量のフォーム送信とエンタープライズ規模のワークロードをサポートします。
...
>[!NOTE]
>
> ドキュメント生成APIには、バッチおよび同期出力生成エンドポイントが含まれます。これらのAPIは、エンドポイントに応じて、JWTまたはOAuthを使用したサーバー間認証をサポートします。 ドキュメント生成APIについて詳しくは、[ここをクリック &#x200B;](/help/forms/aem-forms-communication-api-overview.md#document-generation-apis)してください。
...
>[!NOTE]
>
> Document Manipulation APIは、JWTを使用したサーバー間認証をサポートします。 ドキュメント操作APIについて詳しくは、[ここをクリック &#x200B;](/help/forms/aem-forms-communication-api-overview.md#document-manipulation-apis)してください。
...
>[!NOTE]
>
> Document Extraction APIは、OAuthを使用したサーバー間認証をサポートします。 ドキュメント抽出APIについて詳しくは、[ここをクリック &#x200B;](/help/forms/aem-forms-communication-api-overview.md#document-extraction-apis)してください。
>
...
>[!NOTE]
>
> ドキュメント変換APIは、OAuthを使用したサーバー間認証をサポートします。 ドキュメント変換APIについて詳しくは、[ここをクリック &#x200B;](/help/forms/aem-forms-communication-api-overview.md#document-conversion-apiss)してください。
...
>[!NOTE]
>
> Document Assurance APIは、OAuthを使用したサーバー間認証をサポートします。 Document Assurance APIについて詳しくは、[ここをクリック &#x200B;](/help/forms/aem-forms-communication-api-overview.md#document-assurance-apis)してください。
...
>* [&#x200B; アーリーアダプタープログラムの機能](/help/forms/early-access-ea-features.md)
