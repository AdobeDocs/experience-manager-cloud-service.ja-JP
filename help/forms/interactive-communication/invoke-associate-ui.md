...
<span> インタラクティブ通信機能は、アーリーアダプタープログラムで利用できます。 作業アドレスから`aem-forms-ea@adobe.com`にメールを送信して、アクセスをリクエストします。</span>
...
>- アソシエイト UIの場合、[SAML 2.0認証](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/authentication/saml-2-0)記事で説明されている標準設定を超える追加のSAML設定が必要です。 詳細については、「アソシエイト UI[の](#additional-saml-configurations-for-associate-ui)追加のSAML設定」の節を参照してください。
...
- [クラウドでのインタラクティブ通信](/help/forms/early-access-ea-features.md#interactive-communications-on-cloud)
- [早期アクセス機能](/help/forms/early-access-ea-features.md)
