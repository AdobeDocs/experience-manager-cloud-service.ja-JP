...
description: AEM Formsのインタラクティブなコミュニケーションエディターをご確認ください。 動的にパーソナライズされたコミュニケーションを実現するための主な機能、オンボーディングの手順、実際のユースケースについて解説します。
...
| [**テンプレート**](/help/forms/interactive-communication/create-interactive-communication-template.md) | - コミュニケーション全体で統一されたブランディングと構造を確保 |
