...
# アダプティブフォームを AEM Sites ページに埋め込む {#embed-an-adaptive-form-or-interactive-communication-in-aem-sites-page}
...
## 埋め込まれたアダプティブフォームを公開する {#publishing-embedded-adaptive-form}
