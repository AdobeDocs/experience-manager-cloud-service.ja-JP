...
description: AEM Formsのフォームビルダーを使用して、コアコンポーネントを含むアダプティブフォームを作成する方法を説明します。 情報収集と処理を合理化するレスポンシブなHTML5 フォームを必要とするフォーム作成者に最適です。
keywords: フォームビルダー，コアコンポーネント，フォームの作成，フォーム作成者，アダプティブフォーム，フォームの作成，AEM フォーム，レスポンシブフォーム
...
AEM Formsのフォームビルダーなら、魅力的でレスポンシブ、ダイナミックでアダプティブなフォームを作成できます。 プロ仕様のフォームを作成する場合であれ、レスポンシブなフォームをすばやく作成する場合であれ、AEM Formsは使いやすいウィザードを提供します。 ウィザードには、事前設定済みのテンプレート、スタイル設定、フィールド、送信オプションを簡単に選択するためのクイックタブナビゲーションが用意されています。
...
### フォームのJSON スキーマまたはフォームデータモデル（FDM）の設定
...
### フォームデータモデル事前入力サービスを使用して、アダプティブフォームのフィールドに事前入力を行います {#fdm-prefill-service}
...
## AEM Formsは、顧客との対応と社内の保険プロセスの両方に使用できますか？

はい。AEM Formsは、顧客と接するデジタルフォームだけでなく、レビュー、承認、アシストデータキャプチャなど、社内プロセス、スタッフやエージェント主導のプロセスもサポートします。

## AEM Formsは保険金請求提出に使用できますか？

はい。AEM Formsは、保険契約者が保険金請求をデジタルで送信できるマルチステップのアダプティブフォームをサポートしています。これには、構造化データの取得やドキュメントのサポートなどが含まれます。

## AEM Formsはモバイル保険金請求に対応していますか？

はい。AEM Formsは、レスポンシブでモバイルフレンドリーなフォームをサポートしています。これにより、お客様や担当者は、モバイルデバイスから保険情報を送信できます。
