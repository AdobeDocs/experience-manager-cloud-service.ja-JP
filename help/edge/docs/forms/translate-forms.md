...
以下のURLを参照してください。フランス語の翻訳を使用してフォームを表示できます。
...
- [Macを設定し、別の言語で入力を受け付ける](https://support.apple.com/ja-in/guide/mac-help/mchlp1406/mac)
...
- [AndroidまたはiPhone/iPadを設定して、別の言語で入力を受け取る](https://support.google.com/gboard/answer/7068494?hl=ja&co=GENIE.Platform%3DAndroid)
