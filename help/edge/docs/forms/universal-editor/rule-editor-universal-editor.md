...
>
>
> カスタムイベントベースのルール、動的変数のサポート、API 統合など、ルールエディターの機能強化は、Edge Delivery Services Formsでも利用できます。 これらの機能強化とその使用方法について詳しくは、[ ルールエディターの機能強化とユースケース ](/help/forms/rule-editor-enhancements-use-cases.md) の記事を参照してください。
