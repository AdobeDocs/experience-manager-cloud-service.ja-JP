...
ユニバーサルエディターでは、ルールエディターはデフォルトで有効になっていません。お使いの環境でルールエディター拡張機能を有効にするには、公式アドレスから [aem-forms-ea@adobe.com](mailto:aem-forms-ea@adobe.com) にリクエストを記載したメールを送信してください。
...
ルールを記述するフォームオブジェクトを選択し、![ルールを編集](/help/forms/assets/edit-rules-icon.svg) アイコンをクリックします。ルールエディターのユーザーインターフェイスが表示されます。
...
![ルールを編集](/help/forms/assets/edit-rules-icon.svg) アイコンをクリックすると、ルールエディターのビジュアルエディターが開きます。
...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>「<b>フォームオブジェクト</b>」タブには、フォームに含まれているオブジェクトがすべて階層表示されます。「<b>関数</b>」タブには、一連の組み込み関数が含まれます。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>ビジュアルルールエディターは、ルールエディターのユーザーインターフェイスのビジュアルエディターモード内でルールを記述する領域です。</td>
    </tr>
    <tr>
...
オブジェクトを選択すると、フォームオブジェクト上に既存のルールが一覧表示されます。ビジュアルルールエディターでタイトルを表示し、ルール概要をプレビューできます。さらに、ルールの順序変更、ルールの編集、ルールの有効化／無効化、ルールの削除を行うことができます。
...
<table border="1">
  ...
  <tbody>
    <tr>
      <td>次の値を設定</td>
      <td>指定した条件に応じてフォームオブジェクトの値を設定します。</td>
    </tr>
    <tr>
      <td>次の値をクリア</td>
      <td>指定したオブジェクトの値がクリアします。</td>
    </tr>
    <tr>
      <td>非表示／表示</td>
      <td>条件を満たしているかどうかに基づいて、フォームオブジェクトを表示または非表示にします。</td>
    </tr>
    <tr>
      <td>有効／無効</td>
    ...
    <tr>
      <td>検証</td>
      <td>フォームまたは指定されたオブジェクトを検証します。</td>
    </tr>
    <tr>
      <td>条件</td>
      <td>「<i>条件=アクション=代替</i>」アクションのルール構文または「<i>条件=アクション</i>」のルール構文に従います。評価の条件を指定し、その後に条件が満たされた場合にトリガーするアクションを指定します。</td>
    </tr>
    <tr>
      <td>形式</td>
      <td>関数または正規表現に基づいてフォームオブジェクトを設定します。</td>
    </tr>
    <tr>
      <td>サービスを呼び出す</td>
    ...
    <tr>
      <td>プロパティを設定</td>
      <td>条件に基づいて、指定したオブジェクトのプロパティの値を設定します。</td>
    </tr>
    <tr>
      <td>フォーカスを設定</td>
...
1. 編集用にユニバーサルエディターでフォームを開きます。
1. コンテンツツリーで&#x200B;**[!UICONTROL 総給与]**&#x200B;コンポーネントを選択し、![ルールを編集](/help/forms/assets/edit-rules-icon.svg) を選択します。
   ![ルールエディターの例 1](/help/edge/docs/forms/assets/rule-editor3.png)
ビジュアルルールエディターのインターフェイスが表示されます。
1. 「**[!UICONTROL 作成]**」をクリックし、ルールエディターを起動します。
...
1. オーサリングモードで「**[!UICONTROL 課税所得]**」フィールドを選択し、![ルールを編集](/help/forms/assets/edit-rules-icon.svg) アイコンを選択します。次に、「**[!UICONTROL 作成]**」を選択し、ルールエディターを起動します。
...
1. オーサリングモードで「**[!UICONTROL 支払税]**」フィールドを選択し、![ルールを編集](/help/forms/assets/edit-rules-icon.svg) アイコンを選択します。次に、「**[!UICONTROL 作成]**」を選択し、ルールエディターを起動します。
