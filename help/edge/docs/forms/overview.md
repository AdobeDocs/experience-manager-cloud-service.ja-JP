...
* **選択したツールを使用して登録エクスペリエンスを作成：**&#x200B;コンテンツソースを分離することでオーサリングの効率を高めます。すぐに使用できるオーサリング機能は、ドキュメントベースのオーサリング機能（Microsoft SharePointまたはGoogle ドライブ）と、WYSIWYG オーサリング機能（ユニバーサルエディターまたはアダプティブFormsエディター）です。 同じフォームサイトで複数のコンテンツソースを操作し、Microsoft Excel、Google シート、ユニバーサルエディター、アダプティブForms エディターなど、好みのオーサリングツールを使用できます。
...
Microsoft Excel または Google Sheets（ドキュメントベースのオーサリング）でフォームを編集し、Edge Delivery Services に公開する方法を次の図に示します。また、WYSIWYG オーサリングを使用したAEMの公開方法も示します（ユニバーサルエディターまたはアダプティブFormsエディター）。
...
ドキュメントベースのオーサリングには基本的な機能セットが用意されており、WYSIWYG オーサリングにより、ドキュメントベースのオーサリング以外の追加機能が利用できるようになり、より複雑でインタラクティブなフォームを作成できます。 ドキュメントベースのオーサリングと WYSIWYG オーサリングの両方の主な機能は次のとおりです。
...
WYSIWYG オーサリングには、フォーム作成用の WYSIWYG インターフェイス（ユニバーサルエディターとアダプティブFormsエディター）が用意されており、ドキュメントベースのオーサリングのすべての機能に加えて、次のような様々な機能が提供されます。
...
上記のすべての機能は、アダプティブFormsエディターからも使用できます。

基本的に、WYSIWYG オーサリング（ユニバーサルエディターおよび [アダプティブFormsエディター](/help/forms/creating-adaptive-form-core-components.md)）は、次の基盤の上に構築 [ドキュメントベースのオーサリング](/help/edge/docs/forms/create-forms.md)複雑なフォームを作成および管理するための、より高度なツールキットを提供します。
