---
title: Edge Delivery Services プロジェクトを使用した WYSIWYG オーサリングのコンテンツモデリング
description: Edge Delivery Servicesプロジェクトでの WYSIWYG オーサリング向けコンテンツモデリングの仕組みと、独自のコンテンツをモデル化する方法について説明します。
