...
+ 通信 API {#using-communications}
   + [通信 API の概要](/help/forms/aem-forms-communication-api-overview.md)
   + [通信 API の概要](/help/forms/aem-forms-cloud-service-communications-introduction.md)
   + [認証 – OAuth サーバー間](/help/forms/oauth-api-authetication.md)
   + [認証 JWT （JSON web トークン）](/help/forms/jwt-api-authentication.md)
   ...
   + [通信 API - オンデマンド処理](/help/forms/aem-forms-cloud-service-communications-on-demand-processing.md)
