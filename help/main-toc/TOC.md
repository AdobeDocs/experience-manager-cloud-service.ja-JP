...
source-git-commit: ca3edda50c7734f107161e261e598269d704e4ff
workflow-type: tm+mt
source-wordcount: '6974'
ht-degree: 94%
...
+ Forms {#forms}
   ...
   + インタラクティブなコミュニケーション {#interactive-communication}
      ...
      + [インタラクティブ通信エディターでのテンプレートロック](/help/forms/interactive-communication/template-lock-in-interactive-communication-editor.md)
      + [インタラクティブ通信エディターでの動的ページ番号](/help/forms/interactive-communication/dynamic-page-numbering-in-interactive-communicatio-editor.md)
      + [インタラクティブ通信エディターでのコンテンツオーバーフロー処理](/help/forms/interactive-communication/content-overflow-handling-in-interactive-communication-editor.md)
      + [インタラクティブ通信エディターでの XDP 編集のサポート](/help/forms/interactive-communication/support-xdp-editing-in-interactive-communication-editor.md)
