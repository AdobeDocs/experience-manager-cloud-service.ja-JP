...
+ リリースノート {#release-notes}
   ...
   + AEMaaCS 機能のリリースノート {#release-notes}
      ...
      + 2026 {#2026}
         + [リリースノート（2026.5.0）](/help/release-notes/release-notes-cloud/2026/2026-5-0.md)
   ...
   + AEMaaCS メンテナンスリリースノート {#maintenance}
      ...
      + 2026 {#2026}
         + [メンテナンスリリースノート（2026.7.0）](/help/release-notes/maintenance/2026/2026-7-0.md)
         ...
         + [メンテナンスリリースノート（2026.2.0）](/help/release-notes/maintenance/2026/2026-2-0.md)
         + [メンテナンスリリースノート（2026.1.0）](/help/release-notes/maintenance/2026/2026-1-0.md)
      + 2025 {#2025}
         + [メンテナンスリリースノート（2025.12.0）](/help/release-notes/maintenance/2025/2025-12-0.md)
         + [メンテナンスリリースノート（2025.11.0）](/help/release-notes/maintenance/2025/2025-11-0.md)
         + [メンテナンスリリースノート（2025.10.0）](/help/release-notes/maintenance/2025/2025-10-0.md)
   ...
   + ユニバーサルエディターのリリースノート {#universal-editor}
      ...
      + 2026 {#2026}
         + [2026.07.09 リリースノート](/help/release-notes/universal-editor/2026/2026-07-09.md)
         + [2026.07.02 リリースノート](/help/release-notes/universal-editor/2026/2026-07-02.md)
         + [2026.06.25 リリースノート](/help/release-notes/universal-editor/2026/2026-06-25.md)
         + [2026.06.18 リリースノート](/help/release-notes/universal-editor/2026/2026-06-18.md)
         + [2026.06.11 リリースノート](/help/release-notes/universal-editor/2026/2026-06-11.md)
         + [2026.06.05 リリースノート](/help/release-notes/universal-editor/2026/2026-06-05.md)
         + [2026.05.28 リリースノート](/help/release-notes/universal-editor/2026/2026-05-28.md)
      ...
      + 2025 {#2025}
         ...
         + [リリースノート（2025.12.04）](/help/release-notes/universal-editor/2025/2025-12-04.md)
         + [リリースノート（2025.11.20）](/help/release-notes/universal-editor/2025/2025-11-20.md)
         + [リリースノート（2025.11.13）](/help/release-notes/universal-editor/2025/2025-11-13.md)
         + [リリースノート（2025.11.06）](/help/release-notes/universal-editor/2025/2025-11-06.md)
         + [リリースノート（2025.10.30）](/help/release-notes/universal-editor/2025/2025-10-30.md)
         + [リリースノート（2025.10.24）](/help/release-notes/universal-editor/2025/2025-10-24.md)
         + [リリースノート（2025.10.16）](/help/release-notes/universal-editor/2025/2025-10-16.md)
         + [リリースノート（2025.10.09）](/help/release-notes/universal-editor/2025/2025-10-09.md)
         + [リリースノート（2025.10.02）](/help/release-notes/universal-editor/2025/2025-10-02.md)
...
+ AEM as a Cloud Service 移行ジャーニー {#migration-journey}
   ...
   + クラウド移行ツール {#cloud-migration}
      ...
      + コンテンツトランスファーツール {#content-transfer-tool}
         ...
         + [コンテンツトランスファーツールの前提条件](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/prerequisites-content-transfer-tool.md)
         ...
         + [パブリッシュインスタンスでのコンテンツトランスファーツールの実行](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/running-content-transfer-tool-publish-instance.md)
...
+ Sites {#sites}
   ...
   + 管理 {#administering}
      + コンテンツフラグメント {#content-fragments}
         + [概念とベストプラクティス](/help/sites-cloud/administering/content-fragments/overview.md)
         ...
         + {hide-from-toc}[MSM](/help/sites-cloud/administering/content-fragments/msm-for-content-fragments.md)を使用したコンテンツフラグメントの再利用
...
+ Assets {#assets}
   ...
   + デジタルアセットの管理 {#manage}
      ...
      + [スマートタグのトレーニング](/help/assets/smart-tags-training.md)
      ...
      + {hide-from-toc}[AEM Assets アクティベーション レポート （Beta） ](/help/assets/aem-assets-activation-report.md)
   + [!DNL Assets] の設定、管理、拡張 {#admin}
      ...
      + [AEM Assets用アセットソースポータル](/help/assets/asset-sourcing-portal-for-aem-assets.md)
   ...
   + コンテンツアドバイザー {#content-advisor}
      ...
      + [Dynamic Mediaとの統合](/help/assets/integration-with-dynamic-media.md)
      + [OpenAPI 機能を備えた Dynamic Media の統合](/help/assets/integrate-dynamic-media-openapi.md)
   + コンテンツフラグメント {#content-fragments}
   ...
   + Dynamic Media {#dynamicmedia}
      ...
      + [新しいビデオビューアー](/help/assets/dynamic-media/new-video-viewer.md)
   ...
   + アセットビューの操作 {#assets-view}
      ...
      + [AIが生成したメタデータ](/help/assets/ai-generated-metadata-assets-view.md)
   ...
   + アダプティブフォーム {#adaptive-forms-authoring}
      ...
      + コアコンポーネント {#authoring-adaptive-forms-core-components}
         + アダプティブフォームの作成 {#create-an-adaptive-form-on-forms-cs}
            ...
            + [テーマエディターを使用したアダプティブフォームのテーマのカスタマイズ](/help/forms/customizing-themes-using-theme-editor.md)
            ...
            + [アダプティブForms用の送信PDF（旧レコードのドキュメント）の生成](/help/forms/generate-document-of-record-core-components.md)
            + [自動生成されたレコードのドキュメントのテンプレートをカスタマイズ](/help/forms/customize-document-of-record-template.md)
            + [Submission PDFでサポートされているHTML マークアップタグ](/help/forms/html-markup-tags-support-in-document-of-record.md)
            ...
            + アダプティブ Formsの{hide-from-toc}[電子メールテンプレート ](/help/forms/html-email-templates-in-adaptive-forms.md)
      ...
      + 基盤コンポーネント {#authoring-adaptive-forms-foundation-components}
         ...
         + アダプティブフォームの作成 {#create-an-adaptive-form-on-forms-cs}
            ...
            + XDP ベースのアダプティブ Formsでの{hide-from-toc}[XFA サポート ](/help/forms/xfa-api-supported-in-adaptive-form.md)
         ...
         + 送信アクションとメタデータ送信の設定 {#configure-submit-actions-and-metadata-submission}
            ...
            + アダプティブ Formsからフォームデータモデル （FDM） サービスを呼び出す{hide-from-toc}[API](/help/forms/invoke-form-data-model-services.md)
...
+ インタラクティブなコミュニケーション {#interactive-communication}
   + インタラクティブ通信について {#overview}
      ...
      + [はじめに](/help/forms/interactive-communication/getting-started.md)
   ...
   + Component {#component}
      ...
      + [画像フィールド](/help/forms/interactive-communication/image-field.md)
      + [テキストフィールド](/help/forms/interactive-communication/text-field.md)
      + [数値フィールド](/help/forms/interactive-communication/numeric-field.md)
      + [日付／時間フィールド](/help/forms/interactive-communication/date-time-field.md)
      + [日付フィールド](/help/forms/interactive-communication/date-field.md)
      + [チェックボックス](/help/forms/interactive-communication/check-box.md)
      + [ラジオボタン](/help/forms/interactive-communication/radio-button.md)
      + [サブフォーム](/help/forms/interactive-communication/subform.md)
      + [長方形](/help/forms/interactive-communication/rectangle.md)
   ...
   + 方法 {#howto}
      ...
      + [インタラクティブ通信の読み込みと書き出し](/help/forms/interactive-communication/import-and-export-the-interactive-communication.md)
      + [カスタムフォントを追加](/help/forms/interactive-communication/add-custom-fonts.md)
      + [PDF プレビューを生成](/help/forms/interactive-communication/generate-pdf-preview.md)
      + [テンプレートロックを有効にする](/help/forms/interactive-communication/enable-template-lock.md)
...
+ 通信 API {#using-communications}
   ...
   + [AEM Forms Communications API](/help/forms/aem-forms-communication-api-overview.md)
...
+ AEM の AI {#ai-in-aem}
   ...
   + MCP サポート {#mcp-support}
      + [AEM as a Cloud ServiceでのMCPの使用](/help/ai-in-aem/mcp-support/using-mcp-with-aem-as-a-cloud-service.md)
      + チャットアプリケーション（Webおよびデスクトップ） {#chat-applications}
         + [AEM MCPでのAnthropic Claudeの設定](/help/ai-in-aem/mcp-support/setup-claude.md)
         + [AEM MCPを使用したOpenAI ChatGPTの設定](/help/ai-in-aem/mcp-support/setup-chatgpt.md)
      + 開発者用ツール（IDE拡張機能、デスクトップアプリ、CLI） {#developer-tools}
         + [AEM MCPでのカーソルの設定](/help/ai-in-aem/mcp-support/setup-cursor.md)
      + エンタープライズプラットフォーム {#enterprise-platforms}
         + [AEM MCPを使用したMicrosoft Copilot Studioの設定](/help/ai-in-aem/mcp-support/setup-microsoft-copilot-studio.md)
         + [GitHub CopilotとAEM MCPを使用したJetBrainsの設定](/help/ai-in-aem/mcp-support/setup-jetbrains-copilot.md)
   + [AI ツールを使用したローカル開発](/help/ai-in-aem/local-development-with-ai-tools.md)
   + AEMの担当者 {#agents}
      + [概要](/help/ai-in-aem/agents/overview.md)
      + Brand Experience Agent {#brand-experience}
         + [概要](/help/ai-in-aem/agents/brand-experience/overview.md)
         ...
         + Experience Modernization エージェント {#modernization}
            + [概要](/help/ai-in-aem/agents/brand-experience/modernization/overview.md)
            + [はじめに](/help/ai-in-aem/agents/brand-experience/modernization/getting-started.md)
            + [AEM オーサリングプロジェクトの概要](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md)
      ...
      + Content Advisor エージェント {#content-advisor}
         + [概要](/help/ai-in-aem/agents/content-advisor/overview.md)
         + [Content Discovery Agent](/help/ai-in-aem/agents/content-advisor/discovery.md)
         + [Content Optimization エージェント](/help/ai-in-aem/agents/content-advisor/content-optimization.md)
      + Brand Governance エージェント {#governance}
         + [概要](/help/ai-in-aem/agents/governance/overview.md)
         + [ブランドポリシーの読み込み方法](/help/ai-in-aem/agents/governance/how-to-import-a-brand-policy.md)
...
+ Screens {#screens-as-cloud-service}
   ...
   + Screens as a Cloud Service での開発 {#developing-screens-cloud}
...
+ ヘッドレス {#headless}
   ...
   + コンテンツフラグメントセレクター {#content-fragment-selector}
      ...
      + [Adobe アプリケーションとの統合](/help/headless/content-fragment-selector/integrate-adobe-application.md)
      + [Adobe以外のアプリケーションやサードパーティのアプリケーションとの統合](/help/headless/content-fragment-selector/integrate-non-adobe-application.md)
      + [Vanilla JSを使用したコンテンツフラグメントセレクターの統合](/help/headless/content-fragment-selector/integrate-using-vanilla-js.md)
...
+ 実装 {#implementing}
   ...
   + Cloud Manager の使用 {#using-cloud-manager}
      ...
      + [専用のテスト環境](/help/implementing/cloud-manager/specialized-test-environment.md)
      + コードの管理 {#managing-code}
         ...
         + [外部リポジトリの追加](/help/implementing/cloud-manager/managing-code/external-repositories.md)
         + [外部リポジトリのアクセストークンの管理](/help/implementing/cloud-manager/managing-code/manage-access-tokens.md)
      ...
      + Cloud Manager CI/CD パイプライン {#cicd-pipelines}
         ...
         + [ステージと実稼動専用パイプラインの分割](/help/implementing/cloud-manager/configuring-pipelines/stage-prod-only.md)
   ...
   + AEM as a Cloud Service 向けの開発 {#developing}
      ...
      + [AEM の高速開発環境](/help/implementing/developing/introduction/rapid-development-environments.md)
      ...
      + ユニバーサルエディター {#universal-editor}
         ...
         + [イベント](/help/implementing/universal-editor/events-universal-editor.md)
         + [フィルター](/help/implementing/universal-editor/filtering.md)
         + [RTEの設定](/help/implementing/universal-editor/configure-rte.md)
         + [Assets Selectorの設定](/help/implementing/universal-editor/configure-assets-selector.md)
   ...
   + AEM as a Cloud Service へのデプロイ {#deploying}
      ...
      + [休眠時間と無料期間の更新](/help/implementing/deploying/quiet-hours-update-free-periods.md)
   ...
   + コンテンツ配信の概要 {#content-delivery}
      ...
      + {hide-from-toc}[Dispatcher Tools Legacy](/help/implementing/dispatcher/validation-debug-legacy.md)を使用した検証とデバッグ
...
+ 操作 {#operations}
   ...
   + [デプロイした前のコードを復元](/help/operations/restore-previous-code-deployed.md)
...
+ コンプライアンス {#compliance}
   ...
   + HIPAA {#hipaa}
      + [HIPAA対応](/help/compliance/hipaa/hipaa-readiness.md)
