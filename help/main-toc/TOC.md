...
source-git-commit: 3809e8fb89f9a00d04f93cd0c8f82ff4d475de47
workflow-type: tm+mt
...
+ AEM の AI {#ai-in-aem}
   ...
   + AEMの業務担当者 {#business-agents}
      + [概要](/help/ai-in-aem/agents/overview.md)
      + 実稼動エージェント {#production}
         + [概要](/help/ai-in-aem/agents/production/overview.md)
         + [インタラクティブ通信の作成スキル](/help/ai-in-aem/agents/production/communications-creation.md)
      ...
      + コンテンツ最適化エージェント {#content-optimization}
         + [コンテンツ最適化エージェントの使用](/help/ai-in-aem/agents/content-optimization/using.md)
      + 探索エージェント {#discovery}
         + [検出エージェントの使用](/help/ai-in-aem/agents/discovery/using.md)
