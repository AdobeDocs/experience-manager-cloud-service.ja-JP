...
+ セキュリティ {#security}
   ...
   + [トラフィックをフィルタリングする WAF ルールを使用したトラフィックフィルタルールの設定](/help/security/cdn-and-waf-rules.md)
...
+ AEM as a Cloud Service 移行ジャーニー {#migration-journey}
   ...
   + クラウド移行ツール {#cloud-migration}
      ...
      + コンテンツ転送ツール {#content-transfer-tool}
         ...
         + [閉じられたユーザーグループの移行](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/closed-user-groups-migration.md)
...
+ Forms {#forms}
   ...
   + {#integrate} の統合
      ...
      + フォームデータモデル {#use-form-data-model}
         ...
         + [アダプティブフォームのMicrosoft SharePointリストへの接続](/help/forms/connect-aem-adaptive-form-to-sharepointlist.md)
