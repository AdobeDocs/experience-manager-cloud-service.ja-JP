...
これで、AEM Content and Commerce 開発ジャーニーを開始する準備が整いました。ジャーニーの次のステップに進み、[AEM コンテンツとCommerceについて説明する](/help/commerce-cloud/cif-storefront/introduction.md)記事をお読みください。
