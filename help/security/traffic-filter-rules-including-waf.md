...
1. WAF ルールがライセンスされている場合は、*Cloud Managerでこの機能を有効にする必要があります*。 ライセンス済みのWAF ルールはアクティブではなく、**WAF-DDOS Protection**&#x200B;がオンになるまで保護されません。 次の説明に従って、新規および既存のプログラムシナリオの両方で機能を有効にします。
