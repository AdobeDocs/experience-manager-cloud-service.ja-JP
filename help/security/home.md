---
title: クラウドサービスセキュリティとしてのAdobe Experience Manager
description: クラウドサービスセキュリティセルフヘルプのリソースとドキュメントのリンクとしてのAdobe Experience Manager
...
# クラウドサービスとしてのExperience Managerのセキュリティ {#aem-security-guide}

このページには、Experience Managerがクラウドサービスセキュリティとして機能するセルフヘルプリソースの一覧を示します。

## 主要なセキュリティ記事 {#key-articles}
