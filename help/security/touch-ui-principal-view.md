...
このビューを使用すると、ユーザーは指定したパスと選択したプリンシパルに対して適用された権限を効率的に検索できます。 このビューでは、ユーザーは、選択したパスの1つ以上のプリンシパルに付与される権限のタイプを明確に識別できます。

グループメンバーシップは、オプションで「専用」チェックボックスを選択して表示できます。 このオプションが有効になっている場合、権限評価では、選択したプリンシパルだけでなく、プリンシパルのすべてのグループが考慮されます。

さらに、監査ビューでは、効果的なACLに関するインサイトを提供します。 選択したプリンシパルと共通プリンシパルを考慮して、選択したパスの親ノードに関連付けられたACLが表示されます。

![フィルタービュー](assets/audit-view.png)

### リポジトリーブラウザーの権限と監査ビュー {#the-repository-browser-permissions-and-audit-view}
...
1. リポジトリブラウザーで、「**権限**」タブをクリックします
   ...
   ![「権限」タブ](/help/security/assets/permissions-tab.png)

1. 監査ビューを使用すると、ユーザーは指定したパスと選択したプリンシパルに対して適用された権限を効率的に検索できます。 グループメンバーシップは、オプションで「専用」チェックボックスを選択して表示できます。

   ![監査タブ &#x200B;](/help/security/assets/audit-tab.png)
