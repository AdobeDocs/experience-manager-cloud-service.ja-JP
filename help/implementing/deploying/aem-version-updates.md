...
[製品テストおよび顧客機能テスト](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/understand-test-results.html#functional-testing)は、製品のアップグレードや顧客コードのプッシュによる実稼動環境での障害発生を防ぐためのもので、これらも AEM バージョンのアップデート時に検証されます。
