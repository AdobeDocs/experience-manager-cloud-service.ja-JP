...
サインインしたら、編集するページの URL を [アドレスバー。](#address-bar) そのため、 [コンテンツの編集](#edit-content)
...
コンテンツの編集はシンプルで直感的です。In [編集モード](#edit-mode) エディターでコンテンツにマウスを合わせると、編集可能コンテンツは青いボックスでハイライト表示されます。
