...
description: プロパティパネルでユニバーサルエディターが例を使用して編集できるフィールドとコンポーネントタイプについて説明します。 モデル定義を作成し、コンポーネントにリンクすることで、独自のアプリを実装する方法を理解します。
...
プロパティパネルでユニバーサルエディターが例を使用して編集できるフィールドとコンポーネントタイプについて説明します。 モデル定義を作成し、コンポーネントにリンクすることで、独自のアプリを実装する方法を理解します。

## 概要 {#overview}

ユニバーサルエディターで使用するために独自のアプリを適応する場合は、コンポーネントを実装し、エディターのプロパティパネルで操作できるフィールドとコンポーネントタイプを定義する必要があります。 これを行うには、モデルを作成し、コンポーネントからそのモデルにリンクします。
...
ユニバーサルエディターのプロパティパネルでコンポーネントを設定するには、モデル定義が存在し、コンポーネントにリンクされている必要があります。
...
AEM コンテンツコンポーネントタイプを使用すると、任意のAEM リソースの選択に使用できるAEM コンテンツピッカーが有効になります。 アセットのみを選択できる [ 参照コンポーネント ](#reference) とは異なり、AEM コンテンツコンポーネントは、あらゆるAEM コンテンツを参照できます。 追加の検証タイプを提供します。

| 検証タイプ | 値タイプ | 説明 | 必須 |
|---|---|---|---|
| `rootPath` | `string` | AEM コンテンツを選択するためにコンテンツピッカーが開くパスで、そのディレクトリとサブディレクトリに限定して選択します | 不可 |
...
コンテンツフラグメントピッカーを使用すると、[コンテンツフラグメント](/help/sites-cloud/authoring/fragments/content-fragments.md)と（必要に応じて）そのバリエーションを選択できます。追加の設定と検証が可能です。
...
| 検証タイプ | 値タイプ | 説明 | 必須 |
|---|---|---|---|
| `rootPath` | `string` | ユーザーがコンテンツフラグメントを選択するためにコンテンツピッカーが開くパスで、選択はそのディレクトリとサブディレクトリに制限されます | 不可 |
...
エクスペリエンスフラグメントピッカーを使用すると、[エクスペリエンスフラグメント](/help/sites-cloud/authoring/fragments/experience-fragments.md)と（必要に応じて）そのバリエーションを選択できます。追加の設定と検証が可能です。
...
| 検証タイプ | 値タイプ | 説明 | 必須 |
|---|---|---|---|
| `rootPath` | `string` | ユーザーがエクスペリエンスフラグメントを選択するためにコンテンツピッカーが開くパスで、選択はそのディレクトリとサブディレクトリに制限されます | いいえ |
...
参照コンポーネントタイプを使用すると、AEM アセットピッカーを使用して、参照する任意のAEM アセットを選択できます。 任意のAEM リソースを選択できる [AEM コンテンツコンポーネント ](#aem-content) とは異なり、参照コンポーネントは、アセットのみを参照できます。 追加の検証タイプを提供します。
