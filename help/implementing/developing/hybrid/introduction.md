...
また、コンテンツ作成者の場合、SPAエディターを使用したコンテンツ作成はAEM内でシームレスにおこなわれます。
...
SPA は、AEM の外部で開発されて保守される SPA を含む、AEM 内の柔軟なレベルの統合で有効にできます。また、SPAはAEM内で使用できる一方、AEMを使用して追加のエンドポイントにヘッドレスにコンテンツを配信することもできます。
