...
* 構造モードでコンテンツがコンポーネントに追加され、そのコンポーネントがその後ロック解除（または逆）されると、そのコンテンツが初期コンテンツとして使用されます。
...
1. **テンプレートを有効にする**
   ...
   * **テンプレート**&#x200B;コンソールから[テンプレートを有効に](/help/sites-cloud/authoring/features/templates.md)します。
