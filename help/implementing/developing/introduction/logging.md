...
DEBUG ログがアクティブになっている場合、発生したアクティビティと処理に影響を与える主要なパラメーターの明確な内容を提供するステートメントがログに記録されます。</td>
<td>
<ul>
<li> ローカル開発</li>
<li>開発</li>
...
最初のリクエストの後に作成された新しい開発環境で、Splunk の転送が有効になっていない場合は、追加のリクエストを実行する必要があります。
