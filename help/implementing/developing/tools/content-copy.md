...
1. コンソールからコンテンツセットを選択し、「...」メニューから「**コンテンツをコピー**」を選択します。
...
* コンテンツのコピーツールにはバージョン管理機能がなく、前回のコンテンツのコピー操作以降にコンテンツセット内のソース環境で変更されたコンテンツや新しく作成されたコンテンツを自動的に検出できません。
