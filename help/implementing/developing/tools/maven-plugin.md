...
Maven がプラグインをダウンロードできるようにするには、 [Content Package Maven プラグインの取得](#obtaining-the-content-package-maven-plugin) 」セクションに表示されます。

## Content Package Maven プラグインの目標 {#goals-of-the-content-package-maven-plugin}
