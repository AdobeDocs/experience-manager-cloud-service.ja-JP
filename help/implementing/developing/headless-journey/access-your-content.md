...
これで、AEM GraphQL APIを使用してヘッドレスコンテンツにアクセスし、クエリする方法を学びました。これで、REST APIを使用してコンテンツフラグメントのコンテンツにアクセスし、更新する方法を学習できます。[](/help/implementing/developing/headless-journey/update-your-content.md)
