...
description: AEMコンテンツフラグメントを使用して、ヘッドレス配信でページに依存しないコンテンツを設計、作成、キュレーションおよび使用する方法を説明します。
...
AEMコンテンツフラグメントを使用して、ヘッドレス配信でページに依存しないコンテンツを設計、作成、キュレーションおよび使用する方法を説明します。
