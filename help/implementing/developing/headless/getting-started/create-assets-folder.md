...
description: AEMコンテンツフラグメントモデルを使用して、ヘッドレスコンテンツの基になるコンテンツフラグメントの構造を定義します。
...
AEMコンテンツフラグメントモデルを使用して、ヘッドレスコンテンツの基になるコンテンツフラグメントの構造を定義します。 コンテンツフラグメントはアセットフォルダーに保存されます。
