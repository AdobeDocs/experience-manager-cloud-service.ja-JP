...
1. [Adobeで Gen AI ライダーに署名する必要があります ](https://fieldreadiness-adobe.highspot.com/items/665f831c9f831b011aeda057#1)。

   GenAI Rider は、お客様とAdobeの間の法的契約で、ほとんどの AI 機能と Agentic 機能を使用する必要があります。 詳しくは、Adobe カスタマーケアにお問い合わせください。

1. AEM管理者が、組織で使用できるように AI アシスタントを設定します。 [AEMでの AI アシスタントの設定 ](/help/implementing/cloud-manager/aem-ai-assistant-admin.md) を参照してください。
...
1. AEMの AI アシスタントで、![ 詳細アイコン ](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg) をクリックします。
...
1. プロンプトを選択して、AEMの AI アシスタントが回答できる質問の種類をより深く理解します。

### AEMの AI アシスタントに関するフィードバックを提供する

AEMの AI アシスタントのパフォーマンスと精度を向上させるために、入力した情報を使用します。
...
| ![ フラグアイコン ](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Flag_18_N.svg) | クリックして懸念事項を報告したり、AEMの AI アシスタントとのやり取りに関する詳細なフィードバックを提供したりします。 |
