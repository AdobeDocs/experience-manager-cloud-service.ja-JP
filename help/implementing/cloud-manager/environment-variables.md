...
環境変数を追加、更新、または削除するには、[ デプロイメントマネージャーの役割](/help/onboarding/cloud-manager-introduction.md#role-based-permissions)のメンバーである必要があります。
...
1. ![追加／更新 - 追加の円アイコン](https://spectrum.adobe.com/static/icons/workflow_18/Smock_AddCircle_18_N.svg) 「**追加／更新**」をクリックします。初めて環境変数を追加する場合は、ページの中央の「**設定を追加**」をクリックします。
...
1. 「**保存**」をクリックします。
   ...
   ステータスが&#x200B;**Updating**&#x200B;のインジケーターがテーブルの右上隅に表示されます。 新しく追加された変数の左側にもインジケーターが表示されます。 これらのステータスは、環境が設定によって更新されていることを示します。 完了すると、新しい環境変数が表に表示されます。
...
1. 必要に応じて、環境変数の値を更新します。秘密鍵を編集する場合、値は更新のみ可能で、表示はできません。
...
1. 「**保存**」をクリックします。
   ...
   ステータスが&#x200B;**更新中**&#x200B;のスピナーがテーブルの右上隅に表示されます。 更新された変数の左側には、インジケーターも表示されます。 これらのステータスは、環境が設定によって更新されていることを示します。 完了すると、更新された環境変数がテーブルに表示されます。
