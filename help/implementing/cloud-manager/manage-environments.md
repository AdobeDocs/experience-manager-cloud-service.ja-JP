...
1. 次の日： **[マイプログラム](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/editing-programs.md#my-programs)** 画面で、環境を追加するプログラムをタップまたはクリックします。
...
1. 「**環境**」タブの左側のナビゲーションパネルで、クエリを実行する環境を選択します。
