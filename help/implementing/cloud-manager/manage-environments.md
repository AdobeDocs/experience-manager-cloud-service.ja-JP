...
1. **本番環境を編集**&#x200B;ダイアログで、追加の公開地域に必要な変更を加えます。
...
クラウドネイティブなサービスとして、アドビでは本番プログラム内の開発環境、ステージング環境および本番環境の更新を自動的に管理します。

ただし、サンドボックスプログラム環境は、プログラム自体で更新されます。 環境で最新のパブリック AEM バージョンが実行されていない場合、プログラム **概要**&#x200B;画面の&#x200B;**Environments** カードに&#x200B;**利用可能な更新**&#x200B;が表示されます。
...
IP 許可リストを管理するには、プログラムの&#x200B;**概要**&#x200B;ページの ![データアイコン](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Data_18_N.svg) **環境**&#x200B;ページに移動します。 個々の環境を選択して、その詳細を管理します。
