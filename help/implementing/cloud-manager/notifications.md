...
デフォルトでは、アプリケーションとメールの両方で、すべての製品に関するすべての通知を受信します。製品名の横にある山形記号をクリックすると、詳細なオプションが表示され、その製品に対して受け取る通知のタイプを定義できます。または、製品レベルのオプションをオンまたはオフにして、製品のすべてのオプションを選択または選択解除します。
