...
## AEM オーサリング機能（Beta）を使用したEdge Delivery Servicesについて {#eds-aem-authoring}

>[!NOTE]
>
>ここで説明する柔軟なパブリッシュ層とAEM オーサリングクロスウォーク機能は、Betaにあります。 Betaに参加するには、[grp-beta_xwalk-publish_config@adobe.com](mailto:grp-beta_xwalk-publish_config@adobe.com)にAdobeの組織IDとプログラム IDをメールで送信してください。
...
### Edge Delivery Sitesのオーサリングオプション
...
* [SLAのレポートへのアクセス](/help/implementing/cloud-manager/reports/report-sla.md)
