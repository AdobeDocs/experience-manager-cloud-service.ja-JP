...
1. **[マイプログラム](/help/implementing/cloud-manager/navigation.md#my-programs)**&#x200B;コンソールで、外部 Git リポジトリを使用する Edge Delivery サイトを設定するために、Edge Delivery Services が設定済みのプログラムを選択します。
