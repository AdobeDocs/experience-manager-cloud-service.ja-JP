...
「**エクスペリエンス監査スキャン結果**」セクションには、スキャンされたすべてのページのスコアの詳細が表示されます。 **前**&#x200B;および&#x200B;**次** ボタンを使用して、結果をページ化し、表示する表示数を選択します。
...
エクスペリエンス監査レポートは、パイプラインの実行中に実行するだけでなく、オンデマンドで生成することもできます。 このオプションは、パイプラインを実行しなくてもページをすばやくスキャンできる優れたソリューションです。
...
オンデマンドスキャンが既に実行されている場合、「**スキャンを実行**」ボタンは使用できなくなり、時計アイコンが付けられます。
