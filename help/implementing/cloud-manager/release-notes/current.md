...
![&#x200B; フルビルドとスマートビルドの 2 つのビルド戦略オプションを示す「実稼動以外のパイプラインを編集」ダイアログボックス &#x200B;](/help/implementing/cloud-manager/release-notes/assets/non-production-pipeline-edit.png)*フルビルドとスマートビルドの 2 つのビルド戦略オプションを示す「実稼動以外のパイプラインを編集」ダイアログボックス*
