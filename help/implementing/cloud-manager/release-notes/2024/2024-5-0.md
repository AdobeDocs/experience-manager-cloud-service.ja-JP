...
* [ ライセンスダッシュボード ](/help/implementing/cloud-manager/license-dashboard.md) は、左側の [ ナビゲーション ](/help/implementing/cloud-manager/navigation.md) の別個のエントリポイントからアクセスできるようになりました。
