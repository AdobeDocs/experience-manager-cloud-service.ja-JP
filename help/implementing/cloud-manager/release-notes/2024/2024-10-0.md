...
AEM as a Cloud ServiceのCloud Manager リリース 2024.10.0のリリースについて説明します。
...
AEM as a Cloud Service の Cloud Manager 2024.10.0 のリリース日は 2024年10月3日木曜日（PT）です。

次回のリリース予定は 2024年11月7日木曜日（PT）です。
