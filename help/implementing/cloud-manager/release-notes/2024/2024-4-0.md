...
description: AEM as a Cloud ServiceのCloud Manager 2024.4.0のリリースノート。
...
* [Edge Delivery](/help/edge/overview.md) Web サイトの削除操作が、そのサイトに関連するプログラムからドメイン マッピングを更新することで改善されました。
