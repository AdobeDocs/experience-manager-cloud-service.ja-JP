...
description: AEM as a Cloud ServiceのCloud Manager 2024.3.0のリリースノート。
...
* [Cloud Manager プログラムで高度なネットワーク インフラストラクチャ &#x200B;](/help/security/configuring-advanced-networking.md)を作成し、Cloud Manager UIを使用してセルフサービス方式で環境を設定できるようになりました。
* [&#x200B; パイプライン実行ステップの詳細](/help/implementing/cloud-manager/configuring-pipelines/managing-pipelines.md#view-details)には、デプロイメントの現在のステップと今後のステップが含まれます。
...
* ユーザーが末尾のスペースで`COMMERCE_ENDPOINT`変数を定義すると、Dispatcherの読み込みに失敗するバグが修正されました。
