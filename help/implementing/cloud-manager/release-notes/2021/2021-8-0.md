...
詳しくは、[SLA レポート](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/sla-reporting)を参照してください。
