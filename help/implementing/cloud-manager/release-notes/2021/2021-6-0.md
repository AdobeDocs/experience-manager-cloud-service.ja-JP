...
* プレビューサービスは、すべてのプログラムに対して周期的にデプロイされます。 プログラムのプレビューサービスが有効になると、製品内で通知が送信されます。 詳しくは、[プレビューサービスへのアクセス](/help/implementing/cloud-manager/manage-environments.md#access-preview-service)を参照してください。
