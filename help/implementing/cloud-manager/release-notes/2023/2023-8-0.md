...
description: AEM as a Cloud ServiceのCloud Manager 2023.8.0 のリリースノート。
...
AEM as a Cloud Service の Cloud Manager 2023.8.0 のリリース日は 2023年8月10日です。次回のリリースは 2023年9月7日（PT）に予定されています。
