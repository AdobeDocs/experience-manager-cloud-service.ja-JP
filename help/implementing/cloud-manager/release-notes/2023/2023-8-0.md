...
* コンテンツセットを [ コンテンツをコピー ](/help/implementing/developing/tools/content-copy.md) に設定する際に、UI のコンテンツセットで [ コンテキスト対応設定 ](/help/implementing/developing/introduction/configurations.md) が許可されるようになりました。
