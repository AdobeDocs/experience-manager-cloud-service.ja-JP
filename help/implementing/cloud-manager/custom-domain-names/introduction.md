...
独自のCDNで管理されている&#x200B;**ドメインは、Cloud Manager**&#x200B;を介したインストールが必要ありません。X-Forwarded-Hostを介してAEMで利用でき、Dispatcherで定義されているvhostsと一致します。 詳しくは、[CDN ドキュメント](/help/implementing/dispatcher/cdn.md)を参照してください。
