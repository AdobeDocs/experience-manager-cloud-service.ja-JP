...
# Cloud Managerでの外部リポジトリのアクセストークンの管理 {#manage-access-tokens}
...
**`Manage Access Tokens`**&#x200B;機能により、トークンをより効率的に管理できるようになりました。 GitHub Enterprise、GitLab、Bitbucket、Azure DevOpsなど、サポートされている外部Git プロバイダーのトークンを表示、名前変更、削除できます。
...
1. **`Delete Access Token`** ダイアログボックスで、**削除**&#x200B;をクリックして、トークンを完全に削除します。
