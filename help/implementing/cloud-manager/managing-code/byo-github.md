...
>[!TIP]
>
>Cloud Manager でのリポジトリ管理について詳しくは、[Cloud Manager リポジトリ](/help/implementing/cloud-manager/managing-code/cloud-manager-repositories.md)を参照してください。
...
Cloud Manager で独自の GitHub リポジトリを使用する場合の制限事項。
