...
1 つのプロジェクトに複数のベストプラクティスアナライザー (BPA) レポートをアップロードする場合、 **トレンドラインを表示** 古い BPA レポートの結果を表示および比較するオプションです。

トレンドラインを表示するには、次の手順に従います。
...
1. をクリックします。 **...** アイコンをクリックしてドロップダウンを表示します。
   ...
   >[!IMPORTANT]
   >表示されるレポートは常に、最新のレポート日を持つレポートです。
...
1. クリック **トレンドラインを表示** 次の図に示すように、レポートのトレンドライン表示を開きます。
   ...
   >1. カスタムコンポーネントとテンプレートのトレンド
      >以下に示すように、ドロップダウンからグラフィカルビューを追加または変更できます。
