...
landing-page-description: AEM as a Cloud Service への移行プロセスについて説明します。
...
Cloud Service への移行プロセスには、次のフェーズが含まれます。

* [準備](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/phases/migration-readiness.html?lang=ja)
* [実装](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/phases/migration-implementation.html?lang=ja)
* [運用開始](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/phases/migration-go-live.html?lang=ja)
* [運用開始後](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/phases/migration-post-go-live.html?lang=ja)

移行をうまくスムーズに行うには、適切な計画を立て、本ガイドで概要を説明しているベストプラクティスに従う必要があります。

次の図は AEM as a Cloud Service への推奨移行プロセスを示しています。

![画像](/help/move-to-cloud-service/assets/move-aemcloud-process.png)
...
Cloud Acceleration Manager は、Cloud Serviceの計画から運用開始まで、移行プロセス全体を通じて IT チームを導くように設計されたクラウドベースのアプリケーションです。AEM as a Cloud Service への移行プロセスの各フェーズで役に立つアドビ推奨のベストプラクティス、ヒント、ドキュメント、およびツールを利用して移行に成功するように、チームをセットアップします。

移行プロセスを開始するには、[Cloud Acceleration Manager の基本を学ぶ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-acceleration-manager/using-cam/getting-started-cam.html?lang=ja)を参照してください。
...
| [Screens ユーザーガイド](/help/screens-cloud/home.md) | Adobe Experience Manager Screens as a Cloud Service の使用方法と管理方法について説明します。 |
