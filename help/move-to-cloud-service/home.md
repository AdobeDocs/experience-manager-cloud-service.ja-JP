...
AEM as a Cloud Serviceは、Experience Managerアセット、Forms、Screensの拡張性と安全性と俊敏性の高いテクノロジーの基盤を提供し、マーケターやIT部門は、大規模で効果的なエクスペリエンスを提供することに専念できます。
...
移行プロセスには、次のフェーズが含まれます。Cloud Serviceへの移行プロセス
...
次の図に、AEMへの推奨される移行プロセスをCloud Serviceとして示します。
...
>abstract="Cloud Acceleration Managerは、Cloud Serviceの計画から運用開始まで、移行プロセス全体を通じてITチームを導くように設計されたクラウドベースのアプリケーションです。"
>additional-url="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/home.html#aem-moving-to-aem-guide" text="AEM as a Cloud Service への移行"
...
移行プロセスを開始するには、 [Cloud Acceleration Managerの概要](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-acceleration-manager/using-cam/getting-started-cam.html?lang=en)を参照してください。
...
| [概要](/help/overview/home.md) | このガイドでは、導入、用語、アーキテクチャなど、Experience Manageras a Cloud Serviceの概要を説明します。 |
...
| [Screensユーザーガイド](/help/screens-cloud/home.md) | Cloud ServiceとしてのExperience Manager Screensの使用と管理方法を説明します。 |
