...
アクションの大まかな優先度を示すために、各発見に重要度レベルが割り当てられます。各検索カテゴリの詳細については、「 [パターン検出カテゴリ](https://docs.adobe.com/content/help/en/experience-manager-pattern-detection/table-of-contents/aso.html)」を参照してください。
