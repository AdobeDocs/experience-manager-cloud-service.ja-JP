...
* AEMまたは Cloud Manager の管理者の場合、またはフロントエンド開発者と管理者の役割を両方担当している場合、またはAEMのエンドツーエンドのプロセスを理解したい場合は、次を使用してジャーニーの最初に進みます。 [Cloud Manager について](cloud-manager.md) 以下に示すように。
