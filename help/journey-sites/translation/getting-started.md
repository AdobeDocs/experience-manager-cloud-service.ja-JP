...
1. グローバルナビゲーションメニューで、 **ナビゲーション** > **Sites**.
...
1. 列内の項目のチェックボックスをタップまたはクリックすると、その項目が選択され、選択した項目の詳細が右側の列に表示され、上のツールバーに、選択した項目で使用可能ないくつかのアクションが表示されます。
...
1. Sites コンソールを使用してページを探し、選択します。個々のページのチェックボックスをオンにして選択する必要があることに注意してください。
