...
AEM Sites ページには、多くの情報を含めることができます。プロジェクトのニーズに応じて、ページ内のすべての情報を翻訳する必要が生じる可能性があります。
...
1. 翻訳されるページプロパティは、リストの「**一般**」セクションに表示されます。翻訳に明示的に含める既存のプロパティ名を追加または更新できます。
   1. Adobe Analytics の **新しいプロパティ** 「 」フィールドで、プロパティ名を入力します。 「**翻訳**」オプションと「**継承**」オプションが自動的にオンになります。
   1. 「**追加**」を選択します。
